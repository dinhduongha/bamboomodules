...
namespace Bamboo.Core.HttpApi.Controllers.BaseModule
{
    public partial class ResCurrencyController
    {
        ...
        {
            var result = await _appService.AmountToTextAsync(id, input.Amount);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.CompareAmountsAsync(id, input.Amount1, input.Amount2);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.FormatAsync(id, input.Amount);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.GetCompanyCurrencyForSpreadsheetAsync(id, input.CompanyId);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.IsZeroAsync(id, input.Amount);
            return Ok(result);
        }
