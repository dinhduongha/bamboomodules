...
namespace Bamboo.Core.HttpApi.Controllers.BaseModule
{
    public partial class IrUiViewController
    {
        ...
        {
            var result = await _appService.ApplyInheritanceSpecsAsync(id, input.Source, input.SpecsTree, input.PreLocate);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.DefaultViewAsync(id, input.Model, input.ViewType);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.DeleteSnippetAsync(id, input.ViewId, input.TemplateKey);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.DistributeBrandingAsync(id, input.E, input.Branding, input.ParentXpath, input.IndexMap);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.ExtractEmbeddedFieldsAsync(id, input.Arch);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.ExtractOeStructuresAsync(id, input.Arch);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.GetRelatedViewsAsync(id, input.Key, input.Bundles);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.InheritBrandingAsync(id, input.SpecsTree);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.IsNodeBrandedAsync(id, input.Node);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.LocateNodeAsync(id, input.Arch, input.Spec);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.PostprocessAndFieldsAsync(id, input.Node, input.Model);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.RenameSnippetAsync(id, input.Name, input.ViewId, input.TemplateKey);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.RenderPublicAssetAsync(id, input.Template, input.Values);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.ReplaceArchSectionAsync(id, input.SectionXpath, input.Replacement, input.ReplaceTail);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.ResetArchAsync(id, input.Mode);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.SaveAsync(id, input.Value, input.Xpath);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.SaveEmbeddedFieldAsync(id, input.El);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.SaveOeStructureAsync(id, input.El);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.SaveSnippetAsync(id, input.Name, input.Arch, input.TemplateKey, input.SnippetKey, input.ThumbnailUrl);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.ToEmptyOeStructureAsync(id, input.El);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.ToFieldRefAsync(id, input.El);
            return Ok(result);
        }
    }
}