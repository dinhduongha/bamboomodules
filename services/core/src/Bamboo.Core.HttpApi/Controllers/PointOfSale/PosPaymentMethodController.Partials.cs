...
namespace Bamboo.Core.HttpApi.Controllers.PointOfSale
{
    public partial class PosPaymentMethodController
    {
        ...
        {
            var result = await _appService.GetQrCodeAsync(id, input.Amount, input.FreeCommunication, input.StructuredCommunication, input.Currency, input.DebtorPartner);
            return Ok(result);
        }
        
        [HttpPost]
        [Route("{id}/l10n-id-verify-qris-status")]
        public async Task<IActionResult> L10nIdVerifyQrisStatusAsync(Guid id, [FromBody] PosPaymentMethodL10nIdVerifyQrisStatusRequestDto input)
        {
            var result = await _appService.L10nIdVerifyQrisStatusAsync(id, input.TrxUuid);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.MpGetPaymentStatusAsync(id, input.PaymentId);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.MpPaymentIntentCancelAsync(id, input.PaymentIntentId);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.MpPaymentIntentCreateAsync(id, input.Infos);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.MpPaymentIntentGetAsync(id, input.PaymentIntentId);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.PaytmFetchPaymentStatusAsync(id, input.TransactionId, input.ReferenceId, input.Timestamp);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.PaytmMakePaymentRequestAsync(id, input.Amount, input.TransactionId, input.ReferenceId, input.Timestamp);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.PineLabsCancelPaymentRequestAsync(id, input.Data);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.PineLabsFetchPaymentStatusAsync(id, input.Data);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.PineLabsMakePaymentRequestAsync(id, input.Data);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.ProxyAdyenRequestAsync(id, input.Data, input.Operation);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.RazorpayCancelPaymentRequestAsync(id, input.Data);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.RazorpayFetchPaymentStatusAsync(id, input.Data);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.RazorpayMakePaymentRequestAsync(id, input.Data);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.StripeCapturePaymentAsync(id, input.PaymentIntentId, input.Amount);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.StripePaymentIntentAsync(id, input.Amount);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.VivaWalletGetPaymentStatusAsync(id, input.SessionId);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.VivaWalletSendPaymentCancelAsync(id, input.Data);
            return Ok(result);
        }
        ...
        {
            var result = await _appService.VivaWalletSendPaymentRequestAsync(id, input.Data);
            return Ok(result);
        }
    }
}