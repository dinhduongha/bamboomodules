...
namespace Bamboo.Core.Application.Services
{
    ...
    public class HrWorkEntryAppService : GenericApplicationService<HrWorkEntry>, IHrWorkEntryAppService
    {
        ...
        public HrWorkEntryAppService(IRepository<HrWorkEntry, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        protected async Task<HrWorkEntry> FilterFrenchPartTimeEntriesInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_fr_hr_work_entry_holidays, FILE: hr_work_entry.py) ---
