...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class CalendarRecurrenceAppService : GenericAppService<CalendarRecurrence>, ICalendarRecurrenceAppService
    {
        ...
        public CalendarRecurrenceAppService(IRepository<CalendarRecurrence, Guid> repository, IServiceProvider serviceProvider, IDataFilter dataFilter, IObjectMapper objectMapper, IDistributedCache cache, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IGoogleCalendarSyncAppService googleCalendarSyncAppService, IMicrosoftCalendarSyncAppService microsoftCalendarSyncAppService) : base(repository, serviceProvider, dataFilter, objectMapper, cache, authorizationService, domainParser, modelTypeRegistry)
        {
