...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class DiscussChannelMemberAppService : GenericAppService<DiscussChannelMember>, IDiscussChannelMemberAppService
    {
        ...
        public DiscussChannelMemberAppService(IRepository<DiscussChannelMember, Guid> repository, ICurrentTenant currentTenant, IDistributedCache cache, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IBusListenerMixinAppService busListenerMixinAppService) : base(repository, currentTenant, cache, domainParser, modelTypeRegistry)
        {
        ...
        {
            /*
            --- METHOD SOURCE (MODULE: im_livechat, FILE: discuss_channel_member.py, METHOD: create) ---
