...
namespace Bamboo.Core.Application.Services
{
    ...
    public class WebTourTourStepAppService : GenericApplicationService<WebTourTourStep>, IWebTourTourStepAppService
    {
        ...
        public WebTourTourStepAppService(IRepository<WebTourTourStep, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
