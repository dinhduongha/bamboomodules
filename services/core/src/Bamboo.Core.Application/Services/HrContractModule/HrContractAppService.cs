...
{
    [Module("HrContractModule", Depends = new[] { "hr" })]
    public class HrContractAppService : GenericApplicationService<HrContract>, IHrContractAppService
    {
        ...
        public async Task<HrContract> GenerateWorkEntriesAsync(Guid id, object date_start, object date_stop, object force)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: hr_work_entry_contract, FILE: hr_contract.py) ---
        ...
        public async Task<HrContract> GetAttributeAsync(Guid id, object code, object attribute)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: om_hr_payroll, FILE: hr_contract.py) ---
        ...
        protected async Task<HrContract> GetContractWorkEntriesValuesInternalAsync(object date_start, object date_stop)
        {
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_fr_hr_work_entry_holidays, FILE: hr_contract.py) ---
            // def _get_contract_work_entries_values(self, date_start, date_stop):
        ...
        public async Task<HrContract> SetAttributeValueAsync(Guid id, object code, object active)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: om_hr_payroll, FILE: hr_contract.py) ---
