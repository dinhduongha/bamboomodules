...
namespace Bamboo.Core.Application
{
        ...
        where TEntity : class, IEntity<Guid>
    {
        ...
        public async Task<List<Guid>> SearchAsync(string domain, long offset = 0, int limit = 100, string order = null)
        {
        ...
        public async Task<List<object>> ReadAsync(List<Guid> ids, List<string> fields)
        {
            var modelName = typeof(TEntity).Name;
            await _authorizationService.CheckAccessAsync(modelName, "read");
        ...
        public async Task<List<object>> SearchReadAsync(string domain, List<string> fields, long offset = 0, int limit = 100, string order = null)
        {
            var modelName = typeof(TEntity).Name;
            await _authorizationService.CheckAccessAsync(modelName, "read");
        ...
        public async Task<object> CreateAsync(TEntity entity, List<string> fields)
        {
            var modelName = typeof(TEntity).Name;
        ...
        public async Task<List<object>> WriteAsync(List<Guid> ids, TEntity entity, List<string> fields)
        {
            var modelName = typeof(TEntity).Name;
        ...
        public async Task<List<(Guid Id, string Name)>> NameSearchAsync(string name, string domainJson = null, string @operator = "ilike", int limit = 100)
        {
            var modelName = typeof(TEntity).Name;
            await _authorizationService.CheckAccessAsync(modelName, "read");
        ...
        public async Task<object> CopyAsync(Guid id, List<string> fields, TEntity defaultValues = null)
        {
            var modelName = typeof(TEntity).Name;
            await _authorizationService.CheckAccessAsync(modelName, "create");
        ...
        public async Task<OnchangeResult> OnchangeAsync(List<string> changedFields, TEntity values, Dictionary<string, object> fieldInfo)
        {
            var modelName = typeof(TEntity).Name;
            await _authorizationService.CheckAccessAsync(modelName, "read");
        ...
        public async Task<Dictionary<string, object>> DefaultGetAsync(List<string> fields)
        {
            var modelName = typeof(TEntity).Name;
            await _authorizationService.CheckAccessAsync(modelName, "create");
        ...
        public async Task<Dictionary<string, Dictionary<string, object>>> FieldsGetAsync(List<string> fields = null, Dictionary<string, List<string>> attributes = null)
        {
            var modelName = typeof(TEntity).Name;
            await _authorizationService.CheckAccessAsync(modelName, "read");
