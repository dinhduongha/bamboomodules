...
{
    [Module("AccountEdi", Depends = new[] { "account" })]
    public class AccountEdiDocumentAppService : GenericApplicationService<AccountEdiDocument>, IAccountEdiDocumentAppService
    {

        public AccountEdiDocumentAppService(IRepository<AccountEdiDocument, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
