...
namespace Bamboo.Core.Application.Services
{
    ...
    public class HrLeaveAccrualLevelAppService : GenericApplicationService<HrLeaveAccrualLevel>, IHrLeaveAccrualLevelAppService
    {

        public HrLeaveAccrualLevelAppService(IRepository<HrLeaveAccrualLevel, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
