...
namespace Bamboo.Core.Application.Services
{
    ...
    public class HrAttendanceOvertimeLineAppService : GenericApplicationService<HrAttendanceOvertimeLine>, IHrAttendanceOvertimeLineAppService
    {

        public HrAttendanceOvertimeLineAppService(IRepository<HrAttendanceOvertimeLine, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
