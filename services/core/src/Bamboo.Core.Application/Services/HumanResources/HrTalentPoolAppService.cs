...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class HrTalentPoolAppService : GenericAppService<HrTalentPool>, IHrTalentPoolAppService
    {
        ...
        public HrTalentPoolAppService(IRepository<HrTalentPool, Guid> repository, ICurrentTenant currentTenant, IDistributedCache cache, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IMailThreadAppService mailThreadAppService) : base(repository, currentTenant, cache, domainParser, modelTypeRegistry)
        {
