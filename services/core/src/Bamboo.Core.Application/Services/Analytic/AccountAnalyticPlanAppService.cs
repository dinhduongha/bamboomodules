...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountAnalyticPlanAppService : GenericApplicationService<AccountAnalyticPlan>, IAccountAnalyticPlanAppService
    {
        ...
        public AccountAnalyticPlanAppService(IRepository<AccountAnalyticPlan, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
