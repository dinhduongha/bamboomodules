...
{
    [Module("DataRecycle", Depends = new[] { "mail" })]
    public class DataRecycleModelAppService : GenericApplicationService<DataRecycleModel>, IDataRecycleModelAppService
    {

        public DataRecycleModelAppService(IRepository<DataRecycleModel, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
