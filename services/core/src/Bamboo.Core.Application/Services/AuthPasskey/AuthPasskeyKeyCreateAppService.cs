...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AuthPasskeyKeyCreateAppService : GenericApplicationService<AuthPasskeyKeyCreate>, IAuthPasskeyKeyCreateAppService
    {

        public AuthPasskeyKeyCreateAppService(IRepository<AuthPasskeyKeyCreate, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
