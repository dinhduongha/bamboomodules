...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ResourceCalendarAttendanceAppService : GenericApplicationService<ResourceCalendarAttendance>, IResourceCalendarAttendanceAppService
    {
        ...
        public ResourceCalendarAttendanceAppService(IRepository<ResourceCalendarAttendance, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
