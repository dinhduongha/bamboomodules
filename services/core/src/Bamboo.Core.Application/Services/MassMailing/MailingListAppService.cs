...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MailingListAppService : GenericApplicationService<MailingList>, IMailingListAppService
    {
        ...
        public MailingListAppService(IRepository<MailingList, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
