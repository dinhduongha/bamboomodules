...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockPackageTypeAppService : GenericApplicationService<StockPackageType>, IStockPackageTypeAppService
    {
        ...
        public StockPackageTypeAppService(IRepository<StockPackageType, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<StockPackageType> CopyDataAsync(Guid id, object @default)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock, FILE: stock_package_type.py) ---
