...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockWarehouseOrderpointAppService : GenericApplicationService<StockWarehouseOrderpoint>, IStockWarehouseOrderpointAppService
    {
        ...
        public StockWarehouseOrderpointAppService(IRepository<StockWarehouseOrderpoint, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<StockWarehouseOrderpoint> ReplenishAsync(Guid id, object force_to_max)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock, FILE: stock_orderpoint.py) ---
