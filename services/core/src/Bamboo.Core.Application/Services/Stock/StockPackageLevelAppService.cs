...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockPackageLevelAppService : GenericApplicationService<StockPackageLevel>, IStockPackageLevelAppService
    {

        public StockPackageLevelAppService(IRepository<StockPackageLevel, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
