...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockPickingTypeAppService : GenericApplicationService<StockPickingType>, IStockPickingTypeAppService
    {
        ...
        public StockPickingTypeAppService(IRepository<StockPickingType, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IPosLoadMixinAppService posLoadMixinAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
