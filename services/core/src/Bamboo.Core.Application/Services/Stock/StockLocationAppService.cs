...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockLocationAppService : GenericApplicationService<StockLocation>, IStockLocationAppService
    {
        ...
        public StockLocationAppService(IRepository<StockLocation, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<StockLocation> CopyDataAsync(Guid id, object @default)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock, FILE: stock_location.py) ---
