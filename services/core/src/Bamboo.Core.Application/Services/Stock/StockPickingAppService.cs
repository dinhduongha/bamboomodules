...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockPickingAppService : GenericApplicationService<StockPicking>, IStockPickingAppService
    {
        ...
        public async Task<StockPicking> AssignBatchUserAsync(Guid id, Guid user_id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock_picking_batch, FILE: stock_picking.py) ---
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_edispatch, FILE: stock_picking.py) ---
            // def button_validate(self):
        ...
        public async Task<StockPicking> CalculateDateCategoryAsync(Guid id, object datetime)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeEdispatchWarningsInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_edispatch, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nItShowPrintDdtButtonInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_it_stock_ddt, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockAvailableLocationTypesInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockAvailableOperationScopesInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockCurrentDocumentStateInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockCurrentDocumentUitInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockDefaultLocationTypeInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockEnableAmendInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockEnableFetchInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockEnableInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock_batch, FILE: stock_picking.py) ---
            // def _compute_l10n_ro_edi_stock_enable(self):
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockEnableSendInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> ComputeL10nRoEdiStockFieldsReadonlyInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> DateCategoryToDomainAsync(Guid id, object date_category)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> GenerateL10nTrEdispatchXmlAsync(Guid id, object is_list)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_edispatch, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> GetEmptyListHelpAsync(Guid id, object help_message)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> GetL10nInDropshipDestPartnerInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_purchase_stock, FILE: stock_picking.py) ---
            // def _get_l10n_in_dropship_dest_partner(self):
            // self.ensure_one()
            // if line_id := self.purchase_id:
            //     return line_id.dest_address_id
            // return False
            --- ODOO METHOD SOURCE (MODULE: l10n_in_stock, FILE: stock_picking.py) ---
            // def _get_l10n_in_dropship_dest_partner(self):
            // """
        ...
        protected async Task<StockPicking> GetL10nInEwaybillFormActionInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_ewaybill_stock, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> L10nInEwaybillCreateAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_ewaybill_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nInGetFiscalPositionInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_purchase_stock, FILE: stock_picking.py) ---
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_in_sale_stock, FILE: stock_picking.py) ---
            // def _l10n_in_get_fiscal_position(self):
            // self.ensure_one()
        ...
        protected async Task<StockPicking> L10nInGetInvoicePartnerInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_sale_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockCreateAttachmentInternalAsync(Dictionary<string, object> values)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockCreateDocumentStockSendingFailedInternalAsync(object values)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockCreateDocumentStockSentInternalAsync(object values)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockCreateDocumentStockValidatedInternalAsync(object values)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockFetchDocumentStatusInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> L10nRoEdiStockFetchStatusAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockGetAllDocumentsInternalAsync(object states)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<string> L10nRoEdiStockGetAvailableLocationTypesInternalAsync(object operation_type, object location)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockGetCodInternalAsync(object record)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockGetCurrentDocumentInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockGetGrossWeightInternalAsync(object move)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockGetLastDocumentInternalAsync(object state)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockGetTemplateDataInternalAsync(Dictionary<string, object> data)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockReportUnhandledDocumentStateInternalAsync(string state)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockResetVariableSelectionFieldsInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> L10nRoEdiStockSendEtransportAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockSendEtransportDocumentInternalAsync(string send_type)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockValidateCarrierFilterInternalAsync(object picking)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockValidateCarrierInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockValidateDataInternalAsync(Dictionary<string, object> data)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nRoEdiStockValidateFetchDataInternalAsync(object errors)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ro_edi_stock, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nTrGenerateEdispatchXmlInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_edispatch, FILE: stock_picking.py) ---
        ...
        protected async Task<StockPicking> L10nTrValidateEdispatchFieldsInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_edispatch, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> MarkL10nTrEdispatchStatusAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_edispatch, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> OpenL10nInEwaybillAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_ewaybill_stock, FILE: stock_picking.py) ---
        ...
        public async Task<StockPicking> PutInPackAsync(Guid id, object move_lines_to_pack)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock, FILE: stock_picking.py) ---
