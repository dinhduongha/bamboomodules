...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockScrapAppService : GenericApplicationService<StockScrap>, IStockScrapAppService
    {
        ...
        public StockScrapAppService(IRepository<StockScrap, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
