...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountAssetDepreciationLineAppService : GenericApplicationService<AccountAssetDepreciationLine>, IAccountAssetDepreciationLineAppService
    {
        ...
        public AccountAssetDepreciationLineAppService(IRepository<AccountAssetDepreciationLine, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
