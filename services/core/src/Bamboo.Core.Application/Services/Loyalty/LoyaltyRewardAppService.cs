...
{
    [Module("Loyalty", Depends = new[] { "product", "portal", "account" })]
    public class LoyaltyRewardAppService : GenericApplicationService<LoyaltyReward>, ILoyaltyRewardAppService
    {
        private readonly IPosLoadMixinAppService _posLoadMixinAppService;
        public LoyaltyRewardAppService(IRepository<LoyaltyReward, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IPosLoadMixinAppService posLoadMixinAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
