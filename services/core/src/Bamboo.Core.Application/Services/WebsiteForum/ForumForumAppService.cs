...
{
    [Module("WebsiteForum", Depends = new[] { "auth_signup", "website_mail", "website_profile" })]
    public class ForumForumAppService : GenericApplicationService<ForumForum>, IForumForumAppService
    {
        ...
        protected async Task<ForumForum> ComputeTeaserInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: website_forum, FILE: forum_forum.py) ---
