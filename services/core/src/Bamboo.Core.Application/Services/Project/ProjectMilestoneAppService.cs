...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ProjectMilestoneAppService : GenericApplicationService<ProjectMilestone>, IProjectMilestoneAppService
    {
        ...
        public ProjectMilestoneAppService(IRepository<ProjectMilestone, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
