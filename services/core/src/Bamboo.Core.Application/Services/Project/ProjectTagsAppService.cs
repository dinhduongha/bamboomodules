...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ProjectTagsAppService : GenericApplicationService<ProjectTags>, IProjectTagsAppService
    {
        ...
        public ProjectTagsAppService(IRepository<ProjectTags, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {

        }

        public async Task<ProjectTags> ArrangeTagListByIdAsync(Guid id, object tag_list, object id_order)
        {
            /*
