...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ProjectTaskTypeAppService : GenericApplicationService<ProjectTaskType>, IProjectTaskTypeAppService
    {
        ...
        public ProjectTaskTypeAppService(IRepository<ProjectTaskType, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<ProjectTaskType> CopyDataAsync(Guid id, object @default)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: project, FILE: project_task_type.py) ---
        ...
        public async Task<ProjectTaskType> UnlinkWizardAsync(Guid id, object stage_view)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: project, FILE: project_task_type.py) ---
