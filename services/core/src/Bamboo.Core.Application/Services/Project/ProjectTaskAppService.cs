...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ProjectTaskAppService : GenericApplicationService<ProjectTask>, IProjectTaskAppService
    {
