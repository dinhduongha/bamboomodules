...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ProductAttributeValueAppService : GenericApplicationService<ProductAttributeValue>, IProductAttributeValueAppService
    {
        ...
        public ProductAttributeValueAppService(IRepository<ProductAttributeValue, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
