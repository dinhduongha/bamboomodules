...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MrpProductionAppService : GenericApplicationService<MrpProduction>, IMrpProductionAppService
    {
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: mrp_product_expiry, FILE: mrp_production.py) ---
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: project_mrp, FILE: mrp_production.py) ---
