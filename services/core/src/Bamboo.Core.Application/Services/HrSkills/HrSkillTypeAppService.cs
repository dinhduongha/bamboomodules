...
namespace Bamboo.Core.Application.Services
{
    ...
    public class HrSkillTypeAppService : GenericApplicationService<HrSkillType>, IHrSkillTypeAppService
    {
        ...
        public HrSkillTypeAppService(IRepository<HrSkillType, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
