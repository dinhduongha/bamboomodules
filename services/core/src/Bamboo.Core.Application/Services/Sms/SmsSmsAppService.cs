...
namespace Bamboo.Core.Application.Services
{
    ...
    public class SmsSmsAppService : GenericApplicationService<SmsSms>, ISmsSmsAppService
    {
        ...
        public SmsSmsAppService(IRepository<SmsSms, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
