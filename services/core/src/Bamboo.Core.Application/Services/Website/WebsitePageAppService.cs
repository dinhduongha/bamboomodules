...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class WebsitePageAppService : GenericApplicationService<WebsitePage>, IWebsitePageAppService
    {
        ...
        public WebsitePageAppService(IRepository<WebsitePage, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IWebsitePageOptionsMixinAppService websitePageOptionsMixinAppService, IWebsitePublishedMultiMixinAppService websitePublishedMultiMixinAppService, IWebsiteSearchableMixinAppService websiteSearchableMixinAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
