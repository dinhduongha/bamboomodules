...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ProductFeedAppService : GenericApplicationService<ProductFeed>, IProductFeedAppService
    {
        ...
        protected async Task<ProductFeed> PrepareGmcStockInfoInternalAsync(object product)
        {
            ...
            --- ODOO METHOD SOURCE (MODULE: website_sale_stock, FILE: product_feed.py) ---
