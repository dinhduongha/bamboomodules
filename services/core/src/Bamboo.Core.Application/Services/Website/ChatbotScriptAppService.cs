...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class ChatbotScriptAppService : GenericAppService<ChatbotScript>, IChatbotScriptAppService
    {
        ...
        public ChatbotScriptAppService(IRepository<ChatbotScript, Guid> repository, IServiceProvider serviceProvider, IDataFilter dataFilter, IObjectMapper objectMapper, IDistributedCache cache, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IImageMixinAppService imageMixinAppService, IUtmSourceMixinAppService utmSourceMixinAppService) : base(repository, serviceProvider, dataFilter, objectMapper, cache, authorizationService, domainParser, modelTypeRegistry)
        {
