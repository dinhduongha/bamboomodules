...
namespace Bamboo.Core.Application.Services
{
    ...
    public class BusPresenceAppService : GenericApplicationService<BusPresence>, IBusPresenceAppService
    {

        public BusPresenceAppService(IRepository<BusPresence, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
