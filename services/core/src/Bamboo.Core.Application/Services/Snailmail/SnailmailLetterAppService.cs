...
{
    [Module("Snailmail", Depends = new[] { "iap_mail", "mail" })]
    public class SnailmailLetterAppService : GenericApplicationService<SnailmailLetter>, ISnailmailLetterAppService
    {

        public SnailmailLetterAppService(IRepository<SnailmailLetter, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
