...
{
    public interface IDmsOutletVisitAppService : IGenericApplicationService<DmsOutletVisit>
    {
...
namespace Bamboo.Core.Application.Services
{
    ...
    public class DmsOutletVisitAppService : GenericApplicationService<DmsOutletVisit>, IDmsOutletVisitAppService
    {
