...
{
    public interface IResTeamAppService : IGenericAppService<ResTeam>
    {
...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ResTeamAppService : GenericAppService<ResTeam>, IResTeamAppService
    {
        public ResTeamAppService(
            IRepository<ResTeam, Guid> repository,
