...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MrpWorkcenterProductivityAppService : GenericApplicationService<MrpWorkcenterProductivity>, IMrpWorkcenterProductivityAppService
    {
        ...
        public MrpWorkcenterProductivityAppService(IRepository<MrpWorkcenterProductivity, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
