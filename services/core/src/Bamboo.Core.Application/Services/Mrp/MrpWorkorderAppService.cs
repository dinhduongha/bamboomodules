...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MrpWorkorderAppService : GenericApplicationService<MrpWorkorder>, IMrpWorkorderAppService
    {

        public MrpWorkorderAppService(IRepository<MrpWorkorder, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
