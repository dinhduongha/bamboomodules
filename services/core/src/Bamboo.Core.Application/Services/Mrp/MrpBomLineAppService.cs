...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MrpBomLineAppService : GenericApplicationService<MrpBomLine>, IMrpBomLineAppService
    {

        public MrpBomLineAppService(IRepository<MrpBomLine, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
