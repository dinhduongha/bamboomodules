...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ImLivechatChannelAppService : GenericApplicationService<ImLivechatChannel>, IImLivechatChannelAppService
    {
        ...
        public ImLivechatChannelAppService(IRepository<ImLivechatChannel, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IRatingParentMixinAppService ratingParentMixinAppService, IWebsitePublishedMixinAppService websitePublishedMixinAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<ImLivechatChannel> GetLivechatInfoAsync(Guid id, object username)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: im_livechat, FILE: im_livechat_channel.py) ---
