...
namespace Bamboo.Core.Application.Services
{
    ...
    public class CrmLostReasonAppService : GenericApplicationService<CrmLostReason>, ICrmLostReasonAppService
    {
        ...
        public CrmLostReasonAppService(IRepository<CrmLostReason, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
