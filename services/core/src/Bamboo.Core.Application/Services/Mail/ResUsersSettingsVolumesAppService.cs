...
namespace Bamboo.Core.Application.Services
{
    ...
    public class ResUsersSettingsVolumesAppService : GenericApplicationService<ResUsersSettingsVolumes>, IResUsersSettingsVolumesAppService
    {

        public ResUsersSettingsVolumesAppService(IRepository<ResUsersSettingsVolumes, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
