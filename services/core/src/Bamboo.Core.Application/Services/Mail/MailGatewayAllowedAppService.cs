...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MailGatewayAllowedAppService : GenericApplicationService<MailGatewayAllowed>, IMailGatewayAllowedAppService
    {
        ...
        public MailGatewayAllowedAppService(IRepository<MailGatewayAllowed, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
