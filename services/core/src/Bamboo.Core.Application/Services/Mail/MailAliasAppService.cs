...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MailAliasAppService : GenericApplicationService<MailAlias>, IMailAliasAppService
    {
        ...
        public MailAliasAppService(IRepository<MailAlias, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
