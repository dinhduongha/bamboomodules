...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MailMessageReactionAppService : GenericApplicationService<MailMessageReaction>, IMailMessageReactionAppService
    {
        ...
        public MailMessageReactionAppService(IRepository<MailMessageReaction, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
