...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MailActivityPlanAppService : GenericApplicationService<MailActivityPlan>, IMailActivityPlanAppService
    {

        public MailActivityPlanAppService(IRepository<MailActivityPlan, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<MailActivityPlan> CopyDataAsync(Guid id, object @default)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: mail, FILE: mail_activity_plan.py) ---
