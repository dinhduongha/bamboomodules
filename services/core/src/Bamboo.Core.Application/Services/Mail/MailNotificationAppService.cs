...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MailNotificationAppService : GenericApplicationService<MailNotification>, IMailNotificationAppService
    {
        ...
        public MailNotificationAppService(IRepository<MailNotification, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
