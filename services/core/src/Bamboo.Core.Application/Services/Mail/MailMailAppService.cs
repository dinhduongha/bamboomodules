...
namespace Bamboo.Core.Application.Services
{
    ...
    public class MailMailAppService : GenericApplicationService<MailMail>, IMailMailAppService
    {

        public MailMailAppService(IRepository<MailMail, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<MailMail> MarkOutgoingAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: mail, FILE: mail_mail.py) ---
        ...
        public async Task<MailMail> OpenDocumentAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: mail, FILE: mail_mail.py) ---
        ...
        public async Task<MailMail> RetryAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: mail, FILE: mail_mail.py) ---
        ...
        public async Task<MailMail> SendAfterCommitAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: mail, FILE: mail_mail.py) ---
