...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class IrActionsActWindowAppService : GenericAppService<IrActWindow>, IIrActionsActWindowAppService
    {
        ...
        public IrActionsActWindowAppService(IRepository<IrActWindow, Guid> repository, ICurrentTenant currentTenant, IDistributedCache cache, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IIrActionsActionsAppService irActionsActionsAppService) : base(repository, currentTenant, cache, domainParser, modelTypeRegistry)
        {
