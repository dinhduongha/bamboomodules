...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class IrUiViewAppService : GenericApplicationService<IrUiView>, IIrUiViewAppService
    {
        ...
        public IrUiViewAppService(IRepository<IrUiView, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IWebsiteSeoMetadataAppService websiteSeoMetadataAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
