...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class ResDeviceLogAppService : GenericAppService<ResDeviceLog>, IResDeviceLogAppService
    {
        ...
        public ResDeviceLogAppService(IRepository<ResDeviceLog, Guid> repository, ICurrentTenant currentTenant, IDistributedCache cache, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry) : base(repository, currentTenant, cache, domainParser, modelTypeRegistry)
        {
