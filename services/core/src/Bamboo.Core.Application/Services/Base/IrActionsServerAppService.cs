...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class IrActionsServerAppService : GenericAppService<IrActServer>, IIrActionsServerAppService
    {
        ...
        public IrActionsServerAppService(IRepository<IrActServer, Guid> repository, IServiceProvider serviceProvider, IDataFilter dataFilter, IObjectMapper objectMapper, IDistributedCache cache, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IIrActionsActionsAppService irActionsActionsAppService, IMailActivityMixinAppService mailActivityMixinAppService, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, dataFilter, objectMapper, cache, authorizationService, domainParser, modelTypeRegistry)
        {
