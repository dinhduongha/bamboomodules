...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class IrCronAppService : GenericAppService<IrCron>, IIrCronAppService
    {
        ...
        public IrCronAppService(IRepository<IrCron, Guid> repository, ICurrentTenant currentTenant, IDistributedCache cache, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry) : base(repository, currentTenant, cache, domainParser, modelTypeRegistry)
        {
        ...
        {
            /*
            --- METHOD SOURCE (MODULE: base, FILE: ir_cron.py, METHOD: try_write) ---
            */
            var entity = await Repository.GetAsync(input.Ids[0]);
            await Task.CompletedTask;
            return default;
