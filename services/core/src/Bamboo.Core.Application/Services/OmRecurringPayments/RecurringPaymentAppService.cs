...
namespace Bamboo.Core.Application.Services
{
    ...
    public class RecurringPaymentAppService : GenericApplicationService<RecurringPayment>, IRecurringPaymentAppService
    {
        ...
        public RecurringPaymentAppService(IRepository<RecurringPayment, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
