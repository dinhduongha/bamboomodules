...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountRecurringTemplateAppService : GenericApplicationService<AccountRecurringTemplate>, IAccountRecurringTemplateAppService
    {

        public AccountRecurringTemplateAppService(IRepository<AccountRecurringTemplate, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
