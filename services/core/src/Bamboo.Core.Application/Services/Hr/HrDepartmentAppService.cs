...
namespace Bamboo.Core.Application.Services
{
    ...
    public class HrDepartmentAppService : GenericApplicationService<HrDepartment>, IHrDepartmentAppService
    {
        ...
        public HrDepartmentAppService(IRepository<HrDepartment, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailActivityMixinAppService mailActivityMixinAppService, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<HrDepartment> GetFormviewActionAsync(Guid id, object access_uid)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: hr, FILE: hr_department.py) ---
