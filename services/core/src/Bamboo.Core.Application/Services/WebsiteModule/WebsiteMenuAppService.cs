...
namespace Bamboo.Core.Application.Services
{
    ...
    public class WebsiteMenuAppService : GenericApplicationService<WebsiteMenu>, IWebsiteMenuAppService
    {
        ...
        public WebsiteMenuAppService(IRepository<WebsiteMenu, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
