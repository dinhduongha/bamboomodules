...
namespace Bamboo.Core.Application.Services
{
    ...
    public class WebsiteRewriteAppService : GenericApplicationService<WebsiteRewrite>, IWebsiteRewriteAppService
    {
        ...
        public WebsiteRewriteAppService(IRepository<WebsiteRewrite, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
