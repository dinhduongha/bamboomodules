...
{
    [Module("l10n_tr_nilvera_einvoice", Depends = new[] { "l10n_tr_nilvera", "account_edi_ubl_cii" })]
    public class AccountEdiXmlUblTrAppService : ApplicationService, IAccountEdiXmlUblTrAppService
    {

        public AccountEdiXmlUblTrAppService() 
        {

        }

        public async Task<TEntity> ExportInvoiceFilenameInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
        ...
        public async Task<TEntity> ExportInvoiceValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetAdditionalDocumentReferenceListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetCountryValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object country) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetDeliveryValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoiceLineAllowanceValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object line, object tax_values_list) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoiceLineItemValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object line, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoiceLinePriceValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object line) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoiceLineValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object line, Guid line_id, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoiceMonetaryTotalValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object taxes_vals, object line_extension_amount, object allowance_total_amount, object charge_total_amount) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoicePaymentMeansValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoicePeriodValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetInvoiceTaxTotalsValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetPartnerAddressValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetPartnerPartyIdentificationValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetPartnerPartyLegalEntityValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetPartnerPartyTaxSchemeValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner, object role) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetPartnerPersonValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetPricingExchangeRateValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> GetTaxCategoryListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object customer, object supplier, object taxes) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> ImportFillInvoiceFormInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object tree, object qty_factor) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> ImportRetrievePartnerValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object tree, object role) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
        ...
        public async Task<TEntity> L10nTrGetAmountIntegerPartnTextNoteInternalAsync<TEntity>(IEnumerable<TEntity> entities, object amount, object currency) where TEntity : IEntity<Guid>, IAccountEdiXmlUblTrable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_tr_nilvera_einvoice, FILE: account_edi_xml_ubl_tr.py) ---
