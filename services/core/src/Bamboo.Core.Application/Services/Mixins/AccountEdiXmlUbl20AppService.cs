...
namespace Bamboo.Core.Application.Services.Mixins
{
    ...
    public class AccountEdiXmlUbl20AppService : ApplicationService, IAccountEdiXmlUbl20AppService
    {
        ...
        public async Task<TEntity> GetCurrencyDecimalPlacesInternalAsync<TEntity>(IEnumerable<TEntity> entities, Guid currency_id) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl20able
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_dk_oioubl, FILE: account_edi_xml_oioubl_201.py) ---
        ...
        public async Task<TEntity> GetTaxCategoryListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object customer, object supplier, object taxes) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl20able
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_dk_oioubl, FILE: account_edi_xml_oioubl_201.py) ---
