...
namespace Bamboo.Core.Application.Services.Mixins
{
    ...
    public class PropertiesBaseDefinitionMixinAppService : ApplicationService, IPropertiesBaseDefinitionMixinAppService
    {
        private readonly IServiceProvider _serviceProvider;
        public PropertiesBaseDefinitionMixinAppService(IServiceProvider serviceProvider) 
        {
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: base, FILE: properties_base_definition_mixin.py) ---
