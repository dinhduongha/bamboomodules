...
{
    [Module("l10n_sa_edi", Depends = new[] { "account_edi", "account_edi_ubl_cii", "account_debit_note", "l10n_sa", "base_vat", "certificate" })]
    public class AccountEdiXmlUbl21ZatcaAppService : ApplicationService, IAccountEdiXmlUbl21ZatcaAppService
    {

        public AccountEdiXmlUbl21ZatcaAppService() 
        {

        }

        public async Task<TEntity> ApplyInvoiceLineFilterInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice_line) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
        ...
        public async Task<TEntity> ApplyInvoiceTaxFilterInternalAsync<TEntity>(IEnumerable<TEntity> entities, object base_line, object tax_values) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> ExportInvoiceFilenameInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> ExportInvoiceValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetDeliveryValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetDocumentAllowanceChargeValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetInvoiceLineItemValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object line, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetInvoiceLineValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object line, Guid line_id, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetInvoicePaymentMeansValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetInvoicePaymentTermsValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetInvoiceTaxTotalsValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetPartnerAddressValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetPartnerContactValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetPartnerPartyIdentificationValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetPartnerPartyLegalEntityValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetPartnerPartyTaxSchemeValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner, object role) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetTaxCategoryListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object customer, object supplier, object taxes) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> GetTaxUneceCodesInternalAsync<TEntity>(IEnumerable<TEntity> entities, object customer, object supplier, object tax) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGenerateInvoiceXmlHashInternalAsync<TEntity>(IEnumerable<TEntity> entities, object xml_content, object mode) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGenerateInvoiceXmlShaInternalAsync<TEntity>(IEnumerable<TEntity> entities, object xml_content) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetAdditionalTaxTotalValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetBillingReferenceValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetInvoiceTransactionCodeInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetInvoiceTypeInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetLinePrepaymentValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object line, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetMonetaryValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetNamespacesInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetPaymentMeansCodeInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
            ...
            // return 'unknown'
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi_pos, FILE: account_edi_xml_ubl_21_zatca.py) ---
            // def _l10n_sa_get_payment_means_code(self, invoice):
            // """
            //     Return payment means code to be used to set the value on the XML file
            // """
        ...
        public async Task<TEntity> L10nSaGetPrepaidAmountInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaGetPreviousInvoiceHashInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
        ...
        public async Task<TEntity> L10nSaPostprocessLineValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object vals) where TEntity : IEntity<Guid>, IAccountEdiXmlUbl21Zatcaable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_sa_edi, FILE: account_edi_xml_ubl_21_zatca.py) ---
