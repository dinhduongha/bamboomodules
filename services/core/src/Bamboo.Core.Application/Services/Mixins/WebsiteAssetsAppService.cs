...
namespace Bamboo.Core.Application.Services.Mixins
{
    ...
    public class WebsiteAssetsAppService : ApplicationService, IWebsiteAssetsAppService
    {
        private readonly IServiceProvider _serviceProvider;
        public WebsiteAssetsAppService(IServiceProvider serviceProvider) 
        {
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: website, FILE: assets.py) ---
