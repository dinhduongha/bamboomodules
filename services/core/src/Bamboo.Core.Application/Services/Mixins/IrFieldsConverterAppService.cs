...
namespace Bamboo.Core.Application.Services.Mixins
{
    ...
    public class IrFieldsConverterAppService : ApplicationService, IIrFieldsConverterAppService
    {
        private readonly IServiceProvider _serviceProvider;
        public IrFieldsConverterAppService(IServiceProvider serviceProvider) 
        {
