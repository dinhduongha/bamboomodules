...
namespace Bamboo.Core.Application.Services.Mixins
{
    ...
    public class CalendarAlarmManagerAppService : ApplicationService, ICalendarAlarmManagerAppService
    {
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: calendar, FILE: calendar_alarm_manager.py) ---
        ...
        public async Task<TEntity> GetNotifyAlertExtraConditionsInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, ICalendarAlarmManagerable
        {
            ...
            // """
            // return SQL("")
            --- ODOO METHOD SOURCE (MODULE: google_calendar, FILE: calendar_alarm_manager.py) ---
            // def _get_notify_alert_extra_conditions(self):
            // base = super()._get_notify_alert_extra_conditions()
            // return SQL("%s AND event.google_id IS NULL", base)
            --- ODOO METHOD SOURCE (MODULE: microsoft_calendar, FILE: calendar_alarm_manager.py) ---
            // def _get_notify_alert_extra_conditions(self):
            // base = super()._get_notify_alert_extra_conditions()
