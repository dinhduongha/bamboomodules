...
{
    [Module("l10n_my_ubl_pint", Depends = new[] { "account_edi_ubl_cii" })]
    public class AccountEdiXmlPintMyAppService : ApplicationService, IAccountEdiXmlPintMyAppService
    {

        public AccountEdiXmlPintMyAppService() 
        {

        }

        public async Task<TEntity> ExportInvoiceConstraintsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object vals) where TEntity : IEntity<Guid>, IAccountEdiXmlPintMyable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_my_ubl_pint, FILE: account_edi_xml_pint_my.py) ---
        ...
        public async Task<TEntity> ExportInvoiceFilenameInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlPintMyable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_my_ubl_pint, FILE: account_edi_xml_pint_my.py) ---
        ...
        public async Task<TEntity> ExportInvoiceValsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice) where TEntity : IEntity<Guid>, IAccountEdiXmlPintMyable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_my_ubl_pint, FILE: account_edi_xml_pint_my.py) ---
        ...
        public async Task<TEntity> GetInvoiceTaxTotalsValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object taxes_vals) where TEntity : IEntity<Guid>, IAccountEdiXmlPintMyable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_my_ubl_pint, FILE: account_edi_xml_pint_my.py) ---
        ...
        public async Task<TEntity> GetPartnerPartyTaxSchemeValsListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object partner, object role) where TEntity : IEntity<Guid>, IAccountEdiXmlPintMyable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_my_ubl_pint, FILE: account_edi_xml_pint_my.py) ---
        ...
        public async Task<TEntity> GetTaxUneceCodesInternalAsync<TEntity>(IEnumerable<TEntity> entities, object customer, object supplier, object tax) where TEntity : IEntity<Guid>, IAccountEdiXmlPintMyable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_my_ubl_pint, FILE: account_edi_xml_pint_my.py) ---
