...
namespace Bamboo.Core.Application.Services.Mixins
{
    ...
    public partial class GoogleGmailMixinAppService : ApplicationService, IGoogleGmailMixinAppService
    {
        ...
        public async Task<TEntity> ConnectInternalAsync<TEntity>(IEnumerable<TEntity> entities, object host, object port, object user, object password, object encryption, object smtp_from, object ssl_certificate, object ssl_private_key, object smtp_debug, Guid mail_server_id, object allow_archived) where TEntity : IEntity<Guid>, IGoogleGmailMixinable
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: base, FILE: ir_mail_server.py) ---
