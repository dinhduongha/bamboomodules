...
namespace Bamboo.Core.Application.Services
{
    ...
    public class HrLeaveAllocationAppService : GenericApplicationService<HrLeaveAllocation>, IHrLeaveAllocationAppService
    {
        private readonly IMailActivityMixinAppService _mailActivityMixinAppService;
        private readonly IMailThreadAppService _mailThreadAppService;
        public HrLeaveAllocationAppService(IRepository<HrLeaveAllocation, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailActivityMixinAppService mailActivityMixinAppService, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<HrLeaveAllocation> AddFollowerAsync(Guid id, Guid employee_id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: hr_holidays, FILE: hr_leave_allocation.py) ---
        ...
        public async Task<HrLeaveAllocation> MessageSubscribeAsync(Guid id, List<Guid> partner_ids, List<Guid> subtype_ids)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: hr_holidays, FILE: hr_leave_allocation.py) ---
