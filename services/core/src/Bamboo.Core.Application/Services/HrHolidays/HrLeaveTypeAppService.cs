...
namespace Bamboo.Core.Application.Services
{
    ...
    public class HrLeaveTypeAppService : GenericApplicationService<HrLeaveType>, IHrLeaveTypeAppService
    {
        ...
        public HrLeaveTypeAppService(IRepository<HrLeaveType, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<HrLeaveType> CopyDataAsync(Guid id, object @default)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: hr_holidays, FILE: hr_leave_type.py) ---
        ...
        public async Task<HrLeaveType> GetAllocationDataAsync(Guid id, object employees, object date)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: hr_holidays, FILE: hr_leave_type.py) ---
        ...
        public async Task<HrLeaveType> GetAllocationDataRequestAsync(Guid id, object target_date, object hidden_allocations)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: hr_holidays, FILE: hr_leave_type.py) ---
