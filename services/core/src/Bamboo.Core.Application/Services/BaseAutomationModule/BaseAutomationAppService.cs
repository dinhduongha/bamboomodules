...
{
    [Module("BaseAutomationModule", Depends = new[] { "base", "digest", "resource", "mail", "sms" })]
    public class BaseAutomationAppService : GenericApplicationService<BaseAutomation>, IBaseAutomationAppService
    {

        public BaseAutomationAppService(IRepository<BaseAutomation, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
