...
namespace Bamboo.Core.Application.Services
{
    ...
    public class FleetVehicleModelBrandAppService : GenericApplicationService<FleetVehicleModelBrand>, IFleetVehicleModelBrandAppService
    {
        ...
        public FleetVehicleModelBrandAppService(IRepository<FleetVehicleModelBrand, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
