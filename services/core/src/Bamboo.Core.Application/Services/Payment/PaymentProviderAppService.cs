...
namespace Bamboo.Core.Application.Services
{
    ...
    public class PaymentProviderAppService : GenericApplicationService<PaymentProvider>, IPaymentProviderAppService
    {
        ...
        public PaymentProviderAppService(IRepository<PaymentProvider, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
