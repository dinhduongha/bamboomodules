...
namespace Bamboo.Core.Application.Services
{
    ...
    public class PaymentTransactionAppService : GenericApplicationService<PaymentTransaction>, IPaymentTransactionAppService
    {
        ...
        public PaymentTransactionAppService(IRepository<PaymentTransaction, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
