...
{
    [Module("Payment", Depends = new[] { "onboarding", "portal" })]
    public class PaymentTokenAppService : GenericApplicationService<PaymentToken>, IPaymentTokenAppService
    {

        public PaymentTokenAppService(IRepository<PaymentToken, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
