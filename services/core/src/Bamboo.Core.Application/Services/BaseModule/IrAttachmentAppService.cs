...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrAttachmentAppService : GenericApplicationService<IrAttachment>, IIrAttachmentAppService
    {
        ...
        public IrAttachmentAppService(IRepository<IrAttachment, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IBusListenerMixinAppService busListenerMixinAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
