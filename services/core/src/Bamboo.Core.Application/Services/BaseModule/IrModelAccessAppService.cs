...
{
    [Module("BaseModule")]
    public class IrModelAccessAppService : GenericApplicationService<IrModelAccess>, IIrModelAccessAppService
    {

        public IrModelAccessAppService(IRepository<IrModelAccess, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
