...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrModelAppService : GenericApplicationService<IrModel>, IIrModelAppService
    {
        ...
        public IrModelAppService(IRepository<IrModel, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
