...
namespace Bamboo.Core.Application.Services
{
    ...
    public class BaseEnableProfilingWizardAppService : GenericApplicationService<BaseEnableProfilingWizard>, IBaseEnableProfilingWizardAppService
    {
        ...
        public BaseEnableProfilingWizardAppService(IRepository<BaseEnableProfilingWizard, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
