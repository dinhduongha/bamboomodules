...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrConfigParameterAppService : GenericApplicationService<IrConfigParameter>, IIrConfigParameterAppService
    {
        ...
        public IrConfigParameterAppService(IRepository<IrConfigParameter, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
