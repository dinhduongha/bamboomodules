...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrAssetAppService : GenericApplicationService<IrAsset>, IIrAssetAppService
    {
        ...
        public IrAssetAppService(IRepository<IrAsset, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
