...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrModuleModuleDependencyAppService : GenericApplicationService<IrModuleModuleDependency>, IIrModuleModuleDependencyAppService
    {
        ...
        public IrModuleModuleDependencyAppService(IRepository<IrModuleModuleDependency, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {

        }

        public async Task<IrModuleModuleDependency> AllDependenciesAsync(Guid id, object module_names)
        {
            /*
