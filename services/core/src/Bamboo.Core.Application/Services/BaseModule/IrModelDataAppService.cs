...
{
    [Module("BaseModule")]
    public class IrModelDataAppService : GenericApplicationService<IrModelData>, IIrModelDataAppService
    {

        public IrModelDataAppService(IRepository<IrModelData, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
