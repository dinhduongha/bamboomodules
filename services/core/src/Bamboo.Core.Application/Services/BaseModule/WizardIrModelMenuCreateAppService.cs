...
namespace Bamboo.Core.Application.Services
{
    ...
    public class WizardIrModelMenuCreateAppService : GenericApplicationService<WizardIrModelMenuCreate>, IWizardIrModelMenuCreateAppService
    {
        ...
        public WizardIrModelMenuCreateAppService(IRepository<WizardIrModelMenuCreate, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
