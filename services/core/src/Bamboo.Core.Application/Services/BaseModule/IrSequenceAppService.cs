...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrSequenceAppService : GenericApplicationService<IrSequence>, IIrSequenceAppService
    {
        ...
        public IrSequenceAppService(IRepository<IrSequence, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
