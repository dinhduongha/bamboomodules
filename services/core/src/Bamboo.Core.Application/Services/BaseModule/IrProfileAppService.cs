...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrProfileAppService : GenericApplicationService<IrProfile>, IIrProfileAppService
    {
        ...
        public IrProfileAppService(IRepository<IrProfile, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
