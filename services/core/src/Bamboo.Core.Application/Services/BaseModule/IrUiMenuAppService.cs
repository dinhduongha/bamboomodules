...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IrUiMenuAppService : GenericApplicationService<IrUiMenu>, IIrUiMenuAppService
    {
        ...
        public IrUiMenuAppService(IRepository<IrUiMenu, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
