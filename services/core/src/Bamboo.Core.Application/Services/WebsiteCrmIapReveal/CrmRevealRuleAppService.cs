...
namespace Bamboo.Core.Application.Services
{
    ...
    public class CrmRevealRuleAppService : GenericApplicationService<CrmRevealRule>, ICrmRevealRuleAppService
    {

        public CrmRevealRuleAppService(IRepository<CrmRevealRule, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
