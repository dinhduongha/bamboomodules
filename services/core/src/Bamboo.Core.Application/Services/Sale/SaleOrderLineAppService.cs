...
namespace Bamboo.Core.Application.Services
{
    ...
    public class SaleOrderLineAppService : GenericApplicationService<SaleOrderLine>, ISaleOrderLineAppService
    {
        ...
        protected async Task<SaleOrderLine> ActionLaunchStockRuleInternalAsync(object previous_product_uom_qty)
        {
            /*
        ...
        public async Task<SaleOrderLine> AddFromCatalogAsync(Guid id)
        {
            /*
        ...
        protected async Task<SaleOrderLine> AddMissingDefaultValuesInternalAsync(object values)
        {
            /*
        ...
        protected async Task<SaleOrderLine> ComputeEventTicketIdInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: event_sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> ComputeIsEventBoothInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: event_booth_sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> ComputeProductPackagingIdInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> ComputeProductPackagingQtyInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> ComputeProductUomInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> ComputeTaxIdInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale, FILE: sale_order_line.py) ---
        ...
        public override async Task<SaleOrderLine> CreateAsync(SaleOrderLine entity, List<string> fields)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: repair, FILE: sale_order.py) ---
        ...
        protected async Task<SaleOrderLine> CreateProcurementsInternalAsync(object product_qty, object procurement_uom, object origin, object values)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale_stock, FILE: sale_order_line.py) ---
        ...
        public override async Task<SaleOrderLine> DefaultGetAsync(List<string> fields)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale_project, FILE: sale_order_line.py) ---
        ...
        public async Task<SaleOrderLine> GetDescriptionFollowingLinesAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: website_sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> GetProcurementGroupInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale_stock, FILE: sale_order_line.py) ---
        ...
        public async Task<SaleOrderLine> HasValuedMoveIdsAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: repair, FILE: sale_order.py) ---
        ...
        public async Task<SaleOrderLine> InitAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale_service, FILE: sale_order_line.py) ---
            // def init(self):
        ...
        protected async Task<SaleOrderLine> IsNotSellableLineInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: delivery, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> LinesWithoutPriceRecomputationInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale_management, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> LoadPosDataDomainInternalAsync(object data)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: pos_sale, FILE: sale_order.py) ---
        ...
        protected async Task<SaleOrderLine> LoadPosDataFieldsInternalAsync(Guid config_id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: pos_sale, FILE: sale_order.py) ---
        ...
        public override async Task<object> NameCreateAsync(string name)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale_project, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> OnchangeProductIdWarningInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> OnchangeProductPackagingIdInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> PrepareProcurementGroupValsInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale_stock, FILE: sale_order_line.py) ---
        ...
        protected async Task<SaleOrderLine> PrepareProcurementValuesInternalAsync(Guid group_id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: sale, FILE: sale_order_line.py) ---
        ...
        public async Task<SaleOrderLine> ReadConvertedAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: pos_sale, FILE: sale_order.py) ---
        ...
        protected async Task<SaleOrderLine> SetShopWarningStockInternalAsync(object desired_qty, object new_qty)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: website_sale_stock, FILE: sale_order_line.py) ---
        ...
        public override async Task<List<object>> WriteAsync(List<Guid> ids, SaleOrderLine entity, List<string> fields)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: repair, FILE: sale_order.py) ---
            // def write(self, vals):
