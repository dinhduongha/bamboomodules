...
namespace Bamboo.Core.Application.Services
{
    ...
    public class SaleOrderOptionAppService : GenericApplicationService<SaleOrderOption>, ISaleOrderOptionAppService
    {
        ...
        public SaleOrderOptionAppService(IRepository<SaleOrderOption, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
