...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockLandedCostAppService : GenericApplicationService<StockLandedCost>, IStockLandedCostAppService
    {
        ...
        public StockLandedCostAppService(IRepository<StockLandedCost, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailActivityMixinAppService mailActivityMixinAppService, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
