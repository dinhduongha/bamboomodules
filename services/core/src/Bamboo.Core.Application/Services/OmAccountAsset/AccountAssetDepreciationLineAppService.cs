...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountAssetDepreciationLineAppService : GenericApplicationService<AccountAssetDepreciationLine>, IAccountAssetDepreciationLineAppService
    {

        public AccountAssetDepreciationLineAppService(IRepository<AccountAssetDepreciationLine, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {

        }

        public async Task<AccountAssetDepreciationLine> CreateGroupedMoveAsync(Guid id, object post_move)
        {
            /*
        ...
        public async Task<AccountAssetDepreciationLine> CreateMoveAsync(Guid id, object post_move)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: om_account_asset, FILE: account_asset.py) ---
