...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class SmsTemplateAppService : GenericAppService<SmsTemplate>, ISmsTemplateAppService
    {
        ...
        public SmsTemplateAppService(IRepository<SmsTemplate, Guid> repository, IServiceProvider serviceProvider, IDataFilter dataFilter, IObjectMapper objectMapper, IDistributedCache cache, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IMailRenderMixinAppService mailRenderMixinAppService, ITemplateResetMixinAppService templateResetMixinAppService) : base(repository, serviceProvider, dataFilter, objectMapper, cache, authorizationService, domainParser, modelTypeRegistry)
        {
