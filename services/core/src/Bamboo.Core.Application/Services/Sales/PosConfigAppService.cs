...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class PosConfigAppService : GenericAppService<PosConfig>, IPosConfigAppService
    {
        ...
        public PosConfigAppService(IRepository<PosConfig, Guid> repository, IServiceProvider serviceProvider, IDataFilter dataFilter, IObjectMapper objectMapper, IDistributedCache cache, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IHrMixinAppService hrMixinAppService, IPosBusMixinAppService posBusMixinAppService, IPosLoadMixinAppService posLoadMixinAppService) : base(repository, serviceProvider, dataFilter, objectMapper, cache, authorizationService, domainParser, modelTypeRegistry)
        {
