...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class CrmTeamAppService : GenericAppService<CrmTeam>, ICrmTeamAppService
    {
        ...
        public CrmTeamAppService(IRepository<CrmTeam, Guid> repository, IServiceProvider serviceProvider, IDataFilter dataFilter, IObjectMapper objectMapper, IDistributedCache cache, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IMailAliasMixinAppService mailAliasMixinAppService, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, dataFilter, objectMapper, cache, authorizationService, domainParser, modelTypeRegistry)
        {
