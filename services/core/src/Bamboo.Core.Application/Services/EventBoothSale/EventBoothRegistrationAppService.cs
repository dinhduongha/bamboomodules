...
namespace Bamboo.Core.Application.Services
{
    ...
    public class EventBoothRegistrationAppService : GenericApplicationService<EventBoothRegistration>, IEventBoothRegistrationAppService
    {
        ...
        public EventBoothRegistrationAppService(IRepository<EventBoothRegistration, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
