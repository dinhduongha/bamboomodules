...
{
    [Module("WebsiteSlides", Depends = new[] { "portal_rating", "website", "website_mail", "website_profile" })]
    public class SlideSlideAppService : GenericApplicationService<SlideSlide>, ISlideSlideAppService
    {
