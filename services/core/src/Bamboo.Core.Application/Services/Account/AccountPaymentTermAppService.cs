...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountPaymentTermAppService : GenericApplicationService<AccountPaymentTerm>, IAccountPaymentTermAppService
    {
        ...
        public AccountPaymentTermAppService(IRepository<AccountPaymentTerm, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
