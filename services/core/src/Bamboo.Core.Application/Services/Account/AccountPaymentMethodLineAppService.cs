...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountPaymentMethodLineAppService : GenericApplicationService<AccountPaymentMethodLine>, IAccountPaymentMethodLineAppService
    {

        public AccountPaymentMethodLineAppService(IRepository<AccountPaymentMethodLine, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
