...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountLockExceptionAppService : GenericApplicationService<AccountLockException>, IAccountLockExceptionAppService
    {
        ...
        public AccountLockExceptionAppService(IRepository<AccountLockException, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
