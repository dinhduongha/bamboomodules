...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountTaxAppService : GenericApplicationService<AccountTax>, IAccountTaxAppService
    {
        private readonly IMailThreadAppService _mailThreadAppService;
        private readonly IPosLoadMixinAppService _posLoadMixinAppService;
        public AccountTaxAppService(IRepository<AccountTax, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailThreadAppService mailThreadAppService, IPosLoadMixinAppService posLoadMixinAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
            _mailThreadAppService = mailThreadAppService;
            _posLoadMixinAppService = posLoadMixinAppService;
        }

        protected async Task<AccountTax> AdaptPriceUnitToAnotherTaxesInternalAsync(object price_unit, object product, object original_taxes, object new_taxes)
        {
            /*
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account_tax_python, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> CheckFormulaInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account_tax_python, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> DispatchNegativeLinesInternalAsync(object base_lines, object sorting_criteria, object additional_dispatching_method)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> GetNegativeLinesSortingCandidateCriteriaInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> GetTaxDetailsInternalAsync(object price_unit, object quantity, object precision_rounding, object rounding_method, object product, object special_mode, object manual_tax_amounts, object filter_tax_function)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> HookComputeIsUsedInternalAsync(object taxes_to_compute)
        {
            ...
            // 
            // return used_taxes
            --- ODOO METHOD SOURCE (MODULE: purchase, FILE: account_tax.py) ---
            // def _hook_compute_is_used(self, taxes_to_compute):
        ...
        protected async Task<AccountTax> LoadPosDataFieldsInternalAsync(Guid config_id)
        {
            ...
            // ]
            --- ODOO METHOD SOURCE (MODULE: pos_account_tax_python, FILE: account_tax.py) ---
            // def _load_pos_data_fields(self, config_id):
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account_edi_ubl_cii_tax_extension, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> RequiresExemptionReasonInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account_edi_ubl_cii_tax_extension, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> SearchInternalAsync(object domain, object offset, object limit, object order)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account, FILE: account_tax.py) ---
        ...
        protected async Task<AccountTax> SearchNameInternalAsync(object @operator, object @value)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account, FILE: account_tax.py) ---
