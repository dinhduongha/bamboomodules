...
namespace Bamboo.Core.Application.Services
{
    ...
    public class AccountPaymentAppService : GenericApplicationService<AccountPayment>, IAccountPaymentAppService
    {
        ...
        public AccountPaymentAppService(IRepository<AccountPayment, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailActivityMixinAppService mailActivityMixinAppService, IMailThreadMainAttachmentAppService mailThreadMainAttachmentAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        public async Task<AccountPayment> CancelAsync(Guid id)
        {
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
            // def action_cancel(self):
        ...
        protected async Task<AccountPayment> ComputeAmountInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> ComputeDisplayWithholdingInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_account_withholding_tax, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> ComputeL10nChReferenceWarningMsgInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ch, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> ComputeL10nInTotalWithholdingAmountInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_withholding_payment, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> ComputeL10nLatamCheckWarningMsgInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> ComputePaymentReceiptTitleInternalAsync()
        {
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_au, FILE: account_payment.py) ---
            // def _compute_payment_receipt_title(self):
            // # OVERRIDE
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_nz, FILE: account_payment.py) ---
            // def _compute_payment_receipt_title(self):
            // # OVERRIDE
            // super()._compute_payment_receipt_title()
        ...
        protected async Task<AccountPayment> ComputeShouldWithholdTaxInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_account_withholding_tax, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> ComputeWithholdingHideTaxBaseAccountInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_account_withholding_tax, FILE: account_payment.py) ---
        ...
        public async Task<AccountPayment> CopyDataAsync(Guid id, object @default)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: account, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> GetBlockingL10nLatamWarningMsgInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> GetLatamChecksInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> GetReconciledChecksErrorInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> IsLatamCheckPaymentInternalAsync(object check_subtype)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> IsLatamCheckTransferInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> L10nChReferenceIsValidInternalAsync(object payment_reference)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ch, FILE: account_payment.py) ---
        ...
        public async Task<AccountPayment> L10nInWithholdingEntriesAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_in_withholding, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> L10nLatamCheckSplitMoveInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> L10nLatamCheckUnlinkSplitMoveInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_latam_check, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> OnchangeWithholdingLineIdsInternalAsync()
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_account_withholding_tax, FILE: account_payment.py) ---
        ...
        public async Task<AccountPayment> OpenL10nPh2307WizardAsync(Guid id)
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: l10n_ph, FILE: account_payment.py) ---
        ...
        protected async Task<AccountPayment> SynchronizeToMovesInternalAsync(object changed_fields)
        {
            ...
            --- ODOO METHOD SOURCE (MODULE: l10n_ar_withholding, FILE: account_payment.py) ---
            // def _synchronize_to_moves(self, changed_fields):
