...
namespace Bamboo.Core.Application.Services
{
    ...
    public class StockPackageAppService : GenericApplicationService<StockPackage>, IStockPackageAppService
    {

        public StockPackageAppService(IRepository<StockPackage, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
        ...
        {
            /*
            --- ODOO METHOD SOURCE (MODULE: stock_delivery, FILE: stock_package.py) ---
