...
namespace Bamboo.Core.Application.Services
{
    ...
    public partial class StockRuleAppService : GenericAppService<StockRule>, IStockRuleAppService
    {
        ...
        public StockRuleAppService(IRepository<StockRule, Guid> repository, ICurrentTenant currentTenant, IDistributedCache cache, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry) : base(repository, currentTenant, cache, domainParser, modelTypeRegistry)
        {
        ...
        {
            /*
            --- METHOD SOURCE (MODULE: stock, FILE: stock_rule.py, METHOD: copy_data) ---
            */
        ...
        public async Task<StockRule> RunAsync(StockRuleRunRequestDto input)
        {
            ...
            --- METHOD SOURCE (MODULE: purchase_stock, FILE: stock_rule.py, METHOD: run) ---
