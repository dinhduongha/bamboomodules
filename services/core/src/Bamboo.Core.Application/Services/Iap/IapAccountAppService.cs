...
namespace Bamboo.Core.Application.Services
{
    ...
    public class IapAccountAppService : GenericApplicationService<IapAccount>, IIapAccountAppService
    {
        ...
        public IapAccountAppService(IRepository<IapAccount, Guid> repository, IServiceProvider serviceProvider, AuthorizationService authorizationService, DomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache, IMailThreadAppService mailThreadAppService) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
