...
namespace Bamboo.Core.Application.Services
{
    ...
    public class CloudStorageMigrationReportAppService : GenericApplicationService<CloudStorageMigrationReport>, ICloudStorageMigrationReportAppService
    {

        public CloudStorageMigrationReportAppService(IRepository<CloudStorageMigrationReport, Guid> repository, IServiceProvider serviceProvider, IAuthorizationService authorizationService, IDomainParser domainParser, IModelTypeRegistry modelTypeRegistry, IDataFilter dataFilter, IObjectMapper objectMapper, IMemoryCache memoryCache) : base(repository, serviceProvider, authorizationService, domainParser, modelTypeRegistry, dataFilter, objectMapper, memoryCache)
        {
