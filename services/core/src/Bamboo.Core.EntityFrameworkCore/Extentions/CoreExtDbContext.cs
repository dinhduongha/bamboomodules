...
public partial class CoreDbContext
{
    ...
    public virtual DbSet<AccountAutopostBillsWizard> AccountAutopostBillsWizards { get; set; }
    ...
    public virtual DbSet<AccountDebitNote> AccountDebitNotes { get; set; }
    ...
    public virtual DbSet<AccountEdiProxyClientUser> AccountEdiProxyClientUsers { get; set; }
    ...
    public virtual DbSet<AccountLockException> AccountLockExceptions { get; set; }

    public virtual DbSet<AccountMergeWizard> AccountMergeWizards { get; set; }

    public virtual DbSet<AccountMergeWizardLine> AccountMergeWizardLines { get; set; }
    ...
    public virtual DbSet<AccountMoveSendBatchWizard> AccountMoveSendBatchWizards { get; set; }

    public virtual DbSet<AccountMoveSendWizard> AccountMoveSendWizards { get; set; }
    ...
    public virtual DbSet<AccountSecureEntriesWizard> AccountSecureEntriesWizards { get; set; }
    ...
    public virtual DbSet<BlogBlog> BlogBlogs { get; set; }

    public virtual DbSet<BlogPost> BlogPosts { get; set; }

    public virtual DbSet<BlogTag> BlogTags { get; set; }

    public virtual DbSet<BlogTagCategory> BlogTagCategories { get; set; }
    ...
    public virtual DbSet<CardCampaignTag> CardCampaignTags { get; set; }
    ...
    public virtual DbSet<CrmLeadAssignation> CrmLeadAssignations { get; set; }

    public virtual DbSet<CrmLeadForwardToPartner> CrmLeadForwardToPartners { get; set; }
    ...
    public virtual DbSet<CrmRevealRule> CrmRevealRules { get; set; }

    public virtual DbSet<CrmRevealView> CrmRevealViews { get; set; }
    ...
    public virtual DbSet<CrossoveredBudgetLines> CrossoveredBudgetLines { get; set; }
    ...
    public virtual DbSet<DeliveryCarrier> DeliveryCarriers { get; set; }

    public virtual DbSet<DeliveryPriceRule> DeliveryPriceRules { get; set; }

    public virtual DbSet<DeliveryZipPrefix> DeliveryZipPrefixes { get; set; }

    public virtual DbSet<DigestDigest> DigestDigests { get; set; }

    public virtual DbSet<DigestTip> DigestTips { get; set; }

    public virtual DbSet<DiscussChannel> DiscussChannels { get; set; }

    public virtual DbSet<DiscussChannelMember> DiscussChannelMembers { get; set; }

    public virtual DbSet<DiscussChannelRtcSession> DiscussChannelRtcSessions { get; set; }

    public virtual DbSet<DiscussGifFavorite> DiscussGifFavorites { get; set; }

    public virtual DbSet<DiscussVoiceMetadata> DiscussVoiceMetadata { get; set; }

    public virtual DbSet<EventBooth> EventBooths { get; set; }

    public virtual DbSet<EventBoothCategory> EventBoothCategories { get; set; }

    public virtual DbSet<EventBoothConfigurator> EventBoothConfigurators { get; set; }

    public virtual DbSet<EventBoothRegistration> EventBoothRegistrations { get; set; }
    ...
    public virtual DbSet<EventLeadRequest> EventLeadRequests { get; set; }
    ...
    public virtual DbSet<EventQuestionAnswer> EventQuestionAnswers { get; set; }

    public virtual DbSet<EventQuiz> EventQuizzes { get; set; }

    public virtual DbSet<EventQuizAnswer> EventQuizAnswers { get; set; }

    public virtual DbSet<EventQuizQuestion> EventQuizQuestions { get; set; }

    public virtual DbSet<EventRegistration> EventRegistrations { get; set; }

    public virtual DbSet<EventRegistrationAnswer> EventRegistrationAnswers { get; set; }

    public virtual DbSet<EventSponsor> EventSponsors { get; set; }

    public virtual DbSet<EventSponsorType> EventSponsorTypes { get; set; }
    ...
    public virtual DbSet<EventTrack> EventTracks { get; set; }

    public virtual DbSet<EventTrackLocation> EventTrackLocations { get; set; }

    public virtual DbSet<EventTrackStage> EventTrackStages { get; set; }

    public virtual DbSet<EventTrackTag> EventTrackTags { get; set; }

    public virtual DbSet<EventTrackTagCategory> EventTrackTagCategories { get; set; }

    public virtual DbSet<EventTrackVisitor> EventTrackVisitors { get; set; }

    public virtual DbSet<EventType> EventTypes { get; set; }

    public virtual DbSet<EventTypeBooth> EventTypeBooths { get; set; }

    public virtual DbSet<EventTypeMail> EventTypeMails { get; set; }

    public virtual DbSet<EventTypeTicket> EventTypeTickets { get; set; }

    public virtual DbSet<ExpiryPickingConfirmation> ExpiryPickingConfirmations { get; set; }
    ...
    public virtual DbSet<FleetVehicleSendMail> FleetVehicleSendMails { get; set; }
    ...
    public virtual DbSet<FollowupSendingResults> FollowupSendingResults { get; set; }

    public virtual DbSet<ForumForum> ForumForums { get; set; }

    public virtual DbSet<ForumPost> ForumPosts { get; set; }

    public virtual DbSet<ForumPostReason> ForumPostReasons { get; set; }
    ...
    public virtual DbSet<HrJobPlatform> HrJobPlatforms { get; set; }
    ...
    public virtual DbSet<HrLeaveAllocationGenerateMultiWizard> HrLeaveAllocationGenerateMultiWizards { get; set; }

    public virtual DbSet<HrLeaveGenerateMultiWizard> HrLeaveGenerateMultiWizards { get; set; }
    ...
    public virtual DbSet<HrUserWorkEntryEmployee> HrUserWorkEntryEmployees { get; set; }

    public virtual DbSet<HrWorkEntry> HrWorkEntries { get; set; }

    public virtual DbSet<HrWorkEntryRegenerationWizard> HrWorkEntryRegenerationWizards { get; set; }

    public virtual DbSet<HrWorkEntryType> HrWorkEntryTypes { get; set; }

    public virtual DbSet<HrWorkLocation> HrWorkLocations { get; set; }

    public virtual DbSet<IapAccount> IapAccounts { get; set; }

    public virtual DbSet<IapService> IapServices { get; set; }
    ...
    //public virtual DbSet<IrActionsActUrl> IrActUrls { get; set; }
    ...
    public virtual DbSet<IrActions> IrActions { get; set; }
    ...
    public virtual DbSet<IrCronProgress> IrCronProgresses { get; set; }
    ...
    public virtual DbSet<IrEmbeddedActions> IrEmbeddedActions { get; set; }

    public virtual DbSet<IrExports> IrExports { get; set; }
    ...
    public virtual DbSet<IrModelData> IrModelData { get; set; }
    ...
    public virtual DbSet<IrModelInherit> IrModelInherits { get; set; }
    ...
    public virtual DbSet<MailActivityPlan> MailActivityPlans { get; set; }

    public virtual DbSet<MailActivityPlanTemplate> MailActivityPlanTemplates { get; set; }

    public virtual DbSet<MailActivitySchedule> MailActivitySchedules { get; set; }

    public virtual DbSet<MailActivityTodoCreate> MailActivityTodoCreates { get; set; }

    public virtual DbSet<MailActivityType> MailActivityTypes { get; set; }

    public virtual DbSet<MailAlias> MailAliases { get; set; }

    public virtual DbSet<MailAliasDomain> MailAliasDomains { get; set; }
    ...
    public virtual DbSet<MailMessageTranslation> MailMessageTranslations { get; set; }

    public virtual DbSet<MailNotification> MailNotifications { get; set; }

    public virtual DbSet<MailPush> MailPushes { get; set; }
    ...
    public virtual DbSet<MailingSubscription> MailingSubscriptions { get; set; }

    public virtual DbSet<MailingSubscriptionOptout> MailingSubscriptionOptouts { get; set; }
    ...
    public virtual DbSet<MrpAccountWipAccounting> MrpAccountWipAccountings { get; set; }
    ...
    public virtual DbSet<OnboardingProgressStep> OnboardingProgressSteps { get; set; }
    ...
    public virtual DbSet<PosDailySalesReportsWizard> PosDailySalesReportsWizards { get; set; }
    ...
    public virtual DbSet<PosNote> PosNotes { get; set; }
    ...
    public virtual DbSet<PosSelfOrderCustomLink> PosSelfOrderCustomLinks { get; set; }
    ...
    public virtual DbSet<ProjectProjectStageDeleteWizard> ProjectProjectStageDeleteWizards { get; set; }

    public virtual DbSet<ProjectSaleLineEmployeeMap> ProjectSaleLineEmployeeMaps { get; set; }

    public virtual DbSet<ProjectShareCollaboratorWizard> ProjectShareCollaboratorWizards { get; set; }
    ...
    public virtual DbSet<PurchaseOrderGroup> PurchaseOrderGroups { get; set; }

    public virtual DbSet<PurchaseOrderLine> PurchaseOrderLines { get; set; }

    public virtual DbSet<PurchaseRequisition> PurchaseRequisitions { get; set; }

    public virtual DbSet<PurchaseRequisitionAlternativeWarning> PurchaseRequisitionAlternativeWarnings { get; set; }

    public virtual DbSet<PurchaseRequisitionCreateAlternative> PurchaseRequisitionCreateAlternatives { get; set; }
    ...
    public virtual DbSet<ResDeviceLog> ResDeviceLogs { get; set; }

    public virtual DbSet<ResGroups> ResGroups { get; set; }
    ...
    public virtual DbSet<ResPartnerIap> ResPartnerIaps { get; set; }

    public virtual DbSet<ResPartnerIndustry> ResPartnerIndustries { get; set; }

    public virtual DbSet<ResPartnerTag> ResPartnerTags { get; set; }

    public virtual DbSet<ResPartnerTitle> ResPartnerTitles { get; set; }

    public virtual DbSet<ResUsers> ResUsers { get; set; }

    public virtual DbSet<ResUsersApikeys> ResUsersApikeys { get; set; }
    ...
    public virtual DbSet<SaleLoyaltyCouponWizard> SaleLoyaltyCouponWizards { get; set; }

    public virtual DbSet<SaleLoyaltyRewardWizard> SaleLoyaltyRewardWizards { get; set; }

    public virtual DbSet<SaleMassCancelOrders> SaleMassCancelOrders { get; set; }
    ...
    public virtual DbSet<SmsAccountCode> SmsAccountCodes { get; set; }

    public virtual DbSet<SmsAccountPhone> SmsAccountPhones { get; set; }

    public virtual DbSet<SmsAccountSender> SmsAccountSenders { get; set; }
    ...
    public virtual DbSet<SpreadsheetDashboardShare> SpreadsheetDashboardShares { get; set; }
    ...
    public virtual DbSet<StockLandedCostLines> StockLandedCostLines { get; set; }
    ...
    public virtual DbSet<StockPickingBatch> StockPickingBatches { get; set; }

    public virtual DbSet<StockPickingToBatch> StockPickingToBatches { get; set; }
    ...
    public virtual DbSet<UpdateProductAttributeValue> UpdateProductAttributeValues { get; set; }
    ...
    public virtual DbSet<WebTourTourStep> WebTourTourSteps { get; set; }
    ...
    public virtual DbSet<WebsiteControllerPage> WebsiteControllerPages { get; set; }

    public virtual DbSet<WebsiteCustomBlockedThirdPartyDomains> WebsiteCustomBlockedThirdPartyDomains { get; set; }
    ...
    public virtual DbSet<WebsitePagePropertiesBase> WebsitePagePropertiesBases { get; set; }

    public virtual DbSet<WebsitePageProperties> WebsitePageProperties { get; set; }

    public virtual DbSet<WebsiteRewrite> WebsiteRewrites { get; set; }

    public virtual DbSet<WebsiteRobots> WebsiteRobots { get; set; }
