...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountMergeWizardLine>(entity =>
            ...
            // entity.HasOne(d => d.Account).WithMany(p => p.AccountMergeWizardLine)
            entity.HasOne(d => d.Account).WithMany()
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("account_merge_wizard_line_account_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountMergeWizardLineCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountMergeWizardLineWriteU)
