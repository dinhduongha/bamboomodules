...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrSalaryRule>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrSalaryRule)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_salary_rule_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrSalaryRuleCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrSalaryRuleWriteU)
