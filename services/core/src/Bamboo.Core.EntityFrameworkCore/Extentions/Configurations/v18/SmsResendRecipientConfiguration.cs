    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SmsResendRecipient>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("sms_resend_recipient_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SmsResendRecipientCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sms_resend_recipient_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SmsResendRecipientWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sms_resend_recipient_write_uid_fkey");
