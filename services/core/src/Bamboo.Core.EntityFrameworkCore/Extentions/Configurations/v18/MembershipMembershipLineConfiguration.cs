    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MembershipMembershipLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("membership_membership_line_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.MembershipMembershipLine) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("membership_membership_line_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("membership_membership_line_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MembershipMembershipLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("membership_membership_line_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("membership_membership_line_create_uid_fkey");

                        // entity.HasOne(d => d.Membership).WithMany(p => p.MembershipMembershipLine) .HasForeignKey(d => d.MembershipId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("membership_membership_line_membership_id_fkey");
                        entity.HasOne(d => d.Membership).WithMany()
                            .HasForeignKey(d => d.MembershipId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("membership_membership_line_membership_id_fkey");

                        // entity.HasOne(d => d.PartnerNavigation).WithMany(p => p.MembershipMembershipLine) .HasForeignKey(d => d.Partner) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("membership_membership_line_partner_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MembershipMembershipLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("membership_membership_line_write_uid_fkey");
