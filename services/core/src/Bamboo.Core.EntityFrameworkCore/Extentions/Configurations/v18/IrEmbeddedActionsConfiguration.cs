...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrEmbeddedActions>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.IrEmbeddedActionsCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.IrEmbeddedActionsUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("ir_embedded_actions_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.IrEmbeddedActionsWriteU)
