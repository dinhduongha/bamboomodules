    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResDeviceLog>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("res_device_log_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ResDeviceLogCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_device_log_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("res_device_log_create_uid_fkey");

                        // entity.HasOne(d => d.User).WithMany(p => p.ResDeviceLogUser) .HasForeignKey(d => d.UserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_device_log_user_id_fkey");
                        entity.HasOne(d => d.User).WithMany()
                            .HasForeignKey(d => d.UserId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("res_device_log_user_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ResDeviceLogWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_device_log_write_uid_fkey");
