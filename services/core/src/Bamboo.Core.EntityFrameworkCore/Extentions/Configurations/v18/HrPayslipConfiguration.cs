...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrPayslip>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrPayslip)
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrPayslipCreateU)
            ...
            // entity.HasOne(d => d.Journal).WithMany(p => p.HrPayslip)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrPayslipWriteU)
