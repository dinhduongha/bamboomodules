    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrEmployeeSkillLog>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_employee_skill_log_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrEmployeeSkillLogCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_employee_skill_log_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrEmployeeSkillLogWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_employee_skill_log_write_uid_fkey");
