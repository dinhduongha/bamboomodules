    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrCronProgress>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_cron_progress_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrCronProgressCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_cron_progress_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrCronProgressWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_cron_progress_write_uid_fkey");
