    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CandidateSendMail>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("candidate_send_mail_pkey");
                        ...
                        // entity.HasOne(d => d.Author).WithMany(p => p.CandidateSendMail) .HasForeignKey(d => d.AuthorId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("candidate_send_mail_author_id_fkey");
                        entity.HasOne(d => d.Author).WithMany()
                            .HasForeignKey(d => d.AuthorId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("candidate_send_mail_author_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CandidateSendMailCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("candidate_send_mail_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CandidateSendMailWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("candidate_send_mail_write_uid_fkey");
