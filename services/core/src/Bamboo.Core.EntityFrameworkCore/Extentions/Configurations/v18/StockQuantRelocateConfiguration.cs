    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockQuantRelocate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_quant_relocate_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockQuantRelocateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_quant_relocate_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockQuantRelocateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_quant_relocate_write_uid_fkey");
