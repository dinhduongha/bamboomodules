    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrPayslipEmployees>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_payslip_employees_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrPayslipEmployeesCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payslip_employees_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("hr_payslip_employees_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrPayslipEmployeesWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payslip_employees_write_uid_fkey");
