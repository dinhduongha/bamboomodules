    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrPayslipLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_payslip_line_pkey");
                        ...
                        // entity.HasOne(d => d.AccountCreditNavigation).WithMany(p => p.HrPayslipLineAccountCreditNavigation) .HasForeignKey(d => d.AccountCredit) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payslip_line_account_credit_fkey");
                        ...
                        // entity.HasOne(d => d.AccountDebitNavigation).WithMany(p => p.HrPayslipLineAccountDebitNavigation) .HasForeignKey(d => d.AccountDebit) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payslip_line_account_debit_fkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.HrPayslipLine) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payslip_line_company_id_fkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrPayslipLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payslip_line_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrPayslipLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payslip_line_write_uid_fkey");
