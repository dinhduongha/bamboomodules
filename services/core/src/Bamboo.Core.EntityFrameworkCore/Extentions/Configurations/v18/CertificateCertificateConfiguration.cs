    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CertificateCertificate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("certificate_certificate_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.CertificateCertificate) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("certificate_certificate_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("certificate_certificate_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CertificateCertificateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("certificate_certificate_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CertificateCertificateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("certificate_certificate_write_uid_fkey");
