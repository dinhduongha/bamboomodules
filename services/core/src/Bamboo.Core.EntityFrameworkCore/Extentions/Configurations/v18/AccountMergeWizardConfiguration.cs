    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountMergeWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_merge_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountMergeWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_merge_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_merge_wizard_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountMergeWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_merge_wizard_write_uid_fkey");
