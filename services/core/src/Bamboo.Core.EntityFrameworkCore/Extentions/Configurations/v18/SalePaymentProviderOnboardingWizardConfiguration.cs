    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SalePaymentProviderOnboardingWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("sale_payment_provider_onboarding_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SalePaymentProviderOnboardingWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_payment_provider_onboarding_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("sale_payment_provider_onboarding_wizard_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SalePaymentProviderOnboardingWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_payment_provider_onboarding_wizard_write_uid_fkey");
