    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrCandidate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_candidate_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.HrCandidate) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_candidate_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("hr_candidate_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrCandidateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_candidate_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.HrCandidate) .HasForeignKey(d => d.MessageMainAttachmentId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_candidate_message_main_attachment_id_fkey");
                        entity.HasOne(d => d.MessageMainAttachment).WithMany()
                            .HasForeignKey(d => d.MessageMainAttachmentId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("hr_candidate_message_main_attachment_id_fkey");

                        // entity.HasOne(d => d.Partner).WithMany(p => p.HrCandidate) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_candidate_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.User).WithMany(p => p.HrCandidateUser) .HasForeignKey(d => d.UserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_candidate_user_id_fkey");
                        entity.HasOne(d => d.User).WithMany()
                            .HasForeignKey(d => d.UserId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("hr_candidate_user_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrCandidateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_candidate_write_uid_fkey");
