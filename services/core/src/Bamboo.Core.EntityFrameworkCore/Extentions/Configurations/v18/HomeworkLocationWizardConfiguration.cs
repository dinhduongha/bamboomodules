    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HomeworkLocationWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("homework_location_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HomeworkLocationWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("homework_location_wizard_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HomeworkLocationWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("homework_location_wizard_write_uid_fkey");
