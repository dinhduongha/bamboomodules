...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BillToPoWizard>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.BillToPoWizardCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("bill_to_po_wizard_create_uid_fkey");

            // entity.HasOne(d => d.Partner).WithMany(p => p.BillToPoWizard)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.BillToPoWizardWriteU)
