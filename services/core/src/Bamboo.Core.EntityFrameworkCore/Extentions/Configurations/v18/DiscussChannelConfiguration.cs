...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<DiscussChannel>(entity =>
            ...
            // entity.HasOne(d => d.Country).WithMany(p => p.DiscussChannel)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("discuss_channel_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.DiscussChannelCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.DiscussChannelWriteU)
