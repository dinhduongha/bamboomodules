...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectShareCollaboratorWizard>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectShareCollaboratorWizardCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.ProjectShareCollaboratorWizard)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("project_share_collaborator_wizard_partner_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectShareCollaboratorWizardWriteU)
