    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectShareCollaboratorWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("project_share_collaborator_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectShareCollaboratorWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("project_share_collaborator_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("project_share_collaborator_wizard_create_uid_fkey");

                        entity.HasOne(d => d.ParentWizard).WithMany(p => p.ProjectShareCollaboratorWizard)
                            .HasForeignKey(d => d.ParentWizardId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("project_share_collaborator_wizard_parent_wizard_id_fkey");

                        // entity.HasOne(d => d.Partner).WithMany(p => p.ProjectShareCollaboratorWizard) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("project_share_collaborator_wizard_partner_id_fkey");
                        entity.HasOne(d => d.Partner).WithMany()
                            .HasForeignKey(d => d.PartnerId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("project_share_collaborator_wizard_partner_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectShareCollaboratorWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("project_share_collaborator_wizard_write_uid_fkey");
