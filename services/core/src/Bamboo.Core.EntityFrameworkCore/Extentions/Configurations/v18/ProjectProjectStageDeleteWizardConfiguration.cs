...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectProjectStageDeleteWizard>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectProjectStageDeleteWizardCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_project_stage_delete_wizard_create_uid_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectProjectStageDeleteWizardWriteU)
