    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountMoveSendBatchWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_move_send_batch_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountMoveSendBatchWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_send_batch_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_move_send_batch_wizard_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountMoveSendBatchWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_send_batch_wizard_write_uid_fkey");
