...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsiteControllerPage>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsiteControllerPageCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.WebsiteControllerPage)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("website_controller_page_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsiteControllerPageWriteU)
