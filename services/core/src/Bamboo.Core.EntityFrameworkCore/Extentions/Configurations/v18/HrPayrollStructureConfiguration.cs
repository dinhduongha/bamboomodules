...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrPayrollStructure>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrPayrollStructure)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("hr_payroll_structure_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrPayrollStructureCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrPayrollStructureWriteU)
