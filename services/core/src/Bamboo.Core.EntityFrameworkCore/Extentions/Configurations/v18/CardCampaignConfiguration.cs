...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CardCampaign>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CardCampaignCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CardCampaignUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("card_campaign_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CardCampaignWriteU)
