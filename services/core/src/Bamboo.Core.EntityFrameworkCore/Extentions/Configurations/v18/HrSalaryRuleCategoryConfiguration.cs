...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrSalaryRuleCategory>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrSalaryRuleCategory)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_salary_rule_category_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrSalaryRuleCategoryCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrSalaryRuleCategoryWriteU)
