...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<DiscussChannelMember>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.DiscussChannelMemberCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.DiscussChannelMember)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.DiscussChannelMemberWriteU)
