    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpAccountWipAccountingLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_account_wip_accounting_line_pkey");
                        ...
                        // entity.HasOne(d => d.Account).WithMany(p => p.MrpAccountWipAccountingLine) .HasForeignKey(d => d.AccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_account_wip_accounting_line_account_id_fkey");
                        entity.HasOne(d => d.Account).WithMany()
                            .HasForeignKey(d => d.AccountId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mrp_account_wip_accounting_line_account_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpAccountWipAccountingLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_account_wip_accounting_line_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mrp_account_wip_accounting_line_create_uid_fkey");

                        // entity.HasOne(d => d.Currency).WithMany(p => p.MrpAccountWipAccountingLine) .HasForeignKey(d => d.CurrencyId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_account_wip_accounting_line_currency_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpAccountWipAccountingLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_account_wip_accounting_line_write_uid_fkey");
