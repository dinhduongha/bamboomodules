...
namespace Bamboo.Core.EntityFrameworkCore
{
    ...
    {
        public static void ConfigureResOrganization(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ResOrganization>(entity =>
                {
                    entity.HasKey(e => e.Id).HasName("res_organization_pkey");

                    entity.ToTable("res_organization");

                    entity.HasIndex(e => e.TenantId);

                    entity.HasIndex(e => e.OriginOrganizationUnitId);

                    entity.HasIndex(e => e.AliasDomainId, "res_organization__alias_domain_id_index").HasFilter("(alias_domain_id IS NOT NULL)");

                    entity.HasIndex(e => e.ParentId, "res_organization__parent_id_index");

                    entity.HasIndex(e => e.ParentPath, "res_organization__parent_path_index");

                    entity.HasIndex(e => e.PartnerId, "res_organization__partner_id_index");

                    entity.HasIndex(e => e.Name, "res_organization_name");
                    ...
                    entity.Property(e => e.OriginOrganizationUnitId).HasColumnName("origin_organization_unit_id");
                    ...
                    // entity.HasOne(d => d.AccountCashBasisBaseAccount).WithMany(p => p.ResCompanyAccountCashBasisBaseAccount) .HasForeignKey(d => d.AccountCashBasisBaseAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_cash_basis_base_account_id_fkey");
                    // entity.HasOne(d => d.AccountCashBasisBaseAccount).WithMany()
                    // .HasForeignKey(d => d.AccountCashBasisBaseAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_cash_basis_base_account_id_fkey");

                    // // entity.HasOne(d => d.AccountDefaultPosReceivableAccount).WithMany(p => p.ResCompanyAccountDefaultPosReceivableAccount) .HasForeignKey(d => d.AccountDefaultPosReceivableAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_default_pos_receivable_account_id_fkey");
                    // entity.HasOne(d => d.AccountDefaultPosReceivableAccount).WithMany()
                    // .HasForeignKey(d => d.AccountDefaultPosReceivableAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_default_pos_receivable_account_id_fkey");

                    // // entity.HasOne(d => d.AccountDiscountExpenseAllocation).WithMany(p => p.ResCompanyAccountDiscountExpenseAllocation) .HasForeignKey(d => d.AccountDiscountExpenseAllocationId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_discount_expense_allocation_id_fkey");
                    // entity.HasOne(d => d.AccountDiscountExpenseAllocation).WithMany()
                    // .HasForeignKey(d => d.AccountDiscountExpenseAllocationId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_discount_expense_allocation_id_fkey");

                    // entity.HasOne(d => d.AccountDiscountIncomeAllocation).WithMany(p => p.ResCompanyAccountDiscountIncomeAllocation) .HasForeignKey(d => d.AccountDiscountIncomeAllocationId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_discount_income_allocation_id_fkey");
                    // entity.HasOne(d => d.AccountDiscountIncomeAllocation).WithMany()
                    // .HasForeignKey(d => d.AccountDiscountIncomeAllocationId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_discount_income_allocation_id_fkey");

                    // // entity.HasOne(d => d.AccountFiscalCountry).WithMany(p => p.ResCompany) .HasForeignKey(d => d.AccountFiscalCountryId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_fiscal_country_id_fkey");
                    // entity.HasOne(d => d.AccountFiscalCountry).WithMany()
                    // .HasForeignKey(d => d.AccountFiscalCountryId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_fiscal_country_id_fkey");

                    // entity.HasOne(d => d.AccountJournalEarlyPayDiscountGainAccount).WithMany(p => p.ResCompanyAccountJournalEarlyPayDiscountGainAccount) .HasForeignKey(d => d.AccountJournalEarlyPayDiscountGainAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_journal_early_pay_discount_gain_accoun_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_journal_early_pay_discount_gain_accoun_fkey");

                    // // entity.HasOne(d => d.AccountJournalEarlyPayDiscountLossAccount).WithMany(p => p.ResCompanyAccountJournalEarlyPayDiscountLossAccount) .HasForeignKey(d => d.AccountJournalEarlyPayDiscountLossAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_journal_early_pay_discount_loss_accoun_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_journal_early_pay_discount_loss_accoun_fkey");

                    // entity.HasOne(d => d.AccountJournalSuspenseAccount).WithMany(p => p.ResCompanyAccountJournalSuspenseAccount) .HasForeignKey(d => d.AccountJournalSuspenseAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_journal_suspense_account_id_fkey");
                    // entity.HasOne(d => d.AccountJournalSuspenseAccount).WithMany()
                    // .HasForeignKey(d => d.AccountJournalSuspenseAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_journal_suspense_account_id_fkey");

                    // entity.HasOne(d => d.AccountOpeningMove).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.AccountOpeningMoveId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_opening_move_id_fkey");

                    // // entity.HasOne(d => d.AccountProductionWipAccount).WithMany(p => p.ResCompanyAccountProductionWipAccount) .HasForeignKey(d => d.AccountProductionWipAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_production_wip_account_id_fkey");
                    // entity.HasOne(d => d.AccountProductionWipAccount).WithMany()
                    // .HasForeignKey(d => d.AccountProductionWipAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_production_wip_account_id_fkey");

                    // // entity.HasOne(d => d.AccountProductionWipOverheadAccount).WithMany(p => p.ResCompanyAccountProductionWipOverheadAccount) .HasForeignKey(d => d.AccountProductionWipOverheadAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_production_wip_overhead_account_id_fkey");
                    // entity.HasOne(d => d.AccountProductionWipOverheadAccount).WithMany()
                    // .HasForeignKey(d => d.AccountProductionWipOverheadAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_production_wip_overhead_account_id_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_purchase_receipt_fiscal_position_id_fkey");

                    // entity.HasOne(d => d.AccountPurchaseTax).WithMany(p => p.ResCompanyAccountPurchaseTax)
                    // .HasForeignKey(d => d.AccountPurchaseTaxId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_purchase_tax_id_fkey");

                    // entity.HasOne(d => d.AccountSaleTax).WithMany(p => p.ResCompanyAccountSaleTax)
                    // .HasForeignKey(d => d.AccountSaleTaxId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_sale_tax_id_fkey");

                    // entity.HasOne(d => d.AccountStockJournal).WithMany(p => p.ResCompanyAccountStockJournal)
                    // .HasForeignKey(d => d.AccountStockJournalId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_stock_journal_id_fkey");

                    // // entity.HasOne(d => d.AccountStockValuation).WithMany(p => p.ResCompanyAccountStockValuation) .HasForeignKey(d => d.AccountStockValuationId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_account_stock_valuation_id_fkey");
                    // entity.HasOne(d => d.AccountStockValuation).WithMany()
                    // .HasForeignKey(d => d.AccountStockValuationId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_account_stock_valuation_id_fkey");

                    // entity.HasOne(d => d.AliasDomain).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.AliasDomainId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_alias_domain_id_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_automatic_entry_default_journal_id_fkey");

                    // entity.HasOne(d => d.BatchPaymentSequence).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.BatchPaymentSequenceId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_batch_payment_sequence_id_fkey");

                    // entity.HasOne(d => d.CreateU).WithMany(p => p.ResCompanyCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_create_uid_fkey");
                    entity.HasOne(d => d.CreateU).WithMany()
                    .HasForeignKey(d => d.CreatorId)
                    .OnDelete(DeleteBehavior.SetNull)
                    .HasConstraintName("res_organization_create_uid_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_currency_exchange_journal_id_fkey");

                    // entity.HasOne(d => d.Currency).WithMany(p => p.ResCompany) .HasForeignKey(d => d.CurrencyId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("res_organization_currency_id_fkey");
                    // entity.HasOne(d => d.Currency).WithMany()
                    // .HasForeignKey(d => d.CurrencyId)
                    // .OnDelete(DeleteBehavior.Restrict)
                    // .HasConstraintName("res_organization_currency_id_fkey");

                    // // entity.HasOne(d => d.DefaultCashDifferenceExpenseAccount).WithMany(p => p.ResCompanyDefaultCashDifferenceExpenseAccount) .HasForeignKey(d => d.DefaultCashDifferenceExpenseAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_default_cash_difference_expense_account_id_fkey");
                    // entity.HasOne(d => d.DefaultCashDifferenceExpenseAccount).WithMany()
                    // .HasForeignKey(d => d.DefaultCashDifferenceExpenseAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_default_cash_difference_expense_account_id_fkey");

                    // // entity.HasOne(d => d.DefaultCashDifferenceIncomeAccount).WithMany(p => p.ResCompanyDefaultCashDifferenceIncomeAccount) .HasForeignKey(d => d.DefaultCashDifferenceIncomeAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_default_cash_difference_income_account_id_fkey");
                    // entity.HasOne(d => d.DefaultCashDifferenceIncomeAccount).WithMany()
                    // .HasForeignKey(d => d.DefaultCashDifferenceIncomeAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_default_cash_difference_income_account_id_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_domestic_fiscal_position_id_fkey");

                    // // entity.HasOne(d => d.DownpaymentAccount).WithMany(p => p.ResCompanyDownpaymentAccount) .HasForeignKey(d => d.DownpaymentAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_downpayment_account_id_fkey");
                    // entity.HasOne(d => d.DownpaymentAccount).WithMany()
                    // .HasForeignKey(d => d.DownpaymentAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_downpayment_account_id_fkey");

                    // entity.HasOne(d => d.DropshipSubcontractorPickType).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.DropshipSubcontractorPickTypeId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_dropship_subcontractor_pick_type_id_fkey");

                    // // entity.HasOne(d => d.ExpenseAccount).WithMany(p => p.ResCompanyExpenseAccount) .HasForeignKey(d => d.ExpenseAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_expense_account_id_fkey");
                    // entity.HasOne(d => d.ExpenseAccount).WithMany()
                    // .HasForeignKey(d => d.ExpenseAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_expense_account_id_fkey");

                    // // entity.HasOne(d => d.ExpenseAccrualAccount).WithMany(p => p.ResCompanyExpenseAccrualAccount) .HasForeignKey(d => d.ExpenseAccrualAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_expense_accrual_account_id_fkey");
                    // entity.HasOne(d => d.ExpenseAccrualAccount).WithMany()
                    // .HasForeignKey(d => d.ExpenseAccrualAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_expense_accrual_account_id_fkey");

                    // // entity.HasOne(d => d.ExpenseCurrencyExchangeAccount).WithMany(p => p.ResCompanyExpenseCurrencyExchangeAccount) .HasForeignKey(d => d.ExpenseCurrencyExchangeAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_expense_currency_exchange_account_id_fkey");
                    // entity.HasOne(d => d.ExpenseCurrencyExchangeAccount).WithMany()
                    // .HasForeignKey(d => d.ExpenseCurrencyExchangeAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_expense_currency_exchange_account_id_fkey");

                    // entity.HasOne(d => d.ExpenseJournal).WithMany(p => p.ResCompanyExpenseJournal)
                    // .HasForeignKey(d => d.ExpenseJournalId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_expense_journal_id_fkey");

                    // entity.HasOne(d => d.ExternalReportLayout).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.ExternalReportLayoutId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_external_report_layout_id_fkey");

                    // // entity.HasOne(d => d.IncomeAccount).WithMany(p => p.ResCompanyIncomeAccount) .HasForeignKey(d => d.IncomeAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_income_account_id_fkey");
                    // entity.HasOne(d => d.IncomeAccount).WithMany()
                    // .HasForeignKey(d => d.IncomeAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_income_account_id_fkey");

                    // // entity.HasOne(d => d.IncomeCurrencyExchangeAccount).WithMany(p => p.ResCompanyIncomeCurrencyExchangeAccount) .HasForeignKey(d => d.IncomeCurrencyExchangeAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_income_currency_exchange_account_id_fkey");
                    // entity.HasOne(d => d.IncomeCurrencyExchangeAccount).WithMany()
                    // .HasForeignKey(d => d.IncomeCurrencyExchangeAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_income_currency_exchange_account_id_fkey");

                    // entity.HasOne(d => d.Incoterm).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.IncotermId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_incoterm_id_fkey");

                    // entity.HasOne(d => d.InternalProject).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.InternalProjectId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_internal_project_id_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.Restrict)
                    // .HasConstraintName("res_organization_internal_transit_location_id_fkey");

                    // entity.HasOne(d => d.LcJournal).WithMany(p => p.ResCompanyLcJournal)
                    // .HasForeignKey(d => d.LcJournalId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_lc_journal_id_fkey");

                    // entity.HasOne(d => d.LeaveTimesheetTask).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.LeaveTimesheetTaskId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_leave_timesheet_task_id_fkey");

                    // entity.HasOne(d => d.Nomenclature).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.NomenclatureId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_nomenclature_id_fkey");

                    entity.HasOne(d => d.Paperformat).WithMany()
                    .HasForeignKey(d => d.PaperformatId)
                    .OnDelete(DeleteBehavior.SetNull)
                    .HasConstraintName("res_organization_paperformat_id_fkey");

                    // entity.HasOne(d => d.Parent).WithMany(p => p.InverseParent) .HasForeignKey(d => d.ParentId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("res_organization_parent_id_fkey");
                    entity.HasOne(d => d.Parent).WithMany()
                    .HasForeignKey(d => d.ParentId)
                    .OnDelete(DeleteBehavior.Restrict)
                    .HasConstraintName("res_organization_parent_id_fkey");

                    // entity.HasOne(d => d.Partner).WithMany(p => p.ResCompany) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("res_organization_partner_id_fkey");
                    entity.HasOne(d => d.Partner).WithMany()
                    .HasForeignKey(d => d.PartnerId)
                    .OnDelete(DeleteBehavior.Restrict)
                    .HasConstraintName("res_organization_partner_id_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_peppol_purchase_journal_id_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_peppol_self_billing_reception_journal_id_fkey");

                    // entity.HasOne(d => d.PriceDifferenceAccount).WithMany(p => p.ResCompanyPriceDifferenceAccount) .HasForeignKey(d => d.PriceDifferenceAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_price_difference_account_id_fkey");
                    // entity.HasOne(d => d.PriceDifferenceAccount).WithMany()
                    // .HasForeignKey(d => d.PriceDifferenceAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_price_difference_account_id_fkey");

                    // // entity.HasOne(d => d.ProjectTimeMode).WithMany(p => p.ResCompanyProjectTimeMode) .HasForeignKey(d => d.ProjectTimeModeId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_project_time_mode_id_fkey");
                    // entity.HasOne(d => d.ProjectTimeMode).WithMany()
                    // .HasForeignKey(d => d.ProjectTimeModeId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_project_time_mode_id_fkey");

                    // entity.HasOne(d => d.ResourceCalendar).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.ResourceCalendarId)
                    // .OnDelete(DeleteBehavior.Restrict)
                    // .HasConstraintName("res_organization_resource_calendar_id_fkey");

                    // // entity.HasOne(d => d.RevenueAccrualAccount).WithMany(p => p.ResCompanyRevenueAccrualAccount) .HasForeignKey(d => d.RevenueAccrualAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_revenue_accrual_account_id_fkey");
                    // entity.HasOne(d => d.RevenueAccrualAccount).WithMany()
                    // .HasForeignKey(d => d.RevenueAccrualAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_revenue_accrual_account_id_fkey");

                    // // entity.HasOne(d => d.SaleDiscountProduct).WithMany(p => p.ResCompany) .HasForeignKey(d => d.SaleDiscountProductId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_sale_discount_product_id_fkey");
                    // entity.HasOne(d => d.SaleDiscountProduct).WithMany()
                    // .HasForeignKey(d => d.SaleDiscountProductId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_sale_discount_product_id_fkey");

                    // entity.HasOne(d => d.SaleOrderTemplate).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.SaleOrderTemplateId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_sale_order_template_id_fkey");

                    // entity.HasOne(d => d.StockMailConfirmationTemplate).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.StockMailConfirmationTemplateId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_stock_mail_confirmation_template_id_fkey");

                    // entity.HasOne(d => d.StockSmsConfirmationTemplate).WithMany(p => p.ResCompany)
                    // .HasForeignKey(d => d.StockSmsConfirmationTemplateId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_stock_sms_confirmation_template_id_fkey");
                    ...
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_subcontracting_location_id_fkey");

                    // entity.HasOne(d => d.TaxCashBasisJournal).WithMany(p => p.ResCompanyTaxCashBasisJournal)
                    // .HasForeignKey(d => d.TaxCashBasisJournalId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_tax_cash_basis_journal_id_fkey");

                    // // entity.HasOne(d => d.TimesheetEncodeUom).WithMany(p => p.ResCompanyTimesheetEncodeUom) .HasForeignKey(d => d.TimesheetEncodeUomId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_timesheet_encode_uom_id_fkey");
                    // entity.HasOne(d => d.TimesheetEncodeUom).WithMany()
                    // .HasForeignKey(d => d.TimesheetEncodeUomId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_timesheet_encode_uom_id_fkey");

                    // // entity.HasOne(d => d.TransferAccount).WithMany(p => p.ResCompanyTransferAccount) .HasForeignKey(d => d.TransferAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_transfer_account_id_fkey");
                    // entity.HasOne(d => d.TransferAccount).WithMany()
                    // .HasForeignKey(d => d.TransferAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_transfer_account_id_fkey");

                    // // entity.HasOne(d => d.Website).WithMany(p => p.ResCompany) .HasForeignKey(d => d.WebsiteId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_website_id_fkey");
                    // entity.HasOne(d => d.Website).WithMany()
                    // .HasForeignKey(d => d.WebsiteId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_website_id_fkey");

                    // // entity.HasOne(d => d.WithholdingTaxBaseAccount).WithMany(p => p.ResCompanyWithholdingTaxBaseAccount) .HasForeignKey(d => d.WithholdingTaxBaseAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_withholding_tax_base_account_id_fkey");
                    // entity.HasOne(d => d.WithholdingTaxBaseAccount).WithMany()
                    // .HasForeignKey(d => d.WithholdingTaxBaseAccountId)
                    // .OnDelete(DeleteBehavior.SetNull)
                    // .HasConstraintName("res_organization_withholding_tax_base_account_id_fkey");

                    // entity.HasOne(d => d.WriteU).WithMany(p => p.ResCompanyWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_organization_write_uid_fkey");
                    ...
                    //         .HasConstraintName("account_payment_method_line_res_organization_rel_res_organization_id_fkey"),
                    //     j =>
                    //     {
                    //         j.HasKey("ResCompanyId", "AccountPaymentMethodLineId").HasName("account_payment_method_line_res_organization_rel_pkey");
                    //         j.ToTable("account_payment_method_line_res_organization_rel");
                    //         j.HasIndex(new[] { "AccountPaymentMethodLineId", "ResCompanyId" }, "account_payment_method_line_r_account_payment_method_line_i_idx");
                    //         j.IndexerProperty<Guid>("ResCompanyId").HasColumnName("res_organization_id");
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "ResOrganizationUsersRel",
                        r => r.HasOne<ResUsers>().WithMany()
                            .HasForeignKey("UserId")
                            .HasConstraintName("res_organization_users_rel_user_id_fkey"),
                        l => l.HasOne<ResOrganization>().WithMany()
                            .HasForeignKey("OrganizationUnitId")
                            .HasConstraintName("res_organization_users_rel_ouid_fkey"),
                        j =>
                        {
                            j.HasKey("OrganizationUnitId", "UserId").HasName("res_organization_users_rel_pkey");
                            j.ToTable("res_organization_users_rel");
                            j.HasIndex(new[] { "UserId", "OrganizationUnitId" }, "res_organization_users_rel_user_id_ouid_idx");
                            j.IndexerProperty<Guid>("OrganizationUnitId").HasColumnName("ou_id");
