...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<GamificationBadgeUser>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.GamificationBadgeUserCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.GamificationBadgeUserUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("gamification_badge_user_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.GamificationBadgeUserWriteU)
