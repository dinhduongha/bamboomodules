...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ForumPostVote>(entity =>
            ...
            entity.HasIndex(e => e.CreationTime, "forum_post_vote_create_date_index");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ForumPostVoteCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.ForumPostVoteUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("forum_post_vote_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ForumPostVoteWriteU)
