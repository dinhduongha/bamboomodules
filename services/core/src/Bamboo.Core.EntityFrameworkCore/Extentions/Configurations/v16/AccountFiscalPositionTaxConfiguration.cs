...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountFiscalPositionTax>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountFiscalPositionTax)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_fiscal_position_tax_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountFiscalPositionTaxCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountFiscalPositionTaxWriteU)
