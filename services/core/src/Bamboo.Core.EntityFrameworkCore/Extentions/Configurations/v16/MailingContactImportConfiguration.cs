    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingContactImport>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mailing_contact_import_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingContactImportCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_contact_import_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mailing_contact_import_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingContactImportWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_contact_import_write_uid_fkey");
