    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailGroupMessage>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_group_message_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailGroupMessageCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_group_message_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Moderator).WithMany(p => p.MailGroupMessageModerator) .HasForeignKey(d => d.ModeratorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_group_message_moderator_id_fkey");
                        entity.HasOne(d => d.Moderator).WithMany()
                            .HasForeignKey(d => d.ModeratorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mail_group_message_moderator_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailGroupMessageWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_group_message_write_uid_fkey");
