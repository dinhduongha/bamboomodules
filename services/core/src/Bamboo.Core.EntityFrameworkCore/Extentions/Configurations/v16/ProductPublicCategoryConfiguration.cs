...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductPublicCategory>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductPublicCategoryCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.ProductPublicCategory)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("product_public_category_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductPublicCategoryWriteU)
