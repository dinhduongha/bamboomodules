...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingMailing>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingMailingCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.MailingMailing)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.MailingMailingUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mailing_mailing_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingMailingWriteU)
