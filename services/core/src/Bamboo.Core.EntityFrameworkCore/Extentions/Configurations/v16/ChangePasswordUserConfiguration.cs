...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ChangePasswordUser>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ChangePasswordUserCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("change_password_user_create_uid_fkey");

            // entity.HasOne(d => d.User).WithMany(p => p.ChangePasswordUserUser)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ChangePasswordUserWriteU)
