...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<DataRecycleRecord>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.DataRecycleRecord)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("data_recycle_record_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.DataRecycleRecordCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.DataRecycleRecordWriteU)
