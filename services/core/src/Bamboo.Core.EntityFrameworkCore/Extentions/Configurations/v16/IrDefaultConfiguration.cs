    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrDefault>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_default_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.IrDefault) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("ir_default_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("ir_default_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrDefaultCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_default_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.User).WithMany(p => p.IrDefaultUser) .HasForeignKey(d => d.UserId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("ir_default_user_id_fkey");
                        entity.HasOne(d => d.User).WithMany()
                            .HasForeignKey(d => d.UserId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("ir_default_user_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrDefaultWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_default_write_uid_fkey");
