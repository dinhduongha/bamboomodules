...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountEdiDocument>(entity =>
            ...
            entity.HasIndex(e => e.MoveId, "account_edi_document_move_id_index");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountEdiDocumentCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountEdiDocumentWriteU)
