...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmMergeOpportunity>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmMergeOpportunityCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CrmMergeOpportunityUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_merge_opportunity_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmMergeOpportunityWriteU)
