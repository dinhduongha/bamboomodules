    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailMail>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_mail_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailMailCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_mail_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailMailWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_mail_write_uid_fkey");
