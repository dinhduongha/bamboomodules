    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAssetDepreciationLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_asset_depreciation_line_pkey");
                        ...
                        entity.HasIndex(e => e.DepreciationDate, "account_asset_depreciation_line__depreciation_date_index");

                        entity.HasIndex(e => e.Name, "account_asset_depreciation_line__name_index");
                        ...
                        entity.HasOne(d => d.Asset).WithMany(p => p.AccountAssetDepreciationLine)
                            .HasForeignKey(d => d.AssetId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("account_asset_depreciation_line_asset_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAssetDepreciationLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_asset_depreciation_line_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_asset_depreciation_line_create_uid_fkey");

                        entity.HasOne(d => d.Move).WithMany(p => p.AccountAssetDepreciationLine)
                            .HasForeignKey(d => d.MoveId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_asset_depreciation_line_move_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAssetDepreciationLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_asset_depreciation_line_write_uid_fkey");
