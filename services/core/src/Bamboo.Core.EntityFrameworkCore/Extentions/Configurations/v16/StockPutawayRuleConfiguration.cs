...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockPutawayRule>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockPutawayRule)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_putaway_rule_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockPutawayRuleCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockPutawayRule)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockPutawayRuleWriteU)
