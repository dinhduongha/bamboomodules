...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResUsersSettings>(entity =>
            ...
            entity.Property(e => e.IsDiscussSidebarCategoryLivechatOpen).HasColumnName("is_discuss_sidebar_category_livechat_open");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ResUsersSettingsCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ResUsersSettingsWriteU)
