...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockBackorderConfirmationLine>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockBackorderConfirmationLineCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockBackorderConfirmationLineWriteU)
