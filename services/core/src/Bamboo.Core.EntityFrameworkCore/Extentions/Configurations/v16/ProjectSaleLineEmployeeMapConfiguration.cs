...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectSaleLineEmployeeMap>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectSaleLineEmployeeMapCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_sale_line_employee_map_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.ProjectSaleLineEmployeeMap)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectSaleLineEmployeeMapWriteU)
