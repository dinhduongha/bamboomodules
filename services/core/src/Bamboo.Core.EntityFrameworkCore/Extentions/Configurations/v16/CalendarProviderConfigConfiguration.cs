    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CalendarProviderConfig>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("calendar_provider_config_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CalendarProviderConfigCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("calendar_provider_config_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("calendar_provider_config_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CalendarProviderConfigWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("calendar_provider_config_write_uid_fkey");
