    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectCollaborator>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("project_collaborator_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectCollaboratorCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("project_collaborator_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("project_collaborator_create_uid_fkey");

                        // entity.HasOne(d => d.Partner).WithMany(p => p.ProjectCollaborator) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("project_collaborator_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectCollaboratorWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("project_collaborator_write_uid_fkey");
