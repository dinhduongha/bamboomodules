...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<Website>(entity =>
            ...
            entity.Property(e => e.ForumsCount).HasColumnName("forums_count");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.WebsiteNavigation)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("website_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsiteCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.WebsiteUser)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsiteWriteU)
