...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductWishlist>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductWishlistCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("product_wishlist_create_uid_fkey");

            // entity.HasOne(d => d.Partner).WithMany(p => p.ProductWishlist)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.ProductWishlist)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("product_wishlist_product_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.ProductWishlist)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("product_wishlist_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductWishlistWriteU)
