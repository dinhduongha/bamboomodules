...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountTourUploadBillEmailConfirm>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountTourUploadBillEmailConfirmCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_tour_upload_bill_email_confirm_create_uid_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountTourUploadBillEmailConfirmWriteU)
