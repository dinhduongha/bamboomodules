...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PurchaseRequisitionAlternativeWarning>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.PurchaseRequisitionAlternativeWarningCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("purchase_requisition_alternative_warning_create_uid_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.PurchaseRequisitionAlternativeWarningWriteU)
