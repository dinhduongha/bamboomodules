...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrUiViewCustom>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.IrUiViewCustomCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.IrUiViewCustomUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("ir_ui_view_custom_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.IrUiViewCustomWriteU)
