...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LunchOrder>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.LunchOrder)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("lunch_order_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.LunchOrderCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("lunch_order_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.LunchOrder)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.LunchOrder)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.LunchOrderUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("lunch_order_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.LunchOrderWriteU)
