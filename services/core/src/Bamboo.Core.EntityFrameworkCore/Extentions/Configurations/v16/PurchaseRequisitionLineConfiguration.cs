...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PurchaseRequisitionLine>(entity =>
            ...
            entity.HasIndex(e => e.AnalyticDistribution, "purchase_requisition_line_analytic_distribution_gin_index").HasMethod("gin");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.PurchaseRequisitionLine)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("purchase_requisition_line_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.PurchaseRequisitionLineCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.PurchaseRequisitionLine)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("purchase_requisition_line_product_id_fkey");

            // entity.HasOne(d => d.ProductUom).WithMany(p => p.PurchaseRequisitionLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.PurchaseRequisitionLineWriteU)
