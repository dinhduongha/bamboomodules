    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResCountry>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("res_country_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ResCountryCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_country_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("res_country_create_uid_fkey");

                        // entity.HasOne(d => d.Currency).WithMany(p => p.ResCountry) .HasForeignKey(d => d.CurrencyId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_country_currency_id_fkey");
                        entity.HasOne(d => d.Currency).WithMany()
                            .HasForeignKey(d => d.CurrencyId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("res_country_currency_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ResCountryWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_country_write_uid_fkey");
