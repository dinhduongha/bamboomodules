...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<GamificationBadgeUserWizard>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.GamificationBadgeUserWizardCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.GamificationBadgeUserWizardUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("gamification_badge_user_wizard_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.GamificationBadgeUserWizardWriteU)
