...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosPayment>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.PosPayment)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("pos_payment_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.PosPaymentCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.PosPaymentWriteU)
