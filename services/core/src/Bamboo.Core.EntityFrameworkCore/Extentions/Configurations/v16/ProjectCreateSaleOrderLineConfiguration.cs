...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectCreateSaleOrderLine>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectCreateSaleOrderLineCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_create_sale_order_line_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.ProjectCreateSaleOrderLine)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.ProjectCreateSaleOrderLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectCreateSaleOrderLineWriteU)
