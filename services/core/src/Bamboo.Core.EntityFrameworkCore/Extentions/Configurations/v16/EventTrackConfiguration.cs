...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventTrack>(entity =>
            ...
            entity.HasIndex(e => e.IsPublished, "event_track_is_published_index");

            entity.HasIndex(e => e.StageId, "event_track_stage_id_index");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventTrackCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.EventTrackUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_track_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventTrackWriteU)
