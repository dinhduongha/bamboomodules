    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountPartialReconcile>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_partial_reconcile_pkey");
                        ...
                        entity.HasIndex(e => e.CreditMoveId, "account_partial_reconcile__credit_move_id_index");

                        entity.HasIndex(e => e.DebitMoveId, "account_partial_reconcile__debit_move_id_index");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.AccountPartialReconcile) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_partial_reconcile_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_partial_reconcile_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountPartialReconcileCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_partial_reconcile_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_partial_reconcile_create_uid_fkey");

                        // entity.HasOne(d => d.CreditCurrency).WithMany(p => p.AccountPartialReconcileCreditCurrency) .HasForeignKey(d => d.CreditCurrencyId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_partial_reconcile_credit_currency_id_fkey");
                        ...
                        // entity.HasOne(d => d.DebitCurrency).WithMany(p => p.AccountPartialReconcileDebitCurrency) .HasForeignKey(d => d.DebitCurrencyId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_partial_reconcile_debit_currency_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountPartialReconcileWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_partial_reconcile_write_uid_fkey");
