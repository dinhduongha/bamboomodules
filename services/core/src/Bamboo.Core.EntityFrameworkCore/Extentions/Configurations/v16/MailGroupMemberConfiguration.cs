...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailGroupMember>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MailGroupMemberCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.MailGroupMember)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("mail_group_member_partner_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MailGroupMemberWriteU)
