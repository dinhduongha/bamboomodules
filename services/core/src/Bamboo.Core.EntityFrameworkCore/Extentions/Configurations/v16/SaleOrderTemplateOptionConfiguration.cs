...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SaleOrderTemplateOption>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.SaleOrderTemplateOption)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("sale_order_template_option_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.SaleOrderTemplateOptionCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("sale_order_template_option_create_uid_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.SaleOrderTemplateOption)
            ...
            entity.HasOne(d => d.Uom).WithMany(p => p.SaleOrderTemplateOption)
                .HasForeignKey(d => d.UomId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("sale_order_template_option_uom_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.SaleOrderTemplateOptionWriteU)
