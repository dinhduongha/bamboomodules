    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrModel>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_model_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrModelCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_model_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrModelWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_model_write_uid_fkey");
