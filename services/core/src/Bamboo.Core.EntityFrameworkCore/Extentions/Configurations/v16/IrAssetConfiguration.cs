    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrAsset>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_asset_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrAssetCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_asset_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Website).WithMany(p => p.IrAsset) .HasForeignKey(d => d.WebsiteId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("ir_asset_website_id_fkey");
                        entity.HasOne(d => d.Website).WithMany()
                            .HasForeignKey(d => d.WebsiteId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("ir_asset_website_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrAssetWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_asset_write_uid_fkey");
