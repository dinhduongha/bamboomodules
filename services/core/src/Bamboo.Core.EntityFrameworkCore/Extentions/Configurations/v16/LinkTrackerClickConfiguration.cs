...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LinkTrackerClick>(entity =>
            ...
            // entity.HasOne(d => d.Country).WithMany(p => p.LinkTrackerClick)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("link_tracker_click_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.LinkTrackerClickCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.LinkTrackerClickWriteU)
