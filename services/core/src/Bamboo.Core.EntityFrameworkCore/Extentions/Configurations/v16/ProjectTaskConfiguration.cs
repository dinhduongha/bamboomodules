...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectTask>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.ProjectTask)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_task_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectTaskCreateU)
            ...
            entity.HasOne(d => d.DisplayProject).WithMany(p => p.ProjectTaskDisplayProject)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.ProjectTaskMessageMainAttachment)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.ProjectTask)
            ...
            // v16-Compat
            //entity.HasOne(d => d.Project).WithMany(p => p.ProjectTaskProject)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectTaskWriteU)
