...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductLabelLayout>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductLabelLayoutCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductLabelLayoutWriteU)
            ...
            // v16-Compat
            // entity.HasMany(d => d.StockMoveLine).WithMany(p => p.ProductLabelLayout)
            entity.HasMany(d => d.StockMoveLine).WithMany(p => p.ProductLabelLayout)
                .UsingEntity<Dictionary<string, object>>(
