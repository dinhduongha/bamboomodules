...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SaleOrderOption>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.SaleOrderOptionCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.SaleOrderOption)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("sale_order_option_product_id_fkey");

            entity.HasOne(d => d.Uom).WithMany(p => p.SaleOrderOption)
                .HasForeignKey(d => d.UomId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("sale_order_option_uom_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.SaleOrderOptionWriteU)
