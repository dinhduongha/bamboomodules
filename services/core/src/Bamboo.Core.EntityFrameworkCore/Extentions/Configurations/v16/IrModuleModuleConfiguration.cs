    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrModuleModule>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_module_module_pkey");
                        ...
                        entity.HasIndex(e => e.CategoryId, "ir_module_module__category_id_index");

                        entity.HasIndex(e => e.State, "ir_module_module__state_index");
                        ...
                        entity.HasOne(d => d.Category).WithMany(p => p.IrModuleModule)
                            .HasForeignKey(d => d.CategoryId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("ir_module_module_category_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrModuleModuleCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_module_module_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("ir_module_module_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrModuleModuleWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_module_module_write_uid_fkey");
                        entity.HasOne(d => d.WriteU).WithMany()
                            .HasForeignKey(d => d.LastModifierId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("ir_module_module_write_uid_fkey");

                        // entity.HasMany(d => d.Country).WithMany(p => p.Module)
