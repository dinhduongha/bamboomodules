    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingSmsTest>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mailing_sms_test_pkey");
                        ...
                        entity.ToTable("mailing_sms_test");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingSmsTestCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_sms_test_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mailing_sms_test_create_uid_fkey");

                        entity.HasOne(d => d.Mailing).WithMany(p => p.MailingSmsTest)
                            .HasForeignKey(d => d.MailingId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("mailing_sms_test_mailing_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingSmsTestWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_sms_test_write_uid_fkey");
