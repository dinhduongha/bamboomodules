...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockValuationLayerRevaluation>(entity =>
            ...
            // entity.HasOne(d => d.Account).WithMany(p => p.StockValuationLayerRevaluation)
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockValuationLayerRevaluation)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("stock_valuation_layer_revaluation_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockValuationLayerRevaluationCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockValuationLayerRevaluation)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("stock_valuation_layer_revaluation_product_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockValuationLayerRevaluationWriteU)
