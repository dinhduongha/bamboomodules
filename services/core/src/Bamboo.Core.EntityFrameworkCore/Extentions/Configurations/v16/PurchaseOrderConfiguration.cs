...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PurchaseOrder>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.PurchaseOrder)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("purchase_order_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.PurchaseOrderCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.PurchaseOrder)
            entity.HasOne(d => d.MessageMainAttachment).WithMany()
                .HasForeignKey(d => d.MessageMainAttachmentId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("purchase_order_message_main_attachment_id_fkey");

            // entity.HasOne(d => d.Partner).WithMany(p => p.PurchaseOrderPartner)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.PurchaseOrderUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("purchase_order_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.PurchaseOrderWriteU)
