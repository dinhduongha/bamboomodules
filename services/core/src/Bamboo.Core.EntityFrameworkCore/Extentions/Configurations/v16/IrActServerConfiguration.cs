    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrActServer>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_act_server_pkey");
                        ...
                        // entity.HasOne(d => d.ActivityUser).WithMany(p => p.IrActServerActivityUser) .HasForeignKey(d => d.ActivityUserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_act_server_activity_user_id_fkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrActServerCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_act_server_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrActServerWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_act_server_write_uid_fkey");
