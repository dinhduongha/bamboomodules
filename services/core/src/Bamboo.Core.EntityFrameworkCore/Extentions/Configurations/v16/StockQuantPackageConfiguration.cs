...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockQuantPackage>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockQuantPackage)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_quant_package_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockQuantPackageCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockQuantPackageWriteU)
