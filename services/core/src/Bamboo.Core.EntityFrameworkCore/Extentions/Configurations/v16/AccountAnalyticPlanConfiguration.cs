...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAnalyticPlan>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountAnalyticPlan)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_plan_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAnalyticPlanCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAnalyticPlanWriteU)
