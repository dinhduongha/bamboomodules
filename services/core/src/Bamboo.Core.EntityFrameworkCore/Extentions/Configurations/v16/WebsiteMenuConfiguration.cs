...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsiteMenu>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsiteMenuCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.WebsiteMenu)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("website_menu_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsiteMenuWriteU)
