    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingMailingTest>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mailing_mailing_test_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingMailingTestCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_mailing_test_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingMailingTestWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_mailing_test_write_uid_fkey");
