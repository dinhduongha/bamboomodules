...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockStorageCategoryCapacity>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockStorageCategoryCapacityCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockStorageCategoryCapacity)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockStorageCategoryCapacityWriteU)
