...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductTemplate>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.ProductTemplate)
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductTemplateCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.ProductTemplate)
            ...
            entity.HasOne(d => d.PosCateg).WithMany(p => p.ProductTemplate)
                .HasForeignKey(d => d.PosCategId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("product_template_pos_categ_id_fkey");

            entity.HasOne(d => d.Uom).WithMany(p => p.ProductTemplateUom)
                .HasForeignKey(d => d.UomId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("product_template_uom_id_fkey");

            entity.HasOne(d => d.UomPo).WithMany(p => p.ProductTemplateUomPo)
                .HasForeignKey(d => d.UomPoId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("product_template_uom_po_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.ProductTemplate)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductTemplateWriteU)
