...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectUpdate>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectUpdateCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_update_create_uid_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.ProjectUpdate)
            ...
            entity.HasOne(d => d.Uom).WithMany(p => p.ProjectUpdate)
                .HasForeignKey(d => d.UomId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_update_uom_id_fkey");

            // entity.HasOne(d => d.User).WithMany(p => p.ProjectUpdateUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("project_update_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectUpdateWriteU)
