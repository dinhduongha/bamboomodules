...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrLeaveStressDay>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrLeaveStressDay)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("hr_leave_stress_day_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrLeaveStressDayCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrLeaveStressDayWriteU)
