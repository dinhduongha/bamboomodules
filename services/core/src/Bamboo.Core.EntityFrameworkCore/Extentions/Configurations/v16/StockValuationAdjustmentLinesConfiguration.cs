...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockValuationAdjustmentLines>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockValuationAdjustmentLinesCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockValuationAdjustmentLines)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_valuation_adjustment_lines_product_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockValuationAdjustmentLinesWriteU)
