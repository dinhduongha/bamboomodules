    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockReturnPickingLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_return_picking_line_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockReturnPickingLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_return_picking_line_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.StockReturnPickingLine) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("stock_return_picking_line_product_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockReturnPickingLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_return_picking_line_write_uid_fkey");
