...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PurchaseRequisitionCreateAlternative>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.PurchaseRequisitionCreateAlternativeCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.PurchaseRequisitionCreateAlternative)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("purchase_requisition_create_alternative_partner_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.PurchaseRequisitionCreateAlternativeWriteU)
