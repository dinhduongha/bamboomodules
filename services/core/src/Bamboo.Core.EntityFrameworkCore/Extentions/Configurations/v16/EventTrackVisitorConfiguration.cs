    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventTrackVisitor>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("event_track_visitor_pkey");
                        ...
                        entity.HasIndex(e => e.PartnerId, "event_track_visitor__partner_id_index");

                        entity.HasIndex(e => e.TrackId, "event_track_visitor__track_id_index");

                        entity.HasIndex(e => e.VisitorId, "event_track_visitor__visitor_id_index");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.EventTrackVisitorCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_track_visitor_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("event_track_visitor_create_uid_fkey");

                        // entity.HasOne(d => d.Partner).WithMany(p => p.EventTrackVisitor) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_track_visitor_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.EventTrackVisitorWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_track_visitor_write_uid_fkey");
