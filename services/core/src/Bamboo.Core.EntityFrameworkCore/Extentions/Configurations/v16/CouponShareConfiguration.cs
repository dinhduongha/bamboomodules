...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CouponShare>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CouponShareCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.CouponShare)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("coupon_share_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CouponShareWriteU)
