...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAnalyticLine>(entity =>
            ...
            entity.HasIndex(e => e.AncestorTaskId, "account_analytic_line_ancestor_task_id_index").HasFilter("(ancestor_task_id IS NOT NULL)");

            entity.HasIndex(e => e.Date, "account_analytic_line_date_index");

            entity.HasIndex(e => e.EmployeeId, "account_analytic_line_employee_id_index");

            entity.HasIndex(e => e.GlobalLeaveId, "account_analytic_line_global_leave_id_index").HasFilter("(global_leave_id IS NOT NULL)");

            entity.HasIndex(e => e.HolidayId, "account_analytic_line_holiday_id_index").HasFilter("(holiday_id IS NOT NULL)");

            entity.HasIndex(e => e.MoveLineId, "account_analytic_line_move_line_id_index");

            entity.HasIndex(e => e.OrderId, "account_analytic_line_order_id_index");

            entity.HasIndex(e => e.ProjectId, "account_analytic_line_project_id_index");

            entity.HasIndex(e => e.SoLine, "account_analytic_line_so_line_index").HasFilter("(so_line IS NOT NULL)");

            entity.HasIndex(e => e.TaskId, "account_analytic_line_task_id_index").HasFilter("(task_id IS NOT NULL)");

            entity.HasIndex(e => e.TimesheetInvoiceId, "account_analytic_line_timesheet_invoice_id_index").HasFilter("(timesheet_invoice_id IS NOT NULL)");

            entity.HasIndex(e => e.UserId, "account_analytic_line_user_id_index");

            entity.HasIndex(e => e.XPlan2Id, "account_analytic_line_x_plan2_id_index").HasFilter("(x_plan2_id IS NOT NULL)");

            entity.HasIndex(e => e.XPlan3Id, "account_analytic_line_x_plan3_id_index").HasFilter("(x_plan3_id IS NOT NULL)");
            ...
            entity.Property(e => e.AncestorTaskId).HasColumnName("ancestor_task_id");
            ...
            // entity.HasOne(d => d.Account).WithMany(p => p.AccountAnalyticLine)
            entity.HasOne(d => d.Account).WithMany()
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("account_analytic_line_account_id_fkey");

            entity.HasOne(d => d.AncestorTask).WithMany(p => p.AccountAnalyticLineAncestorTask)
                .HasForeignKey(d => d.AncestorTaskId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_line_ancestor_task_id_fkey");

            // entity.HasOne(d => d.Company).WithMany(p => p.AccountAnalyticLine)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("account_analytic_line_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAnalyticLineCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_line_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.AccountAnalyticLine)
            ...
            // entity.HasOne(d => d.Journal).WithMany(p => p.AccountAnalyticLine)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.AccountAnalyticLine)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_line_partner_id_fkey");

            entity.HasOne(d => d.Plan).WithMany(p => p.AccountAnalyticLine)
                .HasForeignKey(d => d.PlanId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_line_plan_id_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.AccountAnalyticLine)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_line_product_id_fkey");

            // entity.HasOne(d => d.ProductUom).WithMany(p => p.AccountAnalyticLine)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.AccountAnalyticLineUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_line_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAnalyticLineWriteU)
