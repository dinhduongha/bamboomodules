...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockQuant>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockQuant)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_quant_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockQuantCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockQuant)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.StockQuantUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_quant_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockQuantWriteU)
