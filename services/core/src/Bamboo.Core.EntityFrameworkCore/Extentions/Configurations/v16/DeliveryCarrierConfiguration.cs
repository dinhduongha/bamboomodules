...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<DeliveryCarrier>(entity =>
            ...
            entity.HasIndex(e => e.IsPublished, "delivery_carrier_is_published_index");

            entity.HasIndex(e => e.WebsiteId, "delivery_carrier_website_id_index");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.DeliveryCarrier)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("delivery_carrier_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.DeliveryCarrierCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("delivery_carrier_create_uid_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.DeliveryCarrier)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.DeliveryCarrier)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("delivery_carrier_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.DeliveryCarrierWriteU)
