    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<DeliveryCarrier>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("delivery_carrier_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.DeliveryCarrier) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("delivery_carrier_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("delivery_carrier_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.DeliveryCarrierCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("delivery_carrier_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("delivery_carrier_create_uid_fkey");

                        // entity.HasOne(d => d.Product).WithMany(p => p.DeliveryCarrier) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("delivery_carrier_product_id_fkey");
                        entity.HasOne(d => d.Product).WithMany()
                            .HasForeignKey(d => d.ProductId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("delivery_carrier_product_id_fkey");

                        // entity.HasOne(d => d.Website).WithMany(p => p.DeliveryCarrier) .HasForeignKey(d => d.WebsiteId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("delivery_carrier_website_id_fkey");
                        entity.HasOne(d => d.Website).WithMany()
                            .HasForeignKey(d => d.WebsiteId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("delivery_carrier_website_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.DeliveryCarrierWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("delivery_carrier_write_uid_fkey");
                        entity.HasOne(d => d.WriteU).WithMany()
                            .HasForeignKey(d => d.LastModifierId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("delivery_carrier_write_uid_fkey");

                        // entity.HasMany(d => d.Country).WithMany(p => p.Carrier)
                        ...
                        // entity.HasMany(d => d.ProductTag).WithMany(p => p.DeliveryCarrier)
                        entity.HasMany(d => d.ProductTag).WithMany(p => p.DeliveryCarrier)
                            .UsingEntity<Dictionary<string, object>>(
                        ...
                        // entity.HasMany(d => d.ProductTagNavigation).WithMany(p => p.DeliveryCarrierNavigation)
                        entity.HasMany(d => d.ProductTagNavigation).WithMany(p => p.DeliveryCarrierNavigation)
                            .UsingEntity<Dictionary<string, object>>(
                        ...
                        // entity.HasMany(d => d.Route).WithMany(p => p.Shipping)
                        entity.HasMany(d => d.Route).WithMany(p => p.Shipping)
                            .UsingEntity<Dictionary<string, object>>(
                                "StockRouteShipping",
                        ...
                        // entity.HasMany(d => d.State).WithMany(p => p.Carrier)
                        entity.HasMany(d => d.State).WithMany()
                            .UsingEntity<Dictionary<string, object>>(
                        ...
                        entity.HasMany(d => d.StockWarehouse).WithMany(p => p.DeliveryCarrier)
                            .UsingEntity<Dictionary<string, object>>(
                                ...
                                r => r.HasOne<StockWarehouse>().WithMany()
                                    ...
                                    .HasConstraintName("delivery_carrier_stock_warehouse_rel_stock_warehouse_id_fkey"),
                                l => l.HasOne<DeliveryCarrier>().WithMany()
                                    .HasForeignKey("DeliveryCarrierId")
                                    .HasConstraintName("delivery_carrier_stock_warehouse_rel_delivery_carrier_id_fkey"),
                                j =>
                                {
                                    j.HasKey("DeliveryCarrierId", "StockWarehouseId").HasName("delivery_carrier_stock_warehouse_rel_pkey");
                                    j.ToTable("delivery_carrier_stock_warehouse_rel");
                                    j.HasIndex(new[] { "StockWarehouseId", "DeliveryCarrierId" }, "delivery_carrier_stock_wareho_stock_warehouse_id_delivery_c_idx");
                                    j.IndexerProperty<Guid>("DeliveryCarrierId").HasColumnName("delivery_carrier_id");
                                    j.IndexerProperty<Guid>("StockWarehouseId").HasColumnName("stock_warehouse_id");
                                });

                        // entity.HasMany(d => d.ZipPrefix).WithMany(p => p.Carrier)
                        entity.HasMany(d => d.ZipPrefix).WithMany(p => p.Carrier)
                            .UsingEntity<Dictionary<string, object>>(
