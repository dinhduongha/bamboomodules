...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAssetCategory>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountAssetCategory)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("account_asset_category_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAssetCategoryCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_asset_category_create_uid_fkey");

            // entity.HasOne(d => d.Journal).WithMany(p => p.AccountAssetCategory)
            entity.HasOne(d => d.Journal).WithMany()
                .HasForeignKey(d => d.JournalId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("account_asset_category_journal_id_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.AccountAssetCategory)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAssetCategoryWriteU)
