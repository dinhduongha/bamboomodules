...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmLead2opportunityPartnerMass>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmLead2opportunityPartnerMassCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.CrmLead2opportunityPartnerMass)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CrmLead2opportunityPartnerMassUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_lead2opportunity_partner_mass_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmLead2opportunityPartnerMassWriteU)
