...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountChartTemplate>(entity =>
            ...
            // entity.HasOne(d => d.Country).WithMany(p => p.AccountChartTemplate)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_chart_template_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountChartTemplateCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_chart_template_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.AccountChartTemplate)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountChartTemplateWriteU)
