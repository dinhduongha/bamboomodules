...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<UtmCampaign>(entity =>
            ...
            entity.Property(e => e.AbTestingTotalPc).HasColumnName("ab_testing_total_pc");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.UtmCampaign)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("utm_campaign_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.UtmCampaignCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.UtmCampaignUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("utm_campaign_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.UtmCampaignWriteU)
