...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SnailmailLetterMissingRequiredFields>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.SnailmailLetterMissingRequiredFieldsCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.SnailmailLetterMissingRequiredFieldsWriteU)
