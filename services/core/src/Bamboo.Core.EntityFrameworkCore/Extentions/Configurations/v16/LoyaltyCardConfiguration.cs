...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LoyaltyCard>(entity =>
            ...
            entity.HasIndex(e => e.PartnerId, "loyalty_card_partner_id_index");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.LoyaltyCard)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("loyalty_card_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.LoyaltyCardCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("loyalty_card_create_uid_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.LoyaltyCard)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.LoyaltyCard)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.LoyaltyCardWriteU)
