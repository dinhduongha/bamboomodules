...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LunchSupplier>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.LunchSupplier)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("lunch_supplier_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.LunchSupplierCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.LunchSupplierWriteU)
