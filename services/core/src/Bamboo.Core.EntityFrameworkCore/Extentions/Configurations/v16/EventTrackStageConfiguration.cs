    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventTrackStage>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("event_track_stage_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.EventTrackStageCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_track_stage_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.EventTrackStageWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_track_stage_write_uid_fkey");
