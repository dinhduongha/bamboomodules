...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PaymentProvider>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.PaymentProvider)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("payment_provider_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.PaymentProviderCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.PaymentProvider)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("payment_provider_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.PaymentProviderWriteU)
            ...
            // v16-Compat
            // entity.HasMany(d => d.PaymentIcon).WithMany(p => p.PaymentProvider)
            entity.HasMany(d => d.PaymentIcon).WithMany(p => p.PaymentProvider)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<Guid>("PaymentProviderId").HasColumnName("payment_provider_id");
                        j.IndexerProperty<Guid>("PaymentIconId").HasColumnName("payment_icon_id");
                    });
            });
        }
    }
