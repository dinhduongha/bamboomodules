    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectShareWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("project_share_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectShareWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("project_share_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("project_share_wizard_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectShareWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("project_share_wizard_write_uid_fkey");
