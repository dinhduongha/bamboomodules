...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAccountTemplate>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAccountTemplateCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_account_template_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.AccountAccountTemplate)
            entity.HasOne(d => d.Currency).WithMany()
                .HasForeignKey(d => d.CurrencyId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_account_template_currency_id_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.AccountAccountTemplate)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAccountTemplateWriteU)
