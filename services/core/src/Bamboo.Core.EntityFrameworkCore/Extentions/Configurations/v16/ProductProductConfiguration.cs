    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductProduct>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("product_product_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductProductCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_product_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductProductWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_product_write_uid_fkey");
