...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseAutomation>(entity =>
            ...
            entity.HasOne(d => d.ActionServer).WithMany()
                .HasForeignKey(d => d.ActionServerId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("base_automation_action_server_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseAutomationCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseAutomationWriteU)
            ...
            entity.HasMany(d => d.IrModelFields).WithMany()
            ...
            entity.HasMany(d => d.IrModelFieldsNavigation).WithMany()
                .UsingEntity<Dictionary<string, object>>(
