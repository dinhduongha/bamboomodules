...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrJob>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrJob)
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrJobCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.HrJob)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.HrJobUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_job_user_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.HrJob)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("hr_job_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrJobWriteU)
