...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PurchaseOrderLine>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.PurchaseOrderLine)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("purchase_order_line_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.PurchaseOrderLineCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("purchase_order_line_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.PurchaseOrderLine)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.PurchaseOrderLine)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("purchase_order_line_partner_id_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.PurchaseOrderLine)
            ...
            entity.HasOne(d => d.ProductUomNavigation).WithMany(p => p.PurchaseOrderLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.PurchaseOrderLineWriteU)
            ...
            entity.HasMany(d => d.Move).WithMany(p => p.CreatedPurchaseOrderLine)
                .UsingEntity<Dictionary<string, object>>(
