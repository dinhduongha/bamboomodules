...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockWarehouse>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockWarehouse)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_warehouse_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockWarehouseCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.StockWarehouse)
            ...
            entity.HasOne(d => d.ReturnType).WithMany(p => p.StockWarehouseReturnType)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockWarehouseWriteU)
