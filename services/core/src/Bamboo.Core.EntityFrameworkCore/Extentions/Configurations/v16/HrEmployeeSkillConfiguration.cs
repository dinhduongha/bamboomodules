    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrEmployeeSkill>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_employee_skill_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrEmployeeSkillCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_employee_skill_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrEmployeeSkillWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_employee_skill_write_uid_fkey");
