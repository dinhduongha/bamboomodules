...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<RatingRating>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.RatingRatingCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.RatingRatingPartner)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.RatingRatingWriteU)
