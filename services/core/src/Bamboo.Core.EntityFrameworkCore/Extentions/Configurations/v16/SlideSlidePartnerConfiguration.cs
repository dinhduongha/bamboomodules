...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SlideSlidePartner>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.SlideSlidePartnerCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("slide_slide_partner_create_uid_fkey");

            // entity.HasOne(d => d.Partner).WithMany(p => p.SlideSlidePartner)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.SlideSlidePartnerWriteU)
