...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockPicking>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockPicking)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_picking_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockPickingCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.StockPicking)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.StockPickingPartner)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.StockPickingUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_picking_user_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.StockPicking)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_picking_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockPickingWriteU)
