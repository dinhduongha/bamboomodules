...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrFilters>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.IrFiltersCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.IrFiltersUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("ir_filters_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.IrFiltersWriteU)
