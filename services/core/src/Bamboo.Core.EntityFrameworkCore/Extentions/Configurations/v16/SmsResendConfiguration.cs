    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SmsResend>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("sms_resend_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SmsResendCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sms_resend_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("sms_resend_create_uid_fkey");

                        entity.HasOne(d => d.MailMessage).WithMany(p => p.SmsResend)
                            .HasForeignKey(d => d.MailMessageId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("sms_resend_mail_message_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SmsResendWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sms_resend_write_uid_fkey");
