...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SaleOrder>(entity =>
            ...
            entity.Property(e => e.AmountDelivery).HasColumnName("amount_delivery");
            ...
            entity.Property(e => e.DeliveryRatingSuccess).HasColumnName("delivery_rating_success");
            ...
            entity.HasOne(d => d.AnalyticAccount).WithMany(p => p.SaleOrder)
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.SaleOrder)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("sale_order_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.SaleOrderCreateU)
            ...
            // entity.HasOne(d => d.Journal).WithMany(p => p.SaleOrder)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.SaleOrder)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.SaleOrderPartner)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.SaleOrderUser)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.SaleOrder)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("sale_order_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.SaleOrderWriteU)
