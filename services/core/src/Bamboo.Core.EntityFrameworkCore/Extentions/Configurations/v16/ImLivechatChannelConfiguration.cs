...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ImLivechatChannel>(entity =>
            ...
            //entity.Property(e => e.InputPlaceholder).HasColumnName("input_placeholder");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ImLivechatChannelCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("im_livechat_channel_create_uid_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ImLivechatChannelWriteU)
