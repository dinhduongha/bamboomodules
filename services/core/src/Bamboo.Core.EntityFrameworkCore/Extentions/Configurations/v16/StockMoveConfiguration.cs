    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockMove>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_move_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.StockMove) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("stock_move_company_id_fkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockMoveCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_move_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.StockMove) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("stock_move_product_id_fkey");
                        ...
                        // entity.HasOne(d => d.RestrictPartner).WithMany(p => p.StockMoveRestrictPartner) .HasForeignKey(d => d.RestrictPartnerId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_move_restrict_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockMoveWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_move_write_uid_fkey");
