...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockReplenishmentOption>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockReplenishmentOptionCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_replenishment_option_create_uid_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.StockReplenishmentOption)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockReplenishmentOptionWriteU)
