...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsiteVisitor>(entity =>
            ...
            // entity.HasOne(d => d.Country).WithMany(p => p.WebsiteVisitor)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("website_visitor_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsiteVisitorCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.WebsiteVisitorPartner)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("website_visitor_partner_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.WebsiteVisitor)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("website_visitor_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsiteVisitorWriteU)
