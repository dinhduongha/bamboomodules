...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrUserWorkEntryEmployee>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrUserWorkEntryEmployeeCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.HrUserWorkEntryEmployeeUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("hr_user_work_entry_employee_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrUserWorkEntryEmployeeWriteU)
