    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResPartnerCategory>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("res_partner_category_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ResPartnerCategoryCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_partner_category_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ResPartnerCategoryWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_partner_category_write_uid_fkey");
