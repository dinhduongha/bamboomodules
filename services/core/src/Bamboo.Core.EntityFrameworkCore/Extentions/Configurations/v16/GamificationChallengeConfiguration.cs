...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<GamificationChallenge>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.GamificationChallengeCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.GamificationChallenge)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.GamificationChallengeWriteU)
