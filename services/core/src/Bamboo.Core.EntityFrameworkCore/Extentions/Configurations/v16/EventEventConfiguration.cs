...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventEvent>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.EventEvent)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_event_company_id_fkey");

            // entity.HasOne(d => d.Country).WithMany(p => p.EventEvent)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_event_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventEventCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.EventEvent)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.EventEventUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_event_user_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.EventEvent)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("event_event_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventEventWriteU)
