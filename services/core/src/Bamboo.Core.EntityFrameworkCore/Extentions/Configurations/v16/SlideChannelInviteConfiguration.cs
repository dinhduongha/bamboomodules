    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SlideChannelInvite>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("slide_channel_invite_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SlideChannelInviteCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("slide_channel_invite_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SlideChannelInviteWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("slide_channel_invite_write_uid_fkey");
