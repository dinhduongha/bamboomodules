...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpUnbuild>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.MrpUnbuild)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("mrp_unbuild_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpUnbuildCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.MrpUnbuild)
