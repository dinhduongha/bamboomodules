...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LoyaltyReward>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.LoyaltyReward)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("loyalty_reward_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.LoyaltyRewardCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.LoyaltyRewardWriteU)
