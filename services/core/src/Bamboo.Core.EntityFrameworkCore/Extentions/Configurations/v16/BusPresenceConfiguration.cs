...
namespace Bamboo.Core.EntityFrameworkCore
{
    ...
    {
        public static void ConfigureBusPresence(this ModelBuilder modelBuilder)
        {
        modelBuilder.Entity<BusPresence>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("bus_presence_pkey");
                        ...
                        // entity.HasOne(d => d.User).WithOne(p => p.BusPresence) .HasForeignKey<BusPresence>(d => d.UserId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("bus_presence_user_id_fkey");
