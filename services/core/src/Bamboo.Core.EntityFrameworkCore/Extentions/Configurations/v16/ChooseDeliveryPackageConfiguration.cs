    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ChooseDeliveryPackage>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("choose_delivery_package_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ChooseDeliveryPackageCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("choose_delivery_package_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ChooseDeliveryPackageWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("choose_delivery_package_write_uid_fkey");
