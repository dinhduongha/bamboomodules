    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockWarnInsufficientQtyUnbuild>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_warn_insufficient_qty_unbuild_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockWarnInsufficientQtyUnbuildCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_warn_insufficient_qty_unbuild_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.StockWarnInsufficientQtyUnbuild) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("stock_warn_insufficient_qty_unbuild_product_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockWarnInsufficientQtyUnbuildWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_warn_insufficient_qty_unbuild_write_uid_fkey");
