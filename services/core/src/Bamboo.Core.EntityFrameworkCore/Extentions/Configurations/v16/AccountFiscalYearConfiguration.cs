...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountFiscalYear>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountFiscalYear)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("account_fiscal_year_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountFiscalYearCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_fiscal_year_create_uid_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountFiscalYearWriteU)
