    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailFollowers>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_followers_pkey");
                        ...
                        // entity.HasOne(d => d.Partner).WithMany(p => p.MailFollowers) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("mail_followers_partner_id_fkey");
