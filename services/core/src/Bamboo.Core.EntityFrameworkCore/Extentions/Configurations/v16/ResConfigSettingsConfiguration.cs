...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResConfigSettings>(entity =>
            ...
            entity.Property(e => e.ModuleEventBarcode).HasColumnName("module_event_barcode");
            ...
            entity.Property(e => e.ModuleProjectTimesheetSynchro).HasColumnName("module_project_timesheet_synchro");
            ...
            entity.Property(e => e.ModuleWebsiteEventQuestions).HasColumnName("module_website_event_questions");
            ...
            entity.Property(e => e.PosIfaceOrderlineNotes).HasColumnName("pos_iface_orderline_notes");
            ...
            entity.Property(e => e.PosIsTableManagement).HasColumnName("pos_is_table_management");
            ...
            entity.Property(e => e.ReminderManagerAllow).HasColumnName("reminder_manager_allow");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ResConfigSettingsCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("res_config_settings_create_uid_fkey");

            entity.HasOne(d => d.DepositDefaultProduct).WithMany()
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ResConfigSettingsWriteU)
