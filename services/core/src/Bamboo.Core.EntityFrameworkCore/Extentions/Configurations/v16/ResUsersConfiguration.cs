...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResUsers>(entity =>
            ...
            entity.HasIndex(e => e.GoogleCalendarAccountId, "res_users_google_token_uniq").IsUnique();
            ...
            entity.Property(e => e.GoogleCalendarAccountId).HasColumnName("google_calendar_account_id");
            ...
            entity.HasOne(d => d.GoogleCalendarAccount).WithOne(p => p.ResUsers)
                .HasForeignKey<ResUsers>(d => d.GoogleCalendarAccountId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("res_users_google_calendar_account_id_fkey");
