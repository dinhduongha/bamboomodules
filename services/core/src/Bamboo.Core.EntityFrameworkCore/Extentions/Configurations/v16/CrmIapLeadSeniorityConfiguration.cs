    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmIapLeadSeniority>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("crm_iap_lead_seniority_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmIapLeadSeniorityCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_iap_lead_seniority_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("crm_iap_lead_seniority_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmIapLeadSeniorityWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_iap_lead_seniority_write_uid_fkey");
