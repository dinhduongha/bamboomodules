...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockMoveLine>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockMoveLine)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_move_line_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockMoveLineCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockMoveLine)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("stock_move_line_product_id_fkey");

            // entity.HasOne(d => d.ProductUom).WithMany(p => p.StockMoveLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockMoveLineWriteU)
