...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrAttachment>(entity =>
            ...
            entity.Property(e => e.ProductDownloadable).HasColumnName("product_downloadable");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.IrAttachment)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("ir_attachment_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.IrAttachmentCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.IrAttachment)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("ir_attachment_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.IrAttachmentWriteU)
