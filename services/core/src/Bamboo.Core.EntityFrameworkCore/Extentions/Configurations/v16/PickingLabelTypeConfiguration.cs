    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PickingLabelType>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("picking_label_type_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.PickingLabelTypeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("picking_label_type_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("picking_label_type_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.PickingLabelTypeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("picking_label_type_write_uid_fkey");
                        entity.HasOne(d => d.WriteU).WithMany()
                            .HasForeignKey(d => d.LastModifierId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("picking_label_type_write_uid_fkey");

                        // entity.HasMany(d => d.MrpProduction).WithMany(p => p.PickingLabelType)
                        entity.HasMany(d => d.MrpProduction).WithMany(p => p.PickingLabelType)
                        ...
                        // entity.HasMany(d => d.StockPicking).WithMany(p => p.PickingLabelType)
                        entity.HasMany(d => d.StockPicking).WithMany(p => p.PickingLabelType)
                            .UsingEntity<Dictionary<string, object>>(
