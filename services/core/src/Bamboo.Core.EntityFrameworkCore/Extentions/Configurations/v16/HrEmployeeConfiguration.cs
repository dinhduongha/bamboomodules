...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrEmployee>(entity =>
            ...
            entity.HasOne(d => d.AddressHome).WithMany()
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrEmployee)
            ...
            // entity.HasOne(d => d.Country).WithMany(p => p.HrEmployeeCountry)
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrEmployeeCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.HrEmployee)
            ...
            entity.HasOne(d => d.PrivateState).WithMany(p => p.HrEmployee)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.HrEmployeeUser)
           ...
           // v16-Compat
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrEmployeeWriteU)
            ...
            // v16-Compat
            // entity.HasMany(d => d.Category).WithMany(p => p.Emp)
            //entity.HasMany(d => d.Category).WithMany(p => p.Emp)
            //    .UsingEntity<Dictionary<string, object>>(
            //        "EmployeeCategoryRel",
            //        r => r.HasOne<HrEmployeeCategory>().WithMany()
