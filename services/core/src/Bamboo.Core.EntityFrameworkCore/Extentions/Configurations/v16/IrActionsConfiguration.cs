    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrActions>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_actions_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrActionsCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_actions_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("ir_actions_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrActionsWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_actions_write_uid_fkey");
