    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SlideChannelTag>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("slide_channel_tag_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SlideChannelTagCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("slide_channel_tag_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SlideChannelTagWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("slide_channel_tag_write_uid_fkey");
