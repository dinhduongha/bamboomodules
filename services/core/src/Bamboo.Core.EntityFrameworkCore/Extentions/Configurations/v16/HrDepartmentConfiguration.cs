...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrDepartment>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrDepartment)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_department_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrDepartmentCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.HrDepartment)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrDepartmentWriteU)
