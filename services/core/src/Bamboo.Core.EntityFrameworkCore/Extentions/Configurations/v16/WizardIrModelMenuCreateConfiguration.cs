    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WizardIrModelMenuCreate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("wizard_ir_model_menu_create_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.WizardIrModelMenuCreateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("wizard_ir_model_menu_create_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.WizardIrModelMenuCreateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("wizard_ir_model_menu_create_write_uid_fkey");
