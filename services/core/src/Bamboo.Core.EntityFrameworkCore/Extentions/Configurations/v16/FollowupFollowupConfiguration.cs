    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<FollowupFollowup>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("followup_followup_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.FollowupFollowupCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("followup_followup_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("followup_followup_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.FollowupFollowupWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("followup_followup_write_uid_fkey");
