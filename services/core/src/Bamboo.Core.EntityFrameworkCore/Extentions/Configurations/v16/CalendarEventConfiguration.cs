...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CalendarEvent>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CalendarEventCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("calendar_event_create_uid_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.CalendarEvent)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CalendarEventUser)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.CalendarEventWriteU)
