...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockWarehouseOrderpoint>(entity =>
            ...
            entity.HasIndex(e => e.WarehouseId, "stock_warehouse_orderpoint_warehouse_id_index");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockWarehouseOrderpoint)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_warehouse_orderpoint_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockWarehouseOrderpointCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockWarehouseOrderpoint)
            ...
            // v16-Compat
            //entity.HasOne(d => d.Vendor).WithMany(p => p.StockWarehouseOrderpoint)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockWarehouseOrderpointWriteU)
