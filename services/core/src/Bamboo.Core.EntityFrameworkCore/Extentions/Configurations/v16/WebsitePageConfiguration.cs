...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsitePage>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsitePageCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.WebsitePage)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("website_page_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsitePageWriteU)
