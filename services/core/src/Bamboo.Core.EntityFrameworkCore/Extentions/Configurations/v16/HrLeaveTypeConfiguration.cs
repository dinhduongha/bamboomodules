...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrLeaveType>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrLeaveType)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_leave_type_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrLeaveTypeCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrLeaveTypeWriteU)
