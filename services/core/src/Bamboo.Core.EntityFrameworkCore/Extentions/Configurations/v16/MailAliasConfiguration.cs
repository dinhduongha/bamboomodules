    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailAlias>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_alias_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailAliasCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_alias_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mail_alias_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailAliasWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_alias_write_uid_fkey");
