...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<RecurringPaymentLine>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.RecurringPaymentLine)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("recurring_payment_line_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.RecurringPaymentLineCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("recurring_payment_line_create_uid_fkey");

            // entity.HasOne(d => d.Journal).WithMany(p => p.RecurringPaymentLine)
            entity.HasOne(d => d.Journal).WithMany()
                .HasForeignKey(d => d.JournalId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("recurring_payment_line_journal_id_fkey");

            // entity.HasOne(d => d.Partner).WithMany(p => p.RecurringPaymentLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.RecurringPaymentLineWriteU)
