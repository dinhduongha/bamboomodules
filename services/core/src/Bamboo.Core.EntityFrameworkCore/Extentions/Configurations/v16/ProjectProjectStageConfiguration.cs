...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectProjectStage>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.ProjectProjectStage)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_project_stage_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectProjectStageCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectProjectStageWriteU)
