...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BlogTag>(entity =>
            ...
            entity.HasIndex(e => e.CategoryId, "blog_tag_category_id_index");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.BlogTagCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("blog_tag_create_uid_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.BlogTagWriteU)
