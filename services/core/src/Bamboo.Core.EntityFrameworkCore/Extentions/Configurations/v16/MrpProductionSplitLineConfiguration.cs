...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpProductionSplitLine>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpProductionSplitLineCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.MrpProductionSplitLineUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mrp_production_split_line_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpProductionSplitLineWriteU)
