...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductTemplateAttributeValue>(entity =>
            ...
            entity.HasIndex(e => e.ProductAttributeValueId, "product_template_attribute_value__product_attribute_value_id_ind");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductTemplateAttributeValueCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductTemplateAttributeValueWriteU)
