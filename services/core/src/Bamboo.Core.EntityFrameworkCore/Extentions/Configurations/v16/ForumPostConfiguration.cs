...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ForumPost>(entity =>
            ...
            entity.HasIndex(e => e.CreationTime, "forum_post_create_date_index");

            entity.HasIndex(e => e.CreatorId, "forum_post_create_uid_index");

            entity.HasIndex(e => e.ParentId, "forum_post_parent_id_index");

            entity.HasIndex(e => e.LastModificationTime, "forum_post_write_date_index");

            entity.HasIndex(e => e.LastModifierId, "forum_post_write_uid_index");
            ...
            entity.Property(e => e.BumpDate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("bump_date");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ForumPostCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.ForumPost)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ForumPostWriteU)
            ...
            // entity.HasMany(d => d.ForumTag).WithMany(p => p.ForumNavigation)
            entity.HasMany(d => d.ForumTag).WithMany(p => p.ForumNavigation)
                .UsingEntity<Dictionary<string, object>>(
                    "ForumTagRel",
                    r => r.HasOne<ForumTag>().WithMany()
                    ...
                    l => l.HasOne<ForumPost>().WithMany()
                        ...
                        .HasConstraintName("forum_tag_rel_forum_id_fkey"),
                    j =>
                    {
                        j.HasKey("ForumId", "ForumTagId").HasName("forum_tag_rel_pkey");
                        j.ToTable("forum_tag_rel");
                        j.HasIndex(new[] { "ForumTagId", "ForumId" }, "forum_tag_rel_forum_tag_id_forum_id_idx");
                        j.IndexerProperty<Guid>("ForumId").HasColumnName("forum_id");
                        j.IndexerProperty<Guid>("ForumTagId").HasColumnName("forum_tag_id");
                    });
