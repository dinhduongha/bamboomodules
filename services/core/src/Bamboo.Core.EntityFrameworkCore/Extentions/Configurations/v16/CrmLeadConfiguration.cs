...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmLead>(entity =>
            ...
            entity.HasIndex(e => e.PartnerAssignedId, "crm_lead_partner_assigned_id_index").HasFilter("(partner_assigned_id IS NOT NULL)");
            ...
            entity.HasIndex(e => e.RevealRuleId, "crm_lead_reveal_rule_id_index").HasFilter("(reveal_rule_id IS NOT NULL)");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.CrmLead)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_lead_company_id_fkey");

            // entity.HasOne(d => d.Country).WithMany(p => p.CrmLead)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_lead_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmLeadCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.CrmLead)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.CrmLeadPartner)
            ...
            entity.HasOne(d => d.State).WithMany(p => p.CrmLead)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CrmLeadUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_lead_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmLeadWriteU)
