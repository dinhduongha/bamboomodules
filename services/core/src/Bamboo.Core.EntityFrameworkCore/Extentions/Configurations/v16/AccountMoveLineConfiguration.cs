...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountMoveLine>(entity =>
            ...
            entity.HasIndex(e => e.CogsOriginId, "account_move_line_cogs_origin_id_index").HasFilter("(cogs_origin_id IS NOT NULL)");
            ...
            entity.HasIndex(e => e.MatchingNumber, "account_move_line_matching_number_index");
            ...
            // entity.HasOne(d => d.Account).WithMany(p => p.AccountMoveLine)
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountMoveLine)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_move_line_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountMoveLineCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_move_line_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.AccountMoveLineCurrency)
            ...
            // entity.HasOne(d => d.Journal).WithMany(p => p.AccountMoveLine)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.AccountMoveLine)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.AccountMoveLine)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("account_move_line_product_id_fkey");

            // entity.HasOne(d => d.ProductUom).WithMany(p => p.AccountMoveLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountMoveLineWriteU)
