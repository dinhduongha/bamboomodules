    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductAttributeValue>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("product_attribute_value_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductAttributeValueCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_attribute_value_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("product_attribute_value_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductAttributeValueWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_attribute_value_write_uid_fkey");
