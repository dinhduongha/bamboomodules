...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosSession>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.PosSessionCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.PosSession)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.PosSessionUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("pos_session_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.PosSessionWriteU)
