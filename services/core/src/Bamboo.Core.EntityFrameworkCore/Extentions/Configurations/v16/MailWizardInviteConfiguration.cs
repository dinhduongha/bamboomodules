    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailWizardInvite>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_wizard_invite_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailWizardInviteCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_wizard_invite_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mail_wizard_invite_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailWizardInviteWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_wizard_invite_write_uid_fkey");
