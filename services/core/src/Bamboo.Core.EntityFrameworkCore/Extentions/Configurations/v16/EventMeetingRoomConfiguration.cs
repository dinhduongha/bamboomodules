...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventMeetingRoom>(entity =>
            ...
            entity.HasIndex(e => e.IsPublished, "event_meeting_room_is_published_index");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventMeetingRoomCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventMeetingRoomWriteU)
