...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<OnboardingOnboardingStep>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.OnboardingOnboardingStepCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("onboarding_onboarding_step_create_uid_fkey");

            entity.HasOne(d => d.Onboarding).WithMany(p => p.OnboardingOnboardingStep)
                .HasForeignKey(d => d.OnboardingId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("onboarding_onboarding_step_onboarding_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.OnboardingOnboardingStepWriteU)
