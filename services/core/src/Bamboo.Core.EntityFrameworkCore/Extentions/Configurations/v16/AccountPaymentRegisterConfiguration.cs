...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountPaymentRegister>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountPaymentRegister)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_payment_register_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountPaymentRegisterCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_payment_register_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.AccountPaymentRegisterCurrency)
            ...
            // entity.HasOne(d => d.Journal).WithMany(p => p.AccountPaymentRegister)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.AccountPaymentRegister)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountPaymentRegisterWriteU)
