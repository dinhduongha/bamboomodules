...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventTypeTicket>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventTypeTicketCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.EventTypeTicket)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("event_type_ticket_product_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventTypeTicketWriteU)
