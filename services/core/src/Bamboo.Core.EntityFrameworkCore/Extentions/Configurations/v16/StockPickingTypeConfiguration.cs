...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockPickingType>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockPickingType)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_picking_type_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockPickingTypeCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockPickingTypeWriteU)
