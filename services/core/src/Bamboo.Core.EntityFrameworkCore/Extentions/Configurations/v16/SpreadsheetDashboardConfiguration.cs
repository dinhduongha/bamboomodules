...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SpreadsheetDashboard>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.SpreadsheetDashboard)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("spreadsheet_dashboard_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.SpreadsheetDashboardCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.SpreadsheetDashboardWriteU)
            ...
            entity.HasMany(d => d.IrModel).WithMany()
