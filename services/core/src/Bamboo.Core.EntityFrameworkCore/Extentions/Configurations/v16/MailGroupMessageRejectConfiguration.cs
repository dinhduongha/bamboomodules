    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailGroupMessageReject>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_group_message_reject_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailGroupMessageRejectCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_group_message_reject_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailGroupMessageRejectWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_group_message_reject_write_uid_fkey");
