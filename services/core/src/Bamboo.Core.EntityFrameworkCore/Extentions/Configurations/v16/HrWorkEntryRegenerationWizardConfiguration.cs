    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrWorkEntryRegenerationWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_work_entry_regeneration_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrWorkEntryRegenerationWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_work_entry_regeneration_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("hr_work_entry_regeneration_wizard_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrWorkEntryRegenerationWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_work_entry_regeneration_wizard_write_uid_fkey");
