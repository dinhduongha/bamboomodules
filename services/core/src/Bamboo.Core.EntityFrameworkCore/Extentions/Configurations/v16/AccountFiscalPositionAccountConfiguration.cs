...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountFiscalPositionAccount>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountFiscalPositionAccount)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_fiscal_position_account_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountFiscalPositionAccountCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountFiscalPositionAccountWriteU)
