    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResUsersSettingsVolumes>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("res_users_settings_volumes_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ResUsersSettingsVolumesCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_users_settings_volumes_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("res_users_settings_volumes_create_uid_fkey");

                        // entity.HasOne(d => d.Guest).WithMany(p => p.ResUsersSettingsVolumesGuest) .HasForeignKey(d => d.GuestId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("res_users_settings_volumes_guest_id_fkey");
                        entity.HasOne(d => d.Guest).WithMany()
                            .HasForeignKey(d => d.GuestId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("res_users_settings_volumes_guest_id_fkey");

                        // entity.HasOne(d => d.Partner).WithMany(p => p.ResUsersSettingsVolumesPartner) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("res_users_settings_volumes_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ResUsersSettingsVolumesWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_users_settings_volumes_write_uid_fkey");
