...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpProduction>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.MrpProduction)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("mrp_production_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpProductionCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.MrpProduction)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.MrpProduction)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("mrp_production_product_id_fkey");

            // entity.HasOne(d => d.ProductUom).WithMany(p => p.MrpProduction)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.MrpProductionUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mrp_production_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpProductionWriteU)
