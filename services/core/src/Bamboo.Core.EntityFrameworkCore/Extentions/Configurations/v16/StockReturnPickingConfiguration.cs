    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockReturnPicking>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_return_picking_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockReturnPickingCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_return_picking_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockReturnPickingWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_return_picking_write_uid_fkey");
