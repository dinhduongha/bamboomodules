...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailActivity>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MailActivityCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mail_activity_create_uid_fkey");

            entity.HasOne(d => d.NoteNavigation).WithMany(p => p.MailActivity)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.MailActivityUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("mail_activity_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MailActivityWriteU)
