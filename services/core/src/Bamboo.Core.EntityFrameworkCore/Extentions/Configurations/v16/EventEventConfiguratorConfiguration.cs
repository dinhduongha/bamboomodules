    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventEventConfigurator>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("event_event_configurator_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.EventEventConfiguratorCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_event_configurator_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.EventEventConfigurator) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_event_configurator_product_id_fkey");
                        entity.HasOne(d => d.Product).WithMany()
                            .HasForeignKey(d => d.ProductId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("event_event_configurator_product_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.EventEventConfiguratorWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_event_configurator_write_uid_fkey");
