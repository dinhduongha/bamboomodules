...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MaintenanceRequest>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.MaintenanceRequest)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("maintenance_request_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.MaintenanceRequestCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.MaintenanceRequest)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.MaintenanceRequestUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("maintenance_request_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MaintenanceRequestWriteU)
