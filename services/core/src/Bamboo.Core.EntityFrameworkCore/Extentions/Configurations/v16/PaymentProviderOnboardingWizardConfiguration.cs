    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PaymentProviderOnboardingWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("payment_provider_onboarding_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.PaymentProviderOnboardingWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("payment_provider_onboarding_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("payment_provider_onboarding_wizard_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.PaymentProviderOnboardingWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("payment_provider_onboarding_wizard_write_uid_fkey");
