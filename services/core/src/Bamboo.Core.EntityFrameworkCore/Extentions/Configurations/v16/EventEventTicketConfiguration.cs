...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventEventTicket>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventEventTicketCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.EventEventTicket)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("event_event_ticket_product_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventEventTicketWriteU)
