    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventEventTicket>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("event_event_ticket_pkey");
                        ...
                        entity.ToTable("event_event_ticket");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.EventEventTicketCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_event_ticket_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("event_event_ticket_create_uid_fkey");

                        entity.HasOne(d => d.Event).WithMany(p => p.EventEventTicket)
                            .HasForeignKey(d => d.EventId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("event_event_ticket_event_id_fkey");

                        entity.HasOne(d => d.EventType).WithMany(p => p.EventEventTicket)
                            .HasForeignKey(d => d.EventTypeId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("event_event_ticket_event_type_id_fkey");

                        // entity.HasOne(d => d.Product).WithMany(p => p.EventEventTicket) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("event_event_ticket_product_id_fkey");
                        entity.HasOne(d => d.Product).WithMany()
                            .HasForeignKey(d => d.ProductId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("event_event_ticket_product_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.EventEventTicketWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_event_ticket_write_uid_fkey");
