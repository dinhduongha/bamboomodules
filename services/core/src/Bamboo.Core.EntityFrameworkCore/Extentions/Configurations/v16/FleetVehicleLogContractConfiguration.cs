...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<FleetVehicleLogContract>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.FleetVehicleLogContract)
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.FleetVehicleLogContractCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.FleetVehicleLogContract)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.FleetVehicleLogContractUser)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.FleetVehicleLogContractWriteU)
