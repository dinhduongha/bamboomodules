...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosOrder>(entity =>
            ...
            entity.Property(e => e.MultiprintResume).HasColumnName("multiprint_resume");
            ...
            entity.HasOne(d => d.AccountMoveNavigation).WithMany()
                .HasForeignKey(d => d.AccountMove)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("pos_order_account_move_fkey");

            // entity.HasOne(d => d.Company).WithMany(p => p.PosOrder)
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.PosOrderCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.PosOrder)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.PosOrderUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("pos_order_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.PosOrderWriteU)
