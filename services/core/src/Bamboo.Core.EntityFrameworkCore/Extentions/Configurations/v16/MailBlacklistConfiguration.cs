...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailBlacklist>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MailBlacklistCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.MailBlacklist)
            entity.HasOne(d => d.MessageMainAttachment).WithMany()
                .HasForeignKey(d => d.MessageMainAttachmentId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mail_blacklist_message_main_attachment_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MailBlacklistWriteU)
