...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockScrap>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockScrap)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_scrap_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockScrapCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockScrap)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_scrap_product_id_fkey");

            // entity.HasOne(d => d.ProductUom).WithMany(p => p.StockScrap)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockScrapWriteU)
