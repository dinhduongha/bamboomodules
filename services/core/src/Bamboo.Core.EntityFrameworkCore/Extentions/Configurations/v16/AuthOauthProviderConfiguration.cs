    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AuthOauthProvider>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("auth_oauth_provider_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AuthOauthProviderCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("auth_oauth_provider_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("auth_oauth_provider_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AuthOauthProviderWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("auth_oauth_provider_write_uid_fkey");
