    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsiteTrack>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("website_track_pkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.WebsiteTrack) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("website_track_product_id_fkey");
