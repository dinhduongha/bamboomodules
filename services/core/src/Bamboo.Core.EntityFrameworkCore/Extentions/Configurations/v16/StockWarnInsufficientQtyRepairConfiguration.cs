...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockWarnInsufficientQtyRepair>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockWarnInsufficientQtyRepairCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockWarnInsufficientQtyRepair)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockWarnInsufficientQtyRepairWriteU)
