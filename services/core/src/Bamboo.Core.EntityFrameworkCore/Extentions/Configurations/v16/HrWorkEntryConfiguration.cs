    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrWorkEntry>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_work_entry_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.HrWorkEntry) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("hr_work_entry_company_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrWorkEntryWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_work_entry_write_uid_fkey");
