    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailMessageSubtype>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_message_subtype_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailMessageSubtypeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_message_subtype_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailMessageSubtypeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_message_subtype_write_uid_fkey");
