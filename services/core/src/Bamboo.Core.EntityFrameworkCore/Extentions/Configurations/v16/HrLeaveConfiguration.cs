...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrLeave>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrLeaveCompany)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_leave_company_id_fkey");

            entity.HasOne(d => d.Category).WithMany(p => p.HrLeave)
                .HasForeignKey(d => d.CategoryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_leave_category_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrLeaveCreateU)
            ...
            entity.HasOne(d => d.HolidayAllocation).WithMany(p => p.HrLeave)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.HrLeave)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.HrLeaveUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_leave_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrLeaveWriteU)
            entity.HasOne(d => d.WriteU).WithMany()
                .HasForeignKey(d => d.LastModifierId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_leave_write_uid_fkey");

            // entity.HasMany(d => d.HrEmployee).WithMany(p => p.HrLeave)
            entity.HasMany(d => d.HrEmployee).WithMany(p => p.HrLeave)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<Guid>("HrLeaveId").HasColumnName("hr_leave_id");
