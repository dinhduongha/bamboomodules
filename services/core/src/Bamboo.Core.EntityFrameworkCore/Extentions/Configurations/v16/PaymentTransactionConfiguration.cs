...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PaymentTransaction>(entity =>
            ...
            entity.HasOne(d => d.CallbackModel).WithMany(p => p.PaymentTransaction)
                .HasForeignKey(d => d.CallbackModelId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("payment_transaction_callback_model_id_fkey");

            // entity.HasOne(d => d.Company).WithMany(p => p.PaymentTransaction)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("payment_transaction_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.PaymentTransactionCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("payment_transaction_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.PaymentTransaction)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.PaymentTransaction)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("payment_transaction_partner_id_fkey");

            entity.HasOne(d => d.PartnerState).WithMany(p => p.PaymentTransaction)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.PaymentTransactionWriteU)
