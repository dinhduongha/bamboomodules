    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseModuleInstallRequest>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("base_module_install_request_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseModuleInstallRequestCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_module_install_request_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.User).WithMany(p => p.BaseModuleInstallRequestUser) .HasForeignKey(d => d.UserId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("base_module_install_request_user_id_fkey");
                        entity.HasOne(d => d.User).WithMany()
                            .HasForeignKey(d => d.UserId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("base_module_install_request_user_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseModuleInstallRequestWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_module_install_request_write_uid_fkey");
