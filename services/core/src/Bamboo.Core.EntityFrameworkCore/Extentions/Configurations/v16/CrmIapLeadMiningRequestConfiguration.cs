...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmIapLeadMiningRequest>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmIapLeadMiningRequestCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CrmIapLeadMiningRequestUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_iap_lead_mining_request_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmIapLeadMiningRequestWriteU)
