    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BasePartnerMergeAutomaticWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("base_partner_merge_automatic_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BasePartnerMergeAutomaticWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_partner_merge_automatic_wizard_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.DstPartner).WithMany(p => p.BasePartnerMergeAutomaticWizard) .HasForeignKey(d => d.DstPartnerId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_partner_merge_automatic_wizard_dst_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BasePartnerMergeAutomaticWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_partner_merge_automatic_wizard_write_uid_fkey");
