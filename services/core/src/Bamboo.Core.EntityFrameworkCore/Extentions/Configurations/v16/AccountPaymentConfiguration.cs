    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountPayment>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_payment_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.AccountPayment) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_payment_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("account_payment_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountPaymentCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_payment_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_payment_create_uid_fkey");

                        // entity.HasOne(d => d.Currency).WithMany(p => p.AccountPayment) .HasForeignKey(d => d.CurrencyId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_payment_currency_id_fkey");
                        entity.HasOne(d => d.Currency).WithMany()
                            .HasForeignKey(d => d.CurrencyId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_payment_currency_id_fkey");

                        // entity.HasOne(d => d.DestinationAccount).WithMany(p => p.AccountPaymentDestinationAccount) .HasForeignKey(d => d.DestinationAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_payment_destination_account_id_fkey");
                        ...
                        // entity.HasOne(d => d.ForceOutstandingAccount).WithMany(p => p.AccountPaymentForceOutstandingAccount) .HasForeignKey(d => d.ForceOutstandingAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_payment_force_outstanding_account_id_fkey");
                        ...
                        // entity.HasOne(d => d.Journal).WithMany(p => p.AccountPayment) .HasForeignKey(d => d.JournalId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_payment_journal_id_fkey");
                        entity.HasOne(d => d.Journal).WithMany()
                            .HasForeignKey(d => d.JournalId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("account_payment_journal_id_fkey");

                        // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.AccountPayment) .HasForeignKey(d => d.MessageMainAttachmentId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_payment_message_main_attachment_id_fkey");
                        ...
                        // entity.HasOne(d => d.OutstandingAccount).WithMany(p => p.AccountPaymentOutstandingAccount) .HasForeignKey(d => d.OutstandingAccountId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_payment_outstanding_account_id_fkey");
                        ...
                        // entity.HasOne(d => d.Partner).WithMany(p => p.AccountPayment) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_payment_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountPaymentWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_payment_write_uid_fkey");
