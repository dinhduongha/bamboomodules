...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosOrderLine>(entity =>
            ...
            entity.Property(e => e.MpSkip).HasColumnName("mp_skip");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.PosOrderLine)
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.PosOrderLineCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.PosOrderLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.PosOrderLineWriteU)
