    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseImportImport>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("base_import_import_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseImportImportCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_import_import_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("base_import_import_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseImportImportWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_import_import_write_uid_fkey");
