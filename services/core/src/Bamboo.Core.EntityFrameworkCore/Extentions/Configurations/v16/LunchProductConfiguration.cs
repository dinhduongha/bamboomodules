...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LunchProduct>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.LunchProduct)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("lunch_product_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.LunchProductCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.LunchProductWriteU)
