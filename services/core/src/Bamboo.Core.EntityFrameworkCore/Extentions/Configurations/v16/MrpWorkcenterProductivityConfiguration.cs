...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpWorkcenterProductivity>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.MrpWorkcenterProductivity)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("mrp_workcenter_productivity_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpWorkcenterProductivityCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.MrpWorkcenterProductivityUser)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpWorkcenterProductivityWriteU)
