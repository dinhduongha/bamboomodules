...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SurveyQuestion>(entity =>
            ...
            entity.Property(e => e.IsConditional).HasColumnName("is_conditional");
            ...
            entity.Property(e => e.Title)
                .HasColumnType("jsonb")
                .HasColumnName("title");
            entity.Property(e => e.TriggeringAnswerId).HasColumnName("triggering_answer_id");
            entity.Property(e => e.TriggeringQuestionId).HasColumnName("triggering_question_id");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.SurveyQuestionCreateU)
            ...
            entity.HasOne(d => d.TriggeringAnswer).WithMany(p => p.SurveyQuestion)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.SurveyQuestionWriteU)
