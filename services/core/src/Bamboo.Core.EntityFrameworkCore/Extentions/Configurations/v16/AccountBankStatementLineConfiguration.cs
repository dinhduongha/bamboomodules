...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountBankStatementLine>(entity =>
            ...
            entity.HasIndex(e => e.MoveId, "account_bank_statement_line_move_id_index");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountBankStatementLine)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_bank_statement_line_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountBankStatementLineCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_bank_statement_line_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.AccountBankStatementLineCurrency)
            ...
            // entity.HasOne(d => d.Journal).WithMany(p => p.AccountBankStatementLine)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.AccountBankStatementLine)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountBankStatementLineWriteU)
