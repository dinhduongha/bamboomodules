...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SnailmailLetter>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.SnailmailLetter)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("snailmail_letter_company_id_fkey");

            // entity.HasOne(d => d.Country).WithMany(p => p.SnailmailLetter)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("snailmail_letter_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.SnailmailLetterCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.SnailmailLetter)
            ...
            entity.HasOne(d => d.StateNavigation).WithMany(p => p.SnailmailLetter)
                .HasForeignKey(d => d.StateId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("snailmail_letter_state_id_fkey");

            // entity.HasOne(d => d.User).WithMany(p => p.SnailmailLetterUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("snailmail_letter_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.SnailmailLetterWriteU)
