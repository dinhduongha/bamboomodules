...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmRevealRule>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmRevealRuleCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CrmRevealRuleUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_reveal_rule_user_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.CrmRevealRule)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_reveal_rule_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmRevealRuleWriteU)
