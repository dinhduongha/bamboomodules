    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrHolidaysCancelLeave>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_holidays_cancel_leave_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrHolidaysCancelLeaveCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_holidays_cancel_leave_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrHolidaysCancelLeaveWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_holidays_cancel_leave_write_uid_fkey");
