    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsiteRewrite>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("website_rewrite_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsiteRewriteCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("website_rewrite_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Website).WithMany(p => p.WebsiteRewrite) .HasForeignKey(d => d.WebsiteId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("website_rewrite_website_id_fkey");
                        entity.HasOne(d => d.Website).WithMany()
                            .HasForeignKey(d => d.WebsiteId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("website_rewrite_website_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsiteRewriteWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("website_rewrite_write_uid_fkey");
