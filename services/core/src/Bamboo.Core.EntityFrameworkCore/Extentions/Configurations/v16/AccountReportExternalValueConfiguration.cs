...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountReportExternalValue>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountReportExternalValue)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("account_report_external_value_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountReportExternalValueCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountReportExternalValueWriteU)
