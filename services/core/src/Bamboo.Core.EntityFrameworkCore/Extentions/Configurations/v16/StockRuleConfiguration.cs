...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockRule>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockRule)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_rule_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockRuleCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockRuleWriteU)
