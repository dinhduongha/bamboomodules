...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmRevealView>(entity =>
            ...
            entity.HasIndex(e => e.CreationTime, "crm_reveal_view_create_date_index");

            entity.HasIndex(e => e.RevealRuleId, "crm_reveal_view_reveal_rule_id_index").HasFilter("(reveal_rule_id IS NOT NULL)");

            entity.HasIndex(e => e.RevealState, "crm_reveal_view_reveal_state_index");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmRevealViewCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmRevealViewWriteU)
