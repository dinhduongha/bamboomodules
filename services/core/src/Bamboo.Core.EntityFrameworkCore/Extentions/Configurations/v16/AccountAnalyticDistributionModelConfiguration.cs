...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAnalyticDistributionModel>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.AccountAnalyticDistributionModel)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("account_analytic_distribution_model_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAnalyticDistributionModelCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_analytic_distribution_model_create_uid_fkey");

            // entity.HasOne(d => d.PartnerCategory).WithMany(p => p.AccountAnalyticDistributionModel)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.AccountAnalyticDistributionModel)
            entity.HasOne(d => d.Partner).WithMany()
                .HasForeignKey(d => d.PartnerId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("account_analytic_distribution_model_partner_id_fkey");

            // entity.HasOne(d => d.ProductCateg).WithMany(p => p.AccountAnalyticDistributionModel)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.AccountAnalyticDistributionModel)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("account_analytic_distribution_model_product_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAnalyticDistributionModelWriteU)
