...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpConsumptionWarningLine>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpConsumptionWarningLineCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.MrpConsumptionWarningLine)
            entity.HasOne(d => d.Product).WithMany()
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("mrp_consumption_warning_line_product_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpConsumptionWarningLineWriteU)
