    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SurveyUserInputLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("survey_user_input_line_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SurveyUserInputLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("survey_user_input_line_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SurveyUserInputLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("survey_user_input_line_write_uid_fkey");
