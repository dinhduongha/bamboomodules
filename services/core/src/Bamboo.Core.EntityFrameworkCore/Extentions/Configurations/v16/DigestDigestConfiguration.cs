    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<DigestDigest>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("digest_digest_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.DigestDigest) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("digest_digest_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("digest_digest_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.DigestDigestCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("digest_digest_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("digest_digest_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.DigestDigestWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("digest_digest_write_uid_fkey");
