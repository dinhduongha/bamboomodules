...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventLeadRule>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.EventLeadRule)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_lead_rule_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventLeadRuleCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventLeadRuleWriteU)
