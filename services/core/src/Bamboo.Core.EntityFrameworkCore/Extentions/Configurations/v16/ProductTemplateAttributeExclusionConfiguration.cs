    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductTemplateAttributeExclusion>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("product_template_attribute_exclusion_pkey");
                        ...
                        entity.HasIndex(e => e.ProductTemplateAttributeValueId, "product_template_attribute_exclusion__product_template_5b2f8938");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductTemplateAttributeExclusionCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_template_attribute_exclusion_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductTemplateAttributeExclusionWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_template_attribute_exclusion_write_uid_fkey");
