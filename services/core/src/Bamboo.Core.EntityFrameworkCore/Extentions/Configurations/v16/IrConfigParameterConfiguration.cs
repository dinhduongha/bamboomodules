    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrConfigParameter>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_config_parameter_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrConfigParameterCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_config_parameter_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("ir_config_parameter_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrConfigParameterWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_config_parameter_write_uid_fkey");
