...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountTaxRepartitionLineTemplate>(entity =>
            ...
            // entity.HasOne(d => d.Account).WithMany(p => p.AccountTaxRepartitionLineTemplate)
            entity.HasOne(d => d.Account).WithMany()
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_tax_repartition_line_template_account_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountTaxRepartitionLineTemplateCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountTaxRepartitionLineTemplateWriteU)
