...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductImage>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductImageCreateU)
            ...
            entity.HasOne(d => d.ProductVariant).WithMany(p => p.ProductImage)
                .HasForeignKey(d => d.ProductVariantId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("product_image_product_variant_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductImageWriteU)
