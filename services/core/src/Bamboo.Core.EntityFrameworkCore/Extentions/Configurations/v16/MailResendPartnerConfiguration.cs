    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailResendPartner>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_resend_partner_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailResendPartnerCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_resend_partner_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailResendPartnerWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_resend_partner_write_uid_fkey");
