...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventBoothCategory>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventBoothCategoryCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_booth_category_create_uid_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.EventBoothCategory)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventBoothCategoryWriteU)
