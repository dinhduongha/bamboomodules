...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductPricelistItem>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.ProductPricelistItem)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("product_pricelist_item_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductPricelistItemCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("product_pricelist_item_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.ProductPricelistItem)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.ProductPricelistItem)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductPricelistItemWriteU)
