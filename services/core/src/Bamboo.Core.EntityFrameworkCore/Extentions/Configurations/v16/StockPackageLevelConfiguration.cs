...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockPackageLevel>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockPackageLevel)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_package_level_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockPackageLevelCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockPackageLevelWriteU)
