...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountBankStatementImportJournalCreation>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountBankStatementImportJournalCreationCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("account_bank_statement_import_journal_creation_create_uid_fkey");

            // entity.HasOne(d => d.Journal).WithMany(p => p.AccountBankStatementImportJournalCreation)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountBankStatementImportJournalCreationWriteU)
