...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrExpenseSplit>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrExpenseSplit)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_expense_split_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrExpenseSplitCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_expense_split_create_uid_fkey");

            // entity.HasOne(d => d.Currency).WithMany(p => p.HrExpenseSplit)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.HrExpenseSplit)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrExpenseSplitWriteU)
