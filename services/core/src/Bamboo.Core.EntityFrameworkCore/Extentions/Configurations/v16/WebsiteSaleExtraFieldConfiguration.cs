...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsiteSaleExtraField>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsiteSaleExtraFieldCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.WebsiteSaleExtraField)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("website_sale_extra_field_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsiteSaleExtraFieldWriteU)
