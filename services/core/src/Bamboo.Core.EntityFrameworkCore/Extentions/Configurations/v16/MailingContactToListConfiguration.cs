    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingContactToList>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mailing_contact_to_list_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingContactToListCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_contact_to_list_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingContactToListWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_contact_to_list_write_uid_fkey");
