...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpWorkcenterCapacity>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpWorkcenterCapacityCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mrp_workcenter_capacity_create_uid_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.MrpWorkcenterCapacity)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpWorkcenterCapacityWriteU)
