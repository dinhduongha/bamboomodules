...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseLanguageExport>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseLanguageExportCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseLanguageExportWriteU)
            ...
            entity.HasMany(d => d.Module).WithMany()
