...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockRoute>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockRoute)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_route_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockRouteCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockRouteWriteU)
