...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailChannelMember>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MailChannelMemberCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.MailChannelMember)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.MailChannelMemberWriteU)
