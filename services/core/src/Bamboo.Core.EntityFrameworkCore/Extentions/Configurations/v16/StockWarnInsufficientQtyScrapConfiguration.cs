...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockWarnInsufficientQtyScrap>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockWarnInsufficientQtyScrapCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.StockWarnInsufficientQtyScrap)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockWarnInsufficientQtyScrapWriteU)
