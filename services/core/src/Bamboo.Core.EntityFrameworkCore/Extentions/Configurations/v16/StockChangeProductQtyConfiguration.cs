    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockChangeProductQty>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_change_product_qty_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockChangeProductQtyCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_change_product_qty_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("stock_change_product_qty_create_uid_fkey");

                        // entity.HasOne(d => d.Product).WithMany(p => p.StockChangeProductQty) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("stock_change_product_qty_product_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockChangeProductQtyWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_change_product_qty_write_uid_fkey");
