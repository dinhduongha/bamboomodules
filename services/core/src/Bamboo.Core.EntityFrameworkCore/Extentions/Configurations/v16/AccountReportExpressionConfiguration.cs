    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountReportExpression>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_report_expression_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountReportExpressionCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_report_expression_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_report_expression_create_uid_fkey");

                        entity.HasOne(d => d.ReportLine).WithMany(p => p.AccountReportExpression)
                            .HasForeignKey(d => d.ReportLineId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("account_report_expression_report_line_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountReportExpressionWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_report_expression_write_uid_fkey");
