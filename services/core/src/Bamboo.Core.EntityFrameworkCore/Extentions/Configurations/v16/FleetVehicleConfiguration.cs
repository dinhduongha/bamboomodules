...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<FleetVehicle>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.FleetVehicle)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("fleet_vehicle_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.FleetVehicleCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.FleetVehicle)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.FleetVehicleWriteU)
