...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProjectProject>(entity =>
            ...
            // entity.HasOne(d => d.Account).WithMany(p => p.ProjectProjectAccount)
            ...
            entity.HasOne(d => d.AnalyticAccount).WithMany(p => p.ProjectProject)
                .HasForeignKey(d => d.AnalyticAccountId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_project_analytic_account_id_fkey");

            // entity.HasOne(d => d.Company).WithMany(p => p.ProjectProject)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_project_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.ProjectProjectCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.ProjectProject)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.ProjectProject)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ProjectProjectWriteU)
