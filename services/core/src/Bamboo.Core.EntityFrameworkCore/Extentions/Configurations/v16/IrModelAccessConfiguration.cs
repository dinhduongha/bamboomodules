    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrModelAccess>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_model_access_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrModelAccessCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_model_access_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrModelAccessWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_model_access_write_uid_fkey");
