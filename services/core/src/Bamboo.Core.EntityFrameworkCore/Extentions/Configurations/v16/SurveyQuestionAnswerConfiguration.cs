    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SurveyQuestionAnswer>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("survey_question_answer_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SurveyQuestionAnswerCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("survey_question_answer_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SurveyQuestionAnswerWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("survey_question_answer_write_uid_fkey");
