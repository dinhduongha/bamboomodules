    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosMakePayment>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("pos_make_payment_pkey");
                        ...
                        entity.HasOne(d => d.Config).WithMany(p => p.PosMakePayment)
                            .HasForeignKey(d => d.ConfigId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("pos_make_payment_config_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.PosMakePaymentCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("pos_make_payment_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("pos_make_payment_create_uid_fkey");

                        entity.HasOne(d => d.PaymentMethod).WithMany(p => p.PosMakePayment)
                            .HasForeignKey(d => d.PaymentMethodId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("pos_make_payment_payment_method_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.PosMakePaymentWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("pos_make_payment_write_uid_fkey");
