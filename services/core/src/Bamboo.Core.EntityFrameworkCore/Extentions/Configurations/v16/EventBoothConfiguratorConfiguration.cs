...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventBoothConfigurator>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventBoothConfiguratorCreateU)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.EventBoothConfigurator)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventBoothConfiguratorWriteU)
