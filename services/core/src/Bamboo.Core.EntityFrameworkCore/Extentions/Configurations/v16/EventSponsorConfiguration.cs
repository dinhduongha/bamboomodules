...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventSponsor>(entity =>
            ...
            entity.HasIndex(e => e.IsPublished, "event_sponsor_is_published_index");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventSponsorCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventSponsorWriteU)
