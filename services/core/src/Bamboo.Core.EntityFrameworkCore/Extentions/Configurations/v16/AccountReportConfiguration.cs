...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountReport>(entity =>
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountReportWriteU)
