    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrActReportXml>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_act_report_xml_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrActReportXmlCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_act_report_xml_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrActReportXmlWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_act_report_xml_write_uid_fkey");
