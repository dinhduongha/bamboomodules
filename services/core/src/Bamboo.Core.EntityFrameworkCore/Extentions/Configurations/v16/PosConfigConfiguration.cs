...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosConfig>(entity =>
            ...
            entity.Property(e => e.GiftCardSettings).HasColumnName("gift_card_settings");
            ...
            entity.Property(e => e.IfaceOrderlineNotes).HasColumnName("iface_orderline_notes");
            ...
            entity.Property(e => e.IsTableManagement).HasColumnName("is_table_management");
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.PosConfig)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("pos_config_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.PosConfigCreateU)
           ...
           entity.HasOne(d => d.DefaultFiscalPosition).WithMany(p => p.PosConfigDefaultFiscalPosition)
            ...
            entity.HasOne(d => d.IfaceStartCateg).WithMany(p => p.PosConfigNavigation)
            ...
            // entity.HasOne(d => d.Journal).WithMany(p => p.PosConfigJournal)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.PosConfigWriteU)
            ...
            // entity.HasMany(d => d.PosPaymentMethod).WithMany(p => p.PosConfig)
            entity.HasMany(d => d.PosPaymentMethod).WithMany(p => p.PosConfigNavigation)
                .UsingEntity<Dictionary<string, object>>(
            ...
            //     .UsingEntity<Dictionary<string, object>>(
            //         "PosConfigPrinterRel",
            //         r => r.HasOne<RestaurantPrinter>().WithMany()
            //             .HasForeignKey("PrinterId")
            //             .HasConstraintName("pos_config_printer_rel_printer_id_fkey"),
            //         l => l.HasOne<PosConfig>().WithMany()
            //             .HasForeignKey("ConfigId")
            ...
            entity.HasMany(d => d.ResLang).WithMany()
                .UsingEntity<Dictionary<string, object>>(
                    "PosConfigResLangRel",
