...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockRulesReport>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockRulesReportCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_rules_report_create_uid_fkey");

            // entity.HasOne(d => d.Product).WithMany(p => p.StockRulesReport)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockRulesReportWriteU)
