    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockOrderpointSnooze>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_orderpoint_snooze_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockOrderpointSnoozeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_orderpoint_snooze_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("stock_orderpoint_snooze_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockOrderpointSnoozeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_orderpoint_snooze_write_uid_fkey");
