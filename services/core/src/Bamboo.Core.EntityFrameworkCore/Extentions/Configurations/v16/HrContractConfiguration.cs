    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrContract>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_contract_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.HrContract) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("hr_contract_company_id_fkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrContractCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_contract_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.HrResponsible).WithMany(p => p.HrContractHrResponsible) .HasForeignKey(d => d.HrResponsibleId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_contract_hr_responsible_id_fkey");
                        ...
                        // entity.HasOne(d => d.Journal).WithMany(p => p.HrContract) .HasForeignKey(d => d.JournalId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_contract_journal_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrContractWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_contract_write_uid_fkey");
