...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrApplicant>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.HrApplicant)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_applicant_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.HrApplicantCreateU)
            ...
            entity.HasOne(d => d.Emp).WithMany(p => p.HrApplicant)
            ...
            entity.HasOne(d => d.Response).WithMany(p => p.HrApplicant)
                .HasForeignKey(d => d.ResponseId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_applicant_response_id_fkey");
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.HrApplicantUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("hr_applicant_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.HrApplicantWriteU)
