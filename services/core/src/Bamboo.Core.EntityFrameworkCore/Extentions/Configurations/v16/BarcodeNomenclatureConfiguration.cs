    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BarcodeNomenclature>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("barcode_nomenclature_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BarcodeNomenclatureCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("barcode_nomenclature_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("barcode_nomenclature_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BarcodeNomenclatureWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("barcode_nomenclature_write_uid_fkey");
