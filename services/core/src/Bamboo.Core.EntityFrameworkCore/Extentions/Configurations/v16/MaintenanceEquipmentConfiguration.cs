...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MaintenanceEquipment>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.MaintenanceEquipment)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("maintenance_equipment_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.MaintenanceEquipmentCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.MaintenanceEquipment)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.MaintenanceEquipment)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.MaintenanceEquipmentWriteU)
