    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAgedTrialBalance>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_aged_trial_balance_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.AccountAgedTrialBalance) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("account_aged_trial_balance_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("account_aged_trial_balance_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAgedTrialBalanceCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_aged_trial_balance_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_aged_trial_balance_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAgedTrialBalanceWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_aged_trial_balance_write_uid_fkey");
