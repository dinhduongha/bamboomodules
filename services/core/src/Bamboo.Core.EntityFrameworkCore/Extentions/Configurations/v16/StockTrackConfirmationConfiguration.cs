    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockTrackConfirmation>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_track_confirmation_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockTrackConfirmationCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_track_confirmation_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("stock_track_confirmation_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockTrackConfirmationWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_track_confirmation_write_uid_fkey");
