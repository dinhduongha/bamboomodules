    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseLanguageInstall>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("base_language_install_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseLanguageInstallCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_language_install_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("base_language_install_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseLanguageInstallWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_language_install_write_uid_fkey");
