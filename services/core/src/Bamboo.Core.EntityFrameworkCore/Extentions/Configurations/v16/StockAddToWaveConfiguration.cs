...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockAddToWave>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockAddToWaveCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_add_to_wave_create_uid_fkey");

            // entity.HasOne(d => d.User).WithMany(p => p.StockAddToWaveUser)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockAddToWaveWriteU)
