...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmLead2opportunityPartner>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmLead2opportunityPartnerCreateU)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.CrmLead2opportunityPartner)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.CrmLead2opportunityPartnerUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("crm_lead2opportunity_partner_user_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmLead2opportunityPartnerWriteU)
