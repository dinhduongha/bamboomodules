    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockValuationLayer>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_valuation_layer_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.StockValuationLayer) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("stock_valuation_layer_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("stock_valuation_layer_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockValuationLayerCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_valuation_layer_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.StockValuationLayer) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("stock_valuation_layer_product_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockValuationLayerWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_valuation_layer_write_uid_fkey");
