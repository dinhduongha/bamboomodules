    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseModuleInstallReview>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("base_module_install_review_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseModuleInstallReviewCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_module_install_review_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseModuleInstallReviewWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_module_install_review_write_uid_fkey");
