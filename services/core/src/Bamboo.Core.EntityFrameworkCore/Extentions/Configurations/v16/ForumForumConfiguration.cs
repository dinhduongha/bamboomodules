...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ForumForum>(entity =>
            ...
            entity.HasIndex(e => e.WebsiteId, "forum_forum_website_id_index");
            ...
            entity.Property(e => e.AllowBump).HasColumnName("allow_bump");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.ForumForumCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("forum_forum_create_uid_fkey");

            entity.HasOne(d => d.Menu).WithMany(p => p.ForumForum)
                .HasForeignKey(d => d.MenuId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("forum_forum_menu_id_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.ForumForum)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.ForumForum)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("forum_forum_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.ForumForumWriteU)
