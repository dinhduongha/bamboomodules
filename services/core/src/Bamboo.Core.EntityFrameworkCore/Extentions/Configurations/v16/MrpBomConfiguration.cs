...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpBom>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.MrpBom)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mrp_bom_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpBomCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mrp_bom_create_uid_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.MrpBom)
            ...
            // entity.HasOne(d => d.Product).WithMany(p => p.MrpBom)
            ...
            // entity.HasOne(d => d.ProductUom).WithMany(p => p.MrpBom)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpBomWriteU)
