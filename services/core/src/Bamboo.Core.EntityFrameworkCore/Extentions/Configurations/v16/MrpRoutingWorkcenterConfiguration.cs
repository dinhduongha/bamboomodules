    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpRoutingWorkcenter>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_routing_workcenter_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpRoutingWorkcenterCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_routing_workcenter_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpRoutingWorkcenterWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_routing_workcenter_write_uid_fkey");
