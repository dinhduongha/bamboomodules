...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrUiView>(entity =>
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.IrUiViewCreateU)
            ...
            // entity.HasOne(d => d.Website).WithMany(p => p.IrUiView)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("ir_ui_view_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.IrUiViewWriteU)
