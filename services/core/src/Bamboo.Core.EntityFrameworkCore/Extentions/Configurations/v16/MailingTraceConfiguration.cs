...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingTrace>(entity =>
            ...
            entity.Property(e => e.SmsSmsId).HasColumnName("sms_sms_id");
            entity.Property(e => e.SmsSmsIdInt).HasColumnName("sms_sms_id_int");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingTraceCreateU)
            ...
            entity.HasOne(d => d.SmsSms).WithMany(p => p.MailingTrace)
                .HasForeignKey(d => d.SmsSmsId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("mailing_trace_sms_sms_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingTraceWriteU)
