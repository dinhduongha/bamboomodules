    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<RegistrationEditorLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("registration_editor_line_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.RegistrationEditorLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("registration_editor_line_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.RegistrationEditorLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("registration_editor_line_write_uid_fkey");
