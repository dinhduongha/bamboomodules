    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountReconcileModelPartnerMapping>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_reconcile_model_partner_mapping_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountReconcileModelPartnerMappingCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_reconcile_model_partner_mapping_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Partner).WithMany(p => p.AccountReconcileModelPartnerMapping) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("account_reconcile_model_partner_mapping_partner_id_fkey");
                        entity.HasOne(d => d.Partner).WithMany()
                            .HasForeignKey(d => d.PartnerId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("account_reconcile_model_partner_mapping_partner_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountReconcileModelPartnerMappingWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_reconcile_model_partner_mapping_write_uid_fkey");
