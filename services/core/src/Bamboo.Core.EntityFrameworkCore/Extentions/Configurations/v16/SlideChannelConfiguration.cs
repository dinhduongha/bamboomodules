...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SlideChannel>(entity =>
            ...
            entity.Property(e => e.KarmaGenSlideVote).HasColumnName("karma_gen_slide_vote");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.SlideChannelCreateU)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.SlideChannelUser)
            entity.HasOne(d => d.User).WithMany()
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("slide_channel_user_id_fkey");

            // entity.HasOne(d => d.Website).WithMany(p => p.SlideChannel)
            entity.HasOne(d => d.Website).WithMany()
                .HasForeignKey(d => d.WebsiteId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("slide_channel_website_id_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.SlideChannelWriteU)
            ...
            entity.HasMany(d => d.Group).WithMany()
                .UsingEntity<Dictionary<string, object>>(
                    "RelUploadGroups",
