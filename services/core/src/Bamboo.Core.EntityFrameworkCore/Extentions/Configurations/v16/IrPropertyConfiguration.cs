...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrProperty>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.IrProperty)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("ir_property_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.IrPropertyCreateU)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.IrPropertyWriteU)
