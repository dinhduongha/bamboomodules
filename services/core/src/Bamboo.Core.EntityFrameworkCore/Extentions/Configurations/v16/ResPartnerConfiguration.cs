...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResPartner>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.ResPartner)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("res_partner_company_id_fkey");

            // entity.HasOne(d => d.Country).WithMany(p => p.ResPartner)
            entity.HasOne(d => d.Country).WithMany()
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("res_partner_country_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.ResPartnerCreateU)
            ...
            entity.HasOne(d => d.LatestFollowupLevelIdWithoutLitNavigation).WithMany(p => p.ResPartner)
                .HasForeignKey(d => d.LatestFollowupLevelIdWithoutLit)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("res_partner_latest_followup_level_id_without_lit_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.ResPartner)
            ...
            entity.HasOne(d => d.State).WithMany(p => p.ResPartner)
                .HasForeignKey(d => d.StateId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("res_partner_state_id_fkey");

            entity.HasOne(d => d.Team).WithMany(p => p.ResPartner)
            ...
            // entity.HasOne(d => d.User).WithMany(p => p.ResPartnerUser)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.ResPartnerWriteU)
