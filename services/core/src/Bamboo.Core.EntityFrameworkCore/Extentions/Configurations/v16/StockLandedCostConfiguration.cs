...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockLandedCost>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.StockLandedCost)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("stock_landed_cost_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.StockLandedCostCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("stock_landed_cost_create_uid_fkey");

            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.StockLandedCost)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.StockLandedCostWriteU)
