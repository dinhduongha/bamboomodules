    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailActivityType>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_activity_type_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailActivityTypeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_type_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mail_activity_type_create_uid_fkey");

                        // entity.HasOne(d => d.DefaultUser).WithMany(p => p.MailActivityTypeDefaultUser) .HasForeignKey(d => d.DefaultUserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_type_default_user_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailActivityTypeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_type_write_uid_fkey");
