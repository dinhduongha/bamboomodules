    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProcurementGroup>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("procurement_group_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProcurementGroupCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("procurement_group_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("procurement_group_create_uid_fkey");

                        // entity.HasOne(d => d.Partner).WithMany(p => p.ProcurementGroup) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("procurement_group_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProcurementGroupWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("procurement_group_write_uid_fkey");
