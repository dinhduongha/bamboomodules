    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<OnboardingOnboarding>(entity =>
            ...
            entity.Property(e => e.Name)
                .HasColumnType("jsonb")
                .HasColumnName("name");
            entity.Property(e => e.PanelBackgroundColor).HasColumnName("panel_background_color");
            ...
            // entity.HasOne(d => d.CreateU).WithMany(p => p.OnboardingOnboardingCreateU)
            entity.HasOne(d => d.CreateU).WithMany()
                .HasForeignKey(d => d.CreatorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("onboarding_onboarding_create_uid_fkey");

            // entity.HasOne(d => d.WriteU).WithMany(p => p.OnboardingOnboardingWriteU)
