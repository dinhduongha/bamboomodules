    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LinkTrackerCode>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("link_tracker_code_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.LinkTrackerCodeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("link_tracker_code_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.LinkTrackerCodeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("link_tracker_code_write_uid_fkey");
