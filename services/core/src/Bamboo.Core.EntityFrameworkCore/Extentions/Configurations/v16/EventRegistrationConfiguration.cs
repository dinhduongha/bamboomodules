...
namespace Bamboo.Core.EntityFrameworkCore
{
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventRegistration>(entity =>
            ...
            // entity.HasOne(d => d.Company).WithMany(p => p.EventRegistration)
            entity.HasOne(d => d.Company).WithMany()
                .HasForeignKey(d => d.TenantId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_registration_company_id_fkey");

            // entity.HasOne(d => d.CreateU).WithMany(p => p.EventRegistrationCreateU)
            ...
            // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.EventRegistration)
            ...
            // entity.HasOne(d => d.Partner).WithMany(p => p.EventRegistration)
            ...
            // entity.HasOne(d => d.WriteU).WithMany(p => p.EventRegistrationWriteU)
            entity.HasOne(d => d.WriteU).WithMany()
                .HasForeignKey(d => d.LastModifierId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("event_registration_write_uid_fkey");

            // entity.HasMany(d => d.CrmLead).WithMany(p => p.EventRegistration)
            entity.HasMany(d => d.CrmLead).WithMany(p => p.EventRegistration)
