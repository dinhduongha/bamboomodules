    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ResCurrency>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("res_currency_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ResCurrencyCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_currency_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("res_currency_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ResCurrencyWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("res_currency_write_uid_fkey");
