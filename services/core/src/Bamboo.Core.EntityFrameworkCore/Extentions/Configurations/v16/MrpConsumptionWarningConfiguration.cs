    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpConsumptionWarning>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_consumption_warning_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpConsumptionWarningCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_consumption_warning_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mrp_consumption_warning_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpConsumptionWarningWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_consumption_warning_write_uid_fkey");
