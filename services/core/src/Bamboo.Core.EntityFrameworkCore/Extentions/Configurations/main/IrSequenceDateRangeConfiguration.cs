    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrSequenceDateRange>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_sequence_date_range_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrSequenceDateRangeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_sequence_date_range_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrSequenceDateRangeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_sequence_date_range_write_uid_fkey");
