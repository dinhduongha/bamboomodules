    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IapAccount>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("iap_account_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IapAccountCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("iap_account_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IapAccountWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("iap_account_write_uid_fkey");
