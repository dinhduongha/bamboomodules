    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<GamificationGoal>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("gamification_goal_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.GamificationGoalCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("gamification_goal_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.User).WithMany(p => p.GamificationGoalUser) .HasForeignKey(d => d.UserId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("gamification_goal_user_id_fkey");
                        entity.HasOne(d => d.User).WithMany()
                            .HasForeignKey(d => d.UserId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("gamification_goal_user_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.GamificationGoalWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("gamification_goal_write_uid_fkey");
