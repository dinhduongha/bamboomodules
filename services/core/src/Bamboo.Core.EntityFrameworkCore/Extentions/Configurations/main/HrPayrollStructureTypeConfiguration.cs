    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrPayrollStructureType>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_payroll_structure_type_pkey");
                        ...
                        // entity.HasOne(d => d.Country).WithMany(p => p.HrPayrollStructureType) .HasForeignKey(d => d.CountryId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payroll_structure_type_country_id_fkey");
                        entity.HasOne(d => d.Country).WithMany()
                            .HasForeignKey(d => d.CountryId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("hr_payroll_structure_type_country_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrPayrollStructureTypeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payroll_structure_type_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrPayrollStructureTypeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_payroll_structure_type_write_uid_fkey");
