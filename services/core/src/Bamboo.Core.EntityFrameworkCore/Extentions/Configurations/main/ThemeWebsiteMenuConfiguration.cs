    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ThemeWebsiteMenu>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("theme_website_menu_pkey");
                        ...
                        entity.HasIndex(e => e.PageId, "theme_website_menu__page_id_index").HasFilter("(page_id IS NOT NULL)");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ThemeWebsiteMenuCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("theme_website_menu_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ThemeWebsiteMenuWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("theme_website_menu_write_uid_fkey");
