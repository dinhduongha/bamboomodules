    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpProductionBackorder>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_production_backorder_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpProductionBackorderCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_production_backorder_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mrp_production_backorder_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpProductionBackorderWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_production_backorder_write_uid_fkey");
