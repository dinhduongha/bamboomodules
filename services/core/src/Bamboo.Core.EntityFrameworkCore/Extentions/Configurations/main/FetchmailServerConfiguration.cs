    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<FetchmailServer>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("fetchmail_server_pkey");
                        ...
                        entity.HasIndex(e => e.ServerType, "fetchmail_server__server_type_index");

                        entity.HasIndex(e => e.State, "fetchmail_server__state_index");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.FetchmailServerCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("fetchmail_server_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.FetchmailServerWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("fetchmail_server_write_uid_fkey");
