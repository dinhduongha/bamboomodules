    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrLeaveAllocationGenerateMultiWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_leave_allocation_generate_multi_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.HrLeaveAllocationGenerateMultiWizard) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("hr_leave_allocation_generate_multi_wizard_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("hr_leave_allocation_generate_multi_wizard_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrLeaveAllocationGenerateMultiWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_leave_allocation_generate_multi_wizard_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrLeaveAllocationGenerateMultiWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_leave_allocation_generate_multi_wizard_write_uid_fkey");
