    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrCronTrigger>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_cron_trigger_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrCronTriggerCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_cron_trigger_create_uid_fkey");
