    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailTemplate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_template_pkey");
                        ...
                        entity.HasIndex(e => e.MailServerId, "mail_template__mail_server_id_index").HasFilter("(mail_server_id IS NOT NULL)");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailTemplateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_template_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.User).WithMany(p => p.MailTemplateUser) .HasForeignKey(d => d.UserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_template_user_id_fkey");
                        entity.HasOne(d => d.User).WithMany()
                            .HasForeignKey(d => d.UserId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mail_template_user_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailTemplateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_template_write_uid_fkey");
