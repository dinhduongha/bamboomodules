    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingMailingScheduleDate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mailing_mailing_schedule_date_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingMailingScheduleDateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_mailing_schedule_date_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingMailingScheduleDateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_mailing_schedule_date_write_uid_fkey");
