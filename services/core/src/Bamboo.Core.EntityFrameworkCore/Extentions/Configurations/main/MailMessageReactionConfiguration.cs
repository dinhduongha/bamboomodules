    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailMessageReaction>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_message_reaction_pkey");
                        ...
                        // entity.HasOne(d => d.Partner).WithMany(p => p.MailMessageReaction) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("mail_message_reaction_partner_id_fkey");
