    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SurveyUserInput>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("survey_user_input_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SurveyUserInputCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("survey_user_input_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SurveyUserInputWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("survey_user_input_write_uid_fkey");
