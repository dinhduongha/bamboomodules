    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<FollowupPrint>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("followup_print_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.FollowupPrintCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("followup_print_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.FollowupPrintWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("followup_print_write_uid_fkey");
