    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpWorkorder>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_workorder_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpWorkorderCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_workorder_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpWorkorderWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_workorder_write_uid_fkey");
