    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CalendarAlarm>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("calendar_alarm_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CalendarAlarmCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("calendar_alarm_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CalendarAlarmWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("calendar_alarm_write_uid_fkey");
