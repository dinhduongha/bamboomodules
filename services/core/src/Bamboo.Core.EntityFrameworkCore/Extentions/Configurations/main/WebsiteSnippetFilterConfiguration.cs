    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<WebsiteSnippetFilter>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("website_snippet_filter_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.WebsiteSnippetFilterCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("website_snippet_filter_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Website).WithMany(p => p.WebsiteSnippetFilter) .HasForeignKey(d => d.WebsiteId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("website_snippet_filter_website_id_fkey");
                        entity.HasOne(d => d.Website).WithMany()
                            .HasForeignKey(d => d.WebsiteId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("website_snippet_filter_website_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.WebsiteSnippetFilterWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("website_snippet_filter_write_uid_fkey");
