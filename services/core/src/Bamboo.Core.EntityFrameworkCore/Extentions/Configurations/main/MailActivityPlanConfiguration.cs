    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailActivityPlan>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_activity_plan_pkey");
                        ...
                        entity.HasIndex(e => e.DepartmentId, "mail_activity_plan__department_id_index").HasFilter("(department_id IS NOT NULL)");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.MailActivityPlan) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_plan_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mail_activity_plan_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailActivityPlanCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_plan_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailActivityPlanWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_plan_write_uid_fkey");
