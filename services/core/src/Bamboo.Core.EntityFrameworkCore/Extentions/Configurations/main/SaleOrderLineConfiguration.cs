    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SaleOrderLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("sale_order_line_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.SaleOrderLine) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_line_company_id_fkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SaleOrderLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_line_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("sale_order_line_create_uid_fkey");

                        // entity.HasOne(d => d.Currency).WithMany(p => p.SaleOrderLine) .HasForeignKey(d => d.CurrencyId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_line_currency_id_fkey");
                        ...
                        // entity.HasOne(d => d.OrderPartner).WithMany(p => p.SaleOrderLine) .HasForeignKey(d => d.OrderPartnerId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_line_order_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.SaleOrderLine) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("sale_order_line_product_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SaleOrderLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_line_write_uid_fkey");
