    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosPackOperationLot>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("pos_pack_operation_lot_pkey");
                        ...
                        entity.HasIndex(e => e.PosOrderLineId, "pos_pack_operation_lot__pos_order_line_id_index").HasFilter("(pos_order_line_id IS NOT NULL)");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.PosPackOperationLotCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("pos_pack_operation_lot_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.PosPackOperationLotWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("pos_pack_operation_lot_write_uid_fkey");
