    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmIapLeadIndustry>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("crm_iap_lead_industry_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmIapLeadIndustryCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_iap_lead_industry_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("crm_iap_lead_industry_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmIapLeadIndustryWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_iap_lead_industry_write_uid_fkey");
