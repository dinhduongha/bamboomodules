    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockInventoryAdjustmentName>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_inventory_adjustment_name_pkey");
                        ...
                        entity.Property(e => e.CountingDate)
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockInventoryAdjustmentNameCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_inventory_adjustment_name_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("stock_inventory_adjustment_name_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockInventoryAdjustmentNameWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_inventory_adjustment_name_write_uid_fkey");
