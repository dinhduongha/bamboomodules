    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CalendarRecurrence>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("calendar_recurrence_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CalendarRecurrenceCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("calendar_recurrence_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CalendarRecurrenceWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("calendar_recurrence_write_uid_fkey");
