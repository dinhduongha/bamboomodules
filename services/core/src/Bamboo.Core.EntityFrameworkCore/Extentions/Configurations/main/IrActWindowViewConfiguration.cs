    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<IrActWindowView>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("ir_act_window_view_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.IrActWindowViewCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_act_window_view_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.IrActWindowViewWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("ir_act_window_view_write_uid_fkey");
