    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountReportLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_report_line_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountReportLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_report_line_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountReportLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_report_line_write_uid_fkey");
