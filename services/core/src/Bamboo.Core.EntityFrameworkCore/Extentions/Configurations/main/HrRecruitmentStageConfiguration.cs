    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrRecruitmentStage>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_recruitment_stage_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrRecruitmentStageCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_recruitment_stage_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrRecruitmentStageWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_recruitment_stage_write_uid_fkey");
