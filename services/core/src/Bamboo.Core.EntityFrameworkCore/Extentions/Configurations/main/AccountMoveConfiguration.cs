    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountMove>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_move_pkey");
                        ...
                        entity.HasIndex(e => e.TenantId, "account_move__company_id_index");
                        ...
                        // entity.HasOne(d => d.CommercialPartner).WithMany(p => p.AccountMoveCommercialPartner) .HasForeignKey(d => d.CommercialPartnerId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_move_commercial_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.AccountMove) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_move_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountMoveCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_move_create_uid_fkey");

                        // entity.HasOne(d => d.Currency).WithMany(p => p.AccountMove) .HasForeignKey(d => d.CurrencyId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_move_currency_id_fkey");
                        ...
                        // entity.HasOne(d => d.InvoiceUser).WithMany(p => p.AccountMoveInvoiceUser) .HasForeignKey(d => d.InvoiceUserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_invoice_user_id_fkey");
                        entity.HasOne(d => d.InvoiceUser).WithMany()
                            .HasForeignKey(d => d.InvoiceUserId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_move_invoice_user_id_fkey");

                        // entity.HasOne(d => d.Journal).WithMany(p => p.AccountMove) .HasForeignKey(d => d.JournalId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_move_journal_id_fkey");
                        ...
                        // entity.HasOne(d => d.MessageMainAttachment).WithMany(p => p.AccountMove) .HasForeignKey(d => d.MessageMainAttachmentId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_message_main_attachment_id_fkey");
                        ...
                        // entity.HasOne(d => d.Partner).WithMany(p => p.AccountMovePartner) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_move_partner_id_fkey");
                        entity.HasOne(d => d.Partner).WithMany()
                            .HasForeignKey(d => d.PartnerId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("account_move_partner_id_fkey");

                        // entity.HasOne(d => d.PartnerShipping).WithMany(p => p.AccountMovePartnerShipping) .HasForeignKey(d => d.PartnerShippingId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_partner_shipping_id_fkey");
                        ...
                        // entity.HasOne(d => d.Website).WithMany(p => p.AccountMove) .HasForeignKey(d => d.WebsiteId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_website_id_fkey");
                        entity.HasOne(d => d.Website).WithMany()
                            .HasForeignKey(d => d.WebsiteId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_move_website_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountMoveWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_move_write_uid_fkey");
