    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<GamificationBadge>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("gamification_badge_pkey");
                        ...
                        entity.HasIndex(e => e.IsPublished, "gamification_badge__is_published_index");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.GamificationBadgeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("gamification_badge_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.GamificationBadgeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("gamification_badge_write_uid_fkey");
