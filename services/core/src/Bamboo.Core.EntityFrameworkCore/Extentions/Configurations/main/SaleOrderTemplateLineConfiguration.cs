    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SaleOrderTemplateLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("sale_order_template_line_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.SaleOrderTemplateLine) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_line_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("sale_order_template_line_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SaleOrderTemplateLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_line_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("sale_order_template_line_create_uid_fkey");

                        // entity.HasOne(d => d.Product).WithMany(p => p.SaleOrderTemplateLine) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_line_product_id_fkey");
                        entity.HasOne(d => d.Product).WithMany()
                            .HasForeignKey(d => d.ProductId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("sale_order_template_line_product_id_fkey");

                        // entity.HasOne(d => d.ProductUom).WithMany(p => p.SaleOrderTemplateLine) .HasForeignKey(d => d.ProductUomId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_line_product_uom_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SaleOrderTemplateLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_line_write_uid_fkey");
