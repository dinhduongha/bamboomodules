    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<CrmTeam>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("crm_team_pkey");
                        ...
                        entity.HasIndex(e => e.TenantId, "crm_team__company_id_index");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.CrmTeam) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_team_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("crm_team_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.CrmTeamCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_team_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("crm_team_create_uid_fkey");

                        // entity.HasOne(d => d.User).WithMany(p => p.CrmTeamUser) .HasForeignKey(d => d.UserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_team_user_id_fkey");
                        entity.HasOne(d => d.User).WithMany()
                            .HasForeignKey(d => d.UserId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("crm_team_user_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.CrmTeamWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("crm_team_write_uid_fkey");
