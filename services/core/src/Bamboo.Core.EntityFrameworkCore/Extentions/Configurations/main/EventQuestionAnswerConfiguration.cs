    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventQuestionAnswer>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("event_question_answer_pkey");
                        ...
                        entity.HasIndex(e => e.QuestionId, "event_question_answer__question_id_index");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.EventQuestionAnswerCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_question_answer_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.EventQuestionAnswerWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_question_answer_write_uid_fkey");
