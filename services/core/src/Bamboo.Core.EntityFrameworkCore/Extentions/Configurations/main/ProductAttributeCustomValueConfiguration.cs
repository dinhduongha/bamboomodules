    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<ProductAttributeCustomValue>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("product_attribute_custom_value_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.ProductAttributeCustomValueCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_attribute_custom_value_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.ProductAttributeCustomValueWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("product_attribute_custom_value_write_uid_fkey");
