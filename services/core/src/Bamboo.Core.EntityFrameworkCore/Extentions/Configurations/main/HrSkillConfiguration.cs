    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrSkill>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_skill_pkey");
                        ...
                        entity.HasIndex(e => e.SkillTypeId, "hr_skill__skill_type_id_index");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrSkillCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_skill_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrSkillWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_skill_write_uid_fkey");
