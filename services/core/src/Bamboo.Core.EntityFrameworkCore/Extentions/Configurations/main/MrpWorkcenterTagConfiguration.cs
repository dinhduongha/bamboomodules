    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpWorkcenterTag>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_workcenter_tag_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpWorkcenterTagCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_workcenter_tag_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mrp_workcenter_tag_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpWorkcenterTagWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_workcenter_tag_write_uid_fkey");
