    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpBomByproduct>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_bom_byproduct_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.MrpBomByproduct) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_bom_byproduct_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("mrp_bom_byproduct_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpBomByproductCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_bom_byproduct_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.MrpBomByproduct) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("mrp_bom_byproduct_product_id_fkey");
                        entity.HasOne(d => d.Product).WithMany()
                            .HasForeignKey(d => d.ProductId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("mrp_bom_byproduct_product_id_fkey");

                        // entity.HasOne(d => d.ProductUom).WithMany(p => p.MrpBomByproduct) .HasForeignKey(d => d.ProductUomId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("mrp_bom_byproduct_product_uom_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpBomByproductWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_bom_byproduct_write_uid_fkey");
