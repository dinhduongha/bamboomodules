    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SlideSlideResource>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("slide_slide_resource_pkey");
                        ...
                        entity.HasIndex(e => e.SlideId, "slide_slide_resource__slide_id_index");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SlideSlideResourceCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("slide_slide_resource_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SlideSlideResourceWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("slide_slide_resource_write_uid_fkey");
