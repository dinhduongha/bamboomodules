    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<LoyaltyRule>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("loyalty_rule_pkey");
                        ...
                        entity.HasIndex(e => e.ProgramId, "loyalty_rule__program_id_index");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.LoyaltyRule) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("loyalty_rule_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("loyalty_rule_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.LoyaltyRuleCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("loyalty_rule_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Website).WithMany(p => p.LoyaltyRule) .HasForeignKey(d => d.WebsiteId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("loyalty_rule_website_id_fkey");
                        entity.HasOne(d => d.Website).WithMany()
                            .HasForeignKey(d => d.WebsiteId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("loyalty_rule_website_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.LoyaltyRuleWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("loyalty_rule_write_uid_fkey");
