    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountAnalyticApplicability>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_analytic_applicability_pkey");
                        ...
                        entity.HasIndex(e => e.AnalyticPlanId, "account_analytic_applicability__analytic_plan_id_index").HasFilter("(analytic_plan_id IS NOT NULL)");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.AccountAnalyticApplicability) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_analytic_applicability_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_analytic_applicability_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountAnalyticApplicabilityCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_analytic_applicability_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_analytic_applicability_create_uid_fkey");

                        // entity.HasOne(d => d.ProductCateg).WithMany(p => p.AccountAnalyticApplicability) .HasForeignKey(d => d.ProductCategId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_analytic_applicability_product_categ_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountAnalyticApplicabilityWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_analytic_applicability_write_uid_fkey");
