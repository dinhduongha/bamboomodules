    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseLanguageExport>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("base_language_export_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseLanguageExportCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_language_export_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("base_language_export_create_uid_fkey");

                        entity.HasOne(d => d.Model).WithMany(p => p.BaseLanguageExport)
                            .HasForeignKey(d => d.ModelId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("base_language_export_model_id_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseLanguageExportWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_language_export_write_uid_fkey");
                        entity.HasOne(d => d.WriteU).WithMany()
                            .HasForeignKey(d => d.LastModifierId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("base_language_export_write_uid_fkey");

                        // entity.HasMany(d => d.Module).WithMany(p => p.Wiz)
                        entity.HasMany(d => d.Module).WithMany(p => p.Wiz)
