    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<EventBoothRegistration>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("event_booth_registration_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.EventBoothRegistrationCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_booth_registration_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Partner).WithMany(p => p.EventBoothRegistration) .HasForeignKey(d => d.PartnerId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_booth_registration_partner_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.EventBoothRegistrationWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("event_booth_registration_write_uid_fkey");
