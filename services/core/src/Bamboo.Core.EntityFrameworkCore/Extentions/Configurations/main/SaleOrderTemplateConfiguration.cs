    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<SaleOrderTemplate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("sale_order_template_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.SaleOrderTemplateNavigation) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("sale_order_template_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.SaleOrderTemplateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.SaleOrderTemplateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("sale_order_template_write_uid_fkey");
