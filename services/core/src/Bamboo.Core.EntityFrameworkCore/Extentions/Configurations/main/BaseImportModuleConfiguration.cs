    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<BaseImportModule>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("base_import_module_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.BaseImportModuleCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_import_module_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("base_import_module_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.BaseImportModuleWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("base_import_module_write_uid_fkey");
