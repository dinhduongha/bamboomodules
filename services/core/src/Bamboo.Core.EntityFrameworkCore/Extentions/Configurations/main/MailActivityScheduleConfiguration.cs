    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailActivitySchedule>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mail_activity_schedule_pkey");
                        ...
                        // entity.HasOne(d => d.ActivityUser).WithMany(p => p.MailActivityScheduleActivityUser) .HasForeignKey(d => d.ActivityUserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_schedule_activity_user_id_fkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailActivityScheduleCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_schedule_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.PlanOnDemandUser).WithMany(p => p.MailActivitySchedulePlanOnDemandUser) .HasForeignKey(d => d.PlanOnDemandUserId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_schedule_plan_on_demand_user_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailActivityScheduleWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mail_activity_schedule_write_uid_fkey");
