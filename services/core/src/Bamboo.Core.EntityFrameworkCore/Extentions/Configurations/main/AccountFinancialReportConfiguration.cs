    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountFinancialReport>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_financial_report_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountFinancialReportCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_financial_report_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountFinancialReportWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_financial_report_write_uid_fkey");
