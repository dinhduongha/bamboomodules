    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<PosDetailsWizard>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("pos_details_wizard_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.PosDetailsWizardCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("pos_details_wizard_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("pos_details_wizard_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.PosDetailsWizardWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("pos_details_wizard_write_uid_fkey");
