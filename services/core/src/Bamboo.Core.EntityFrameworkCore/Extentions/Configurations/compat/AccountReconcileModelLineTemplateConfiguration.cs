    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountReconcileModelLineTemplate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_reconcile_model_line_template_pkey");
                        ...
                        // entity.HasOne(d => d.Account).WithMany(p => p.AccountReconcileModelLineTemplate) .HasForeignKey(d => d.AccountId) .OnDelete(DeleteBehavior.Cascade) .HasConstraintName("account_reconcile_model_line_template_account_id_fkey");
                        entity.HasOne(d => d.Account).WithMany()
                            .HasForeignKey(d => d.AccountId)
                            .OnDelete(DeleteBehavior.Cascade)
                            .HasConstraintName("account_reconcile_model_line_template_account_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountReconcileModelLineTemplateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_reconcile_model_line_template_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountReconcileModelLineTemplateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_reconcile_model_line_template_write_uid_fkey");
