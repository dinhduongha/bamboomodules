    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountChartTemplate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_chart_template_pkey");
                        ...
                        entity.HasOne(d => d.AccountJournalEarlyPayDiscountGainAccount).WithMany(p => p.AccountChartTemplateAccountJournalEarlyPayDiscountGainAccount)
                        ...
                        entity.HasOne(d => d.AccountJournalEarlyPayDiscountLossAccount).WithMany(p => p.AccountChartTemplateAccountJournalEarlyPayDiscountLossAccount)
                        ...
                        entity.HasOne(d => d.AccountJournalPaymentCreditAccount).WithMany(p => p.AccountChartTemplateAccountJournalPaymentCreditAccount)
                        ...
                        entity.HasOne(d => d.AccountJournalPaymentDebitAccount).WithMany(p => p.AccountChartTemplateAccountJournalPaymentDebitAccount)
                        ...
                        entity.HasOne(d => d.AccountJournalSuspenseAccount).WithMany(p => p.AccountChartTemplateAccountJournalSuspenseAccount)
                        ...
                        // entity.HasOne(d => d.Country).WithMany(p => p.AccountChartTemplate) .HasForeignKey(d => d.CountryId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_chart_template_country_id_fkey");
                        entity.HasOne(d => d.Country).WithMany()
                            .HasForeignKey(d => d.CountryId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_chart_template_country_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountChartTemplateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_chart_template_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_chart_template_create_uid_fkey");

                        // entity.HasOne(d => d.Currency).WithMany(p => p.AccountChartTemplate) .HasForeignKey(d => d.CurrencyId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("account_chart_template_currency_id_fkey");
                        entity.HasOne(d => d.Currency).WithMany()
                            .HasForeignKey(d => d.CurrencyId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("account_chart_template_currency_id_fkey");

                        entity.HasOne(d => d.DefaultCashDifferenceExpenseAccount).WithMany(p => p.AccountChartTemplateDefaultCashDifferenceExpenseAccount)
                        ...
                        entity.HasOne(d => d.DefaultCashDifferenceIncomeAccount).WithMany(p => p.AccountChartTemplateDefaultCashDifferenceIncomeAccount)
                        ...
                        entity.HasOne(d => d.DefaultPosReceivableAccount).WithMany(p => p.AccountChartTemplateDefaultPosReceivableAccount)
                        ...
                        entity.HasOne(d => d.ExpenseCurrencyExchangeAccount).WithMany(p => p.AccountChartTemplateExpenseCurrencyExchangeAccount)
                        ...
                        entity.HasOne(d => d.IncomeCurrencyExchangeAccount).WithMany(p => p.AccountChartTemplateIncomeCurrencyExchangeAccount)
                        ...
                        entity.HasOne(d => d.PropertyAccountExpenseCateg).WithMany(p => p.AccountChartTemplatePropertyAccountExpenseCateg)
                        ...
                        entity.HasOne(d => d.PropertyAccountExpense).WithMany(p => p.AccountChartTemplatePropertyAccountExpense)
                            .HasForeignKey(d => d.PropertyAccountExpenseId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_chart_template_property_account_expense_id_fkey");

                        entity.HasOne(d => d.PropertyAccountIncomeCateg).WithMany(p => p.AccountChartTemplatePropertyAccountIncomeCateg)
                        ...
                        entity.HasOne(d => d.PropertyAccountIncome).WithMany(p => p.AccountChartTemplatePropertyAccountIncome)
                            .HasForeignKey(d => d.PropertyAccountIncomeId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_chart_template_property_account_income_id_fkey");

                        entity.HasOne(d => d.PropertyAccountPayable).WithMany(p => p.AccountChartTemplatePropertyAccountPayable)
                            .HasForeignKey(d => d.PropertyAccountPayableId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_chart_template_property_account_payable_id_fkey");

                        entity.HasOne(d => d.PropertyAccountReceivable).WithMany(p => p.AccountChartTemplatePropertyAccountReceivable)
                        ...
                        entity.HasOne(d => d.PropertyAdvanceTaxPaymentAccount).WithMany(p => p.AccountChartTemplatePropertyAdvanceTaxPaymentAccount)
                        ...
                        entity.HasOne(d => d.PropertyCashBasisBaseAccount).WithMany(p => p.AccountChartTemplatePropertyCashBasisBaseAccount)
                        ...
                        entity.HasOne(d => d.PropertyStockAccountInputCateg).WithMany(p => p.AccountChartTemplatePropertyStockAccountInputCateg)
                        ...
                        entity.HasOne(d => d.PropertyStockAccountOutputCateg).WithMany(p => p.AccountChartTemplatePropertyStockAccountOutputCateg)
                        ...
                        entity.HasOne(d => d.PropertyStockValuationAccount).WithMany(p => p.AccountChartTemplatePropertyStockValuationAccount)
                        ...
                        entity.HasOne(d => d.PropertyTaxPayableAccount).WithMany(p => p.AccountChartTemplatePropertyTaxPayableAccount)
                        ...
                        entity.HasOne(d => d.PropertyTaxReceivableAccount).WithMany(p => p.AccountChartTemplatePropertyTaxReceivableAccount)
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountChartTemplateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_chart_template_write_uid_fkey");
