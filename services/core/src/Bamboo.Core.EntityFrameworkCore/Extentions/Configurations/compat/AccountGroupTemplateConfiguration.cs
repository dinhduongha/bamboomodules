    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountGroupTemplate>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_group_template_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountGroupTemplateCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_group_template_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountGroupTemplateWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_group_template_write_uid_fkey");
