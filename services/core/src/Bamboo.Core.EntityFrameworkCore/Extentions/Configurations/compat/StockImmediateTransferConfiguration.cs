    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<StockImmediateTransfer>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("stock_immediate_transfer_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.StockImmediateTransferCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_immediate_transfer_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("stock_immediate_transfer_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.StockImmediateTransferWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("stock_immediate_transfer_write_uid_fkey");
