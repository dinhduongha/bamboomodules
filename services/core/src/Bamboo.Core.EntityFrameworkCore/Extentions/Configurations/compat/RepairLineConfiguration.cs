    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<RepairLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("repair_line_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.RepairLine) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("repair_line_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("repair_line_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.RepairLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("repair_line_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.RepairLine) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("repair_line_product_id_fkey");
                        entity.HasOne(d => d.Product).WithMany()
                            .HasForeignKey(d => d.ProductId)
                            .OnDelete(DeleteBehavior.Restrict)
                            .HasConstraintName("repair_line_product_id_fkey");

                        // entity.HasOne(d => d.ProductUomNavigation).WithMany(p => p.RepairLine) .HasForeignKey(d => d.ProductUom) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("repair_line_product_uom_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.RepairLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("repair_line_write_uid_fkey");
