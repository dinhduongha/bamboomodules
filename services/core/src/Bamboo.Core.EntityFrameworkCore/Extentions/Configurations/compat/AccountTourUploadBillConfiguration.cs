    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountTourUploadBill>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_tour_upload_bill_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountTourUploadBillCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_tour_upload_bill_create_uid_fkey");
                        entity.HasOne(d => d.CreateU).WithMany()
                            .HasForeignKey(d => d.CreatorId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("account_tour_upload_bill_create_uid_fkey");

                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountTourUploadBillWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_tour_upload_bill_write_uid_fkey");
