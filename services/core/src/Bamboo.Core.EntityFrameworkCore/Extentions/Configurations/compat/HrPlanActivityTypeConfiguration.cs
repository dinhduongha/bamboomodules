    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<HrPlanActivityType>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("hr_plan_activity_type_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.HrPlanActivityType) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_plan_activity_type_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("hr_plan_activity_type_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.HrPlanActivityTypeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_plan_activity_type_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.ResponsibleNavigation).WithMany(p => p.HrPlanActivityTypeResponsibleNavigation) .HasForeignKey(d => d.ResponsibleId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_plan_activity_type_responsible_id_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.HrPlanActivityTypeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("hr_plan_activity_type_write_uid_fkey");
