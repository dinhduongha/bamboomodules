    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<AccountInvoiceSend>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("account_invoice_send_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.AccountInvoiceSendCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_invoice_send_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.AccountInvoiceSendWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("account_invoice_send_write_uid_fkey");
