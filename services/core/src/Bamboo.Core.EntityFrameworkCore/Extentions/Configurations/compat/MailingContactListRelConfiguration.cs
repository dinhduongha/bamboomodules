    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MailingContactListRel>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mailing_contact_list_rel_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MailingContactListRelCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_contact_list_rel_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MailingContactListRelWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mailing_contact_list_rel_write_uid_fkey");
