    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<RepairFee>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("repair_fee_pkey");
                        ...
                        // entity.HasOne(d => d.Company).WithMany(p => p.RepairFee) .HasForeignKey(d => d.TenantId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("repair_fee_company_id_fkey");
                        entity.HasOne(d => d.Company).WithMany()
                            .HasForeignKey(d => d.TenantId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("repair_fee_company_id_fkey");

                        // entity.HasOne(d => d.CreateU).WithMany(p => p.RepairFeeCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("repair_fee_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.Product).WithMany(p => p.RepairFee) .HasForeignKey(d => d.ProductId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("repair_fee_product_id_fkey");
                        entity.HasOne(d => d.Product).WithMany()
                            .HasForeignKey(d => d.ProductId)
                            .OnDelete(DeleteBehavior.SetNull)
                            .HasConstraintName("repair_fee_product_id_fkey");

                        // entity.HasOne(d => d.ProductUomNavigation).WithMany(p => p.RepairFee) .HasForeignKey(d => d.ProductUom) .OnDelete(DeleteBehavior.Restrict) .HasConstraintName("repair_fee_product_uom_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.RepairFeeWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("repair_fee_write_uid_fkey");
