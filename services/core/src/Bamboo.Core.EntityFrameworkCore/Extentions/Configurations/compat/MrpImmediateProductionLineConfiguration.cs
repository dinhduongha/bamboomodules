    ...
    public static partial class ModelBuilderExtensions
    {
        ...
        modelBuilder.Entity<MrpImmediateProductionLine>(entity =>
            ...
            entity.HasKey(e => e.Id).HasName("mrp_immediate_production_line_pkey");
                        ...
                        // entity.HasOne(d => d.CreateU).WithMany(p => p.MrpImmediateProductionLineCreateU) .HasForeignKey(d => d.CreatorId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_immediate_production_line_create_uid_fkey");
                        ...
                        // entity.HasOne(d => d.WriteU).WithMany(p => p.MrpImmediateProductionLineWriteU) .HasForeignKey(d => d.LastModifierId) .OnDelete(DeleteBehavior.SetNull) .HasConstraintName("mrp_immediate_production_line_write_uid_fkey");
