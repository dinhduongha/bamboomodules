...
namespace Bamboo.Admin.Migrations
{
    ...
    [Migration("20241122093406_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bamboo.Admin.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUserClaim", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("IdentityUserClaim");
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUserOrganizationUnit", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("IdentityUserOrganizationUnit");
            ...
            modelBuilder.Entity("Volo.Abp.Identity.OrganizationUnitRole", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("OrganizationUnitRole");
            ...
            modelBuilder.Entity("Bamboo.Admin.BranchUser", b =>
                {
            ...
            modelBuilder.Entity("Bamboo.Admin.BranchUserClaim", b =>
                {
                    b.HasBaseType("Volo.Abp.Identity.IdentityUserClaim");
                    ...
                    b.HasDiscriminator().HasValue("BranchUserClaim");
                });
            ...
            modelBuilder.Entity("Bamboo.Admin.BranchUserOrganizationUnit", b =>
                {
                    b.HasBaseType("Volo.Abp.Identity.IdentityUserOrganizationUnit");
                    ...
                    b.HasDiscriminator().HasValue("BranchUserOrganizationUnit");
                });

            modelBuilder.Entity("Bamboo.Admin.BranchOrganizationUnit", b =>
                {
                    b.HasBaseType("Volo.Abp.Identity.OrganizationUnit");
                    ...
                    b.HasDiscriminator().HasValue("BranchOrganizationUnit");
                });

            modelBuilder.Entity("Bamboo.Admin.BranchOrganizationUnitRole", b =>
                {
                    b.HasBaseType("Volo.Abp.Identity.OrganizationUnitRole");
                    ...
                    b.HasDiscriminator().HasValue("BranchOrganizationUnitRole");
                });
            ...
            modelBuilder.Entity("Bamboo.Admin.BranchOrganizationUnitRole", b =>
                {
                    b.HasOne("Bamboo.Admin.Branch", null)
                        .WithMany("Roles")
