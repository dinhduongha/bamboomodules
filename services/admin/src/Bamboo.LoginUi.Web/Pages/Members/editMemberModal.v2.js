$(function () {
  ...
  var $modal = $("[data-modal-name='editMemberModal']");
  if ($modal.length > 0) {
    console.log("Modal editMemberModal found");
    ...
    $tenantSelect.on("change", function () {
      ...
      console.log("Modal editMemberModal tenantSelect changed");
    ...
    $("#editMemberForm").on("submit", function () {
