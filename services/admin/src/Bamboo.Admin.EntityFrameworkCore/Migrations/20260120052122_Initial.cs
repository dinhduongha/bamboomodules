        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignedIn = table.Column<DateTime>(type: "timestamptz", nullable: false),
                    LastAccessed = table.Column<DateTime>(type: "timestamptz", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxChild = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    OwnerId = table.Column<Guid>(type: "uuid", nullable: true),
                    ParentId = table.Column<Guid>(type: "uuid", nullable: true),
                    ParentPath = table.Column<string>(type: "text", nullable: true),
                    VipLevel = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamptz", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchId = table.Column<Guid>(type: "uuid", nullable: true),
                    Discriminator = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: false),
                    MaxTenant = table.Column<long>(type: "bigint", nullable: false, defaultValue: 1L),
                    Vip = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamptz", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
