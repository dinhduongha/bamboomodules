...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bamboo.Admin.TenantMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("LeavedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Bamboo.Admin.TenantMemberOrganizationUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("uuidv7()");
                    ...
                    b.HasIndex("TenantMemberId", "OrganizationUnitId")
                        .IsUnique();

                    b.ToTable("tenant_member_organization_units");
                });

            modelBuilder.Entity("Bamboo.Admin.TenantMemberRole", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("uuidv7()");
            ...
            modelBuilder.Entity("Bamboo.Admin.TenantRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("uuidv7()");
                    ...
                    b.Property<DateTimeOffset?>("DisableAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DunCode")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Bamboo.Admin.UserBranch", b =>
                {
                    b.HasBaseType("Volo.Abp.Identity.IdentityUser");

                    b.ToTable("AbpUsers");

                    b.HasDiscriminator().HasValue("UserBranch");
                });
            ...
            modelBuilder.Entity("Bamboo.Admin.TenantMemberOrganizationUnit", b =>
                {
                    ...
                    b.HasOne("Bamboo.Admin.TenantMember", null)
