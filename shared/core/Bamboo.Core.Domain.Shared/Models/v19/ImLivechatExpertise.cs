...
[Table("im_livechat_expertise")]
//[Index("Name", Name = "im_livechat_expertise_name_unique", IsUnique = true)]
public partial class ImLivechatExpertise : FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
    ...
    // [ForeignKey("ImLivechatExpertiseId")] //Many2many // Hidden
    // [InverseProperty("ImLivechatExpertise")] //Many2many // Hidden
