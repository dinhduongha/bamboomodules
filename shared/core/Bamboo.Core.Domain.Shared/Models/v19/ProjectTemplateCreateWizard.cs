...
[Table("project_template_create_wizard")]
public partial class ProjectTemplateCreateWizard : FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
    ...
    public virtual ProjectProject? Template { get; set; }
