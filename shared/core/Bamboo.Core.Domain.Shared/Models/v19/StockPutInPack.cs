...
public partial class StockPutInPack : FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
    ...
    // [ForeignKey("StockPutInPackId")] // Many2many // Normal
    // [InverseProperty("StockPutInPack")] // Many2many // Normal
