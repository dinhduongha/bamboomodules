...
public partial class StockImmediateTransferLine: FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    ...
    // [InverseProperty("StockImmediateTransferLineCreateU")] //Many2one
    public virtual ResUsers? CreateU { get; set; }

    // [Many2one]
    [ForeignKey("ImmediateTransferId")]
    // [InverseProperty("StockImmediateTransferLine")] //Many2one
    ...
    // [InverseProperty("StockImmediateTransferLineWriteU")] //Many2one
