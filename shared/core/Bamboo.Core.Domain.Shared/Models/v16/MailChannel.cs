...
public partial class MailChannel: FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    ...
    // [InverseProperty("MailChannelCreateU")] //Many2one
    ...
    // [InverseProperty("MailChannelWriteU")] //Many2one
    public virtual ResUsers? WriteU { get; set; }

    // [Many2many] // Normal
    // [NotMapped] //Many2many // Normal
    // [ForeignKey("MailChannelId")] //Many2many
    // [InverseProperty("MailChannel")] //Many2many
    public virtual ICollection<HrDepartment> HrDepartment { get; set; }

    // [Many2many] // Normal
    // [NotMapped] //Many2many // Normal
    // [ForeignKey("MailChannelId")] //Many2many
    // [InverseProperty("MailChannelNavigation")] //Many2many
