...
public partial class MrpImmediateProductionLine: FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    ...
    // [InverseProperty("MrpImmediateProductionLineCreateU")] //Many2one
    public virtual ResUsers? CreateU { get; set; }

    // [Many2one]
    [ForeignKey("ImmediateProductionId")]
    // [InverseProperty("MrpImmediateProductionLine")] //Many2one
    ...
    // [InverseProperty("MrpImmediateProductionLineWriteU")] //Many2one
