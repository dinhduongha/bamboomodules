...
[Table("restaurant_printer")]
public partial class RestaurantPrinter: FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
    ...
    // [InverseProperty("RestaurantPrinterCreateU")] //Many2one
    public virtual ResUsers? CreateU { get; set; }

    // [Many2one]
    [ForeignKey("LastModifierId")]
    // [InverseProperty("RestaurantPrinterWriteU")] //Many2one
