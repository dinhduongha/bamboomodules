...
public partial class MailFollower: FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
    ...
    //[InverseProperty("MailFollowers")]
    [NotMapped]
    public virtual ICollection<MailMessageSubtype> MailMessageSubtypes { get; set; } 
}
