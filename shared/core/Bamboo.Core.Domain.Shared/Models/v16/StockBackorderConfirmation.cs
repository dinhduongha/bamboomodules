...
public partial class StockBackorderConfirmation: FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    ...
    // [InverseProperty("StockBackorderConfirmationCreateU")] //Many2one
    ...
    // [InverseProperty("StockBackorderConfirmationWriteU")] //Many2one
    public virtual ResUsers? WriteU { get; set; }

    // [Many2many] // Normal
    // [NotMapped] //Many2many // Normal
    // [ForeignKey("StockBackorderConfirmationId")] //Many2many
    // [InverseProperty("StockBackorderConfirmation")] //Many2many
