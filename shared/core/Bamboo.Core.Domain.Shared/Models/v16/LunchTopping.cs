...
[Table("lunch_topping")]
public partial class LunchTopping: FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
    ...
    [NotMapped]
    public virtual ICollection<LunchOrder> Orders { get; set; } 
}
