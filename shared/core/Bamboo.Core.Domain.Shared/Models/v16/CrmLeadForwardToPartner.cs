...
[Table("crm_lead_forward_to_partner")]
public partial class CrmLeadForwardToPartner: FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
