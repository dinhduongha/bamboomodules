...
[Table("res_partner_tag")]
//[Index("IsPublished", Name = "res_partner_tag__is_published_index")]
public partial class ResPartnerTag: FullAuditedEntity<Guid>, IEntityDto<Guid>, IAuditedObject
{
    [Key]
    [Column("id")]
