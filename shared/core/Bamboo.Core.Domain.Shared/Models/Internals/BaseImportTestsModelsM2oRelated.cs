...
public partial class BaseImportTestsModelsM2oRelated: FullAuditedEntity<Guid>, IEntityDto<Guid>
{
    [Key]
    [Column("id")]
    ...
    [NotMapped]
    public virtual ICollection<BaseImportTestsModelsM2o> BaseImportTestsModelsM2os { get; } 
