...
// 12. DmsTargetAssignment
[Table("dms_target_assignment")]
public partial class DmsTargetAssignment : FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
