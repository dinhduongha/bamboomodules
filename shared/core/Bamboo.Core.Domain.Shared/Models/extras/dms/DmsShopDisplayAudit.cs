...
// 5. DmsShopDisplayAudit
[Table("dms_shop_display_audit")]
public partial class DmsShopDisplayAudit : FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
