...
[Table("dms_outlet_inventory_check")]
public partial class DmsOutletInventoryCheck : FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    [Key]
    [Column("id")]
