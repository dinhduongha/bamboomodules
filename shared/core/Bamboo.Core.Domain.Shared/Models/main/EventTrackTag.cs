...
public partial class EventTrackTag: FullAuditedEntity<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    ...
    public virtual EventTrackTagCategory? Category { get; set; }
    ...
    // [ForeignKey("EventTrackTagId")] //Many2many // Hidden
    // [InverseProperty("EventTrackTag")] //Many2many // Hidden
    ...
    [NotMapped] //Many2many // Hidden
    // [ForeignKey("EventTrackTagId")] //Many2many // Hidden
    // [InverseProperty("EventTrackTagNavigation")] //Many2many // Hidden
