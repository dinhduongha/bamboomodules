...
public partial class StockImmediateTransfer: FullAuditedAggregateRoot<Guid>, IEntityDto<Guid>, IMultiTenant, IAuditedObject
{
    ...
    // [One2many]
    // [One2many] [ForeignKey("ImmediateTransferId")]
    // [NotMapped] // One2many // Normal
    // [InverseProperty("ImmediateTransfer")] // One2many
    ...
    // [ForeignKey("StockImmediateTransferId")] // Many2many // Normal
    // [InverseProperty("StockImmediateTransfer")] // Many2many // Normal
