...
namespace Bamboo.Core.Application.Contracts.Interfaces.Mixins
{
    public interface IMicrosoftOutlookMixinAppService : IMixinAppService
    {
        ...
        Task<TEntity> CheckForcedMailServerInternalAsync<TEntity>(IEnumerable<TEntity> entities, object mail_server, object allow_archived, object smtp_from) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        ...
        Task<TEntity> ConnectInternalAsync<TEntity>(IEnumerable<TEntity> entities, object allow_archived) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        ...
        Task<TEntity> FetchMailAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        Task<TEntity> FetchMailInternalAsync<TEntity>(IEnumerable<TEntity> entities, object batch_limit) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        ...
        Task<TEntity> FetchOutlookAccessTokenIapInternalAsync<TEntity>(IEnumerable<TEntity> entities, object refresh_token) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        ...
        Task<TEntity> FilterMailServersFallbackInternalAsync<TEntity>(IEnumerable<TEntity> entities, object servers) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        Task<TEntity> FindMailServerAllowedDomainInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        ...
        Task<TEntity> GetPersonalMailServersLimitInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        ...
        Task<TEntity> ParseFromFilterInternalAsync<TEntity>(IEnumerable<TEntity> entities, object from_filter) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        ...
        Task<TEntity> PrepareSmtpToListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object message, object smtp_session) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
        Task<TEntity> RaiseIapErrorInternalAsync<TEntity>(IEnumerable<TEntity> entities, object error) where TEntity : IEntity<Guid>, IMicrosoftOutlookMixinable;
