...
namespace Bamboo.Core.Application.Contracts.Interfaces.Mixins
{
    ...
    {
        Task<TEntity> CompanyXmlidAsync<TEntity>(IEnumerable<TEntity> entities, object xmlid, object company) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        Task<TEntity> CreateOutstandingAccountsInternalAsync<TEntity>(IEnumerable<TEntity> entities, object company, object bank_prefix, object code_digits) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        ...
        Task<TEntity> GetBankFeesRecoAccountInternalAsync<TEntity>(IEnumerable<TEntity> entities, object company) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        ...
        Task<TEntity> GetChartTemplateModelDataInternalAsync<TEntity>(IEnumerable<TEntity> entities, object template_code, object model) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        ...
        Task<TEntity> GetGenericCoaAccountAccountInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        ...
        Task<TEntity> GetStockAccountAccountInternalAsync<TEntity>(IEnumerable<TEntity> entities, object template_code) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        ...
        Task<TEntity> GetStockAccountResCompanyInternalAsync<TEntity>(IEnumerable<TEntity> entities, object template_code) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        ...
        Task<TEntity> LoadDataInternalAsync<TEntity>(IEnumerable<TEntity> entities, object data) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
        ...
        Task<TEntity> PostModelSetupInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IAccountChartTemplateable;
