...
{
    public interface IGenericAppService<TEntity> : ICrudAppService<TEntity, Guid>, IApplicationService
        where TEntity : class, IEntity<Guid>
    {
        ...
        Task<object> WebSearchReadAsync(WebSearchReadRequestDto input);
        Task<object> WebReadAsync(WebReadRequestDto input);
        Task<object> WebReadGroupAsync(WebReadGroupRequestDto input);
        Task<object> WebSaveAsync(WebSaveRequestDto input);
