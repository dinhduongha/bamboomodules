...
namespace Bamboo.Core.Application.Contracts.Interfaces
{
    public interface IIrModuleModuleAppService : IGenericApplicationService<IrModuleModule>
    {
        ...
        Task<IrModuleModule> CheckExternalDependenciesAsync(Guid id, object module_name, object newstate);
        Task<IrModuleModule> DownstreamDependenciesAsync(Guid id, object known_deps, object exclude_states);
        Task<IrModuleModule> GetModuleInfoAsync(Guid id, object name);
        ...
        Task<IrModuleModule> SearchPanelSelectRangeAsync(Guid id, object field_name);
        Task<IrModuleModule> UpdateListAsync(Guid id);
        Task<IrModuleModule> UpdateThemeImagesAsync(Guid id);
        Task<IrModuleModule> UpstreamDependenciesAsync(Guid id, object known_deps, object exclude_states);
        Task<IrModuleModule> WebReadAsync(Guid id, object specification);
        Task<IrModuleModule> WebSearchReadAsync(Guid id, object domain, object specification, object offset, object limit, object order, object count_limit);
    }
}