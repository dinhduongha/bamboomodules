...
namespace Bamboo.Core.Application.Contracts.Interfaces.Mixins
{
    public interface IAccountMoveSendAppService : IMixinAppService
    {
        ...
        Task<TEntity> GenerateSinvoiceFileDateInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object invoice_data) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        ...
        Task<TEntity> GetL10nKeEdiTremolWarningMessageInternalAsync<TEntity>(IEnumerable<TEntity> entities, object warning_moves) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> GetL10nKeEdiTremolWarningMovesInternalAsync<TEntity>(IEnumerable<TEntity> entities, object moves) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        ...
        Task<TEntity> IsGrEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsHuEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsItEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsMyEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsRoEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsRsEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsSaEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsTbaiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsTrNilveraApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> IsVnEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> L10nHuEdiCronUpdateStatusInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> L10nJoIsEdiApplicableInternalAsync<TEntity>(IEnumerable<TEntity> entities, object move) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        Task<TEntity> L10nMyEdiGenerateMyinvoisXmlInternalAsync<TEntity>(IEnumerable<TEntity> entities, object invoice, object invoice_data) where TEntity : IEntity<Guid>, IAccountMoveSendable;
        ...
        Task<TEntity> WhatIsPeppolActivateAsync<TEntity>(IEnumerable<TEntity> entities, object moves) where TEntity : IEntity<Guid>, IAccountMoveSendable;
    }
}