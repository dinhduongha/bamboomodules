...
namespace Bamboo.Core.Application.Contracts.Interfaces.Mixins
{
    public interface IGoogleGmailMixinAppService : IMixinAppService
    {
        ...
        Task<TEntity> AlterMessageInternalAsync<TEntity>(IEnumerable<TEntity> entities, object message, object smtp_from, object smtp_to_list) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        ...
        Task<TEntity> CheckForcedMailServerInternalAsync<TEntity>(IEnumerable<TEntity> entities, object mail_server, object allow_archived, object smtp_from) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        ...
        Task<TEntity> FetchMailAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        Task<TEntity> FetchMailInternalAsync<TEntity>(IEnumerable<TEntity> entities, object batch_limit) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        ...
        Task<TEntity> FilterMailServersFallbackInternalAsync<TEntity>(IEnumerable<TEntity> entities, object servers) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        Task<TEntity> FindMailServerAllowedDomainInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        ...
        Task<TEntity> GetPersonalMailServersLimitInternalAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        ...
        Task<TEntity> ParseFromFilterInternalAsync<TEntity>(IEnumerable<TEntity> entities, object from_filter) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        ...
        Task<TEntity> PrepareSmtpToListInternalAsync<TEntity>(IEnumerable<TEntity> entities, object message, object smtp_session) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
        Task<TEntity> RaiseIapErrorInternalAsync<TEntity>(IEnumerable<TEntity> entities, object error) where TEntity : IEntity<Guid>, IGoogleGmailMixinable;
