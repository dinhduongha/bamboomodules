...
namespace Bamboo.Core.Application.Contracts.Interfaces.Mixins
{
    public interface ITemplateResetMixinAppService : IMixinAppService
    {
        ...
        Task<TEntity> CreateSidebarActionAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, ITemplateResetMixinable;
        ...
        Task<TEntity> UnlinkSidebarActionAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : IEntity<Guid>, ITemplateResetMixinable;
