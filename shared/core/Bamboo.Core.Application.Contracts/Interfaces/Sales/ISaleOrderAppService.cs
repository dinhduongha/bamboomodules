...
namespace Bamboo.Core.Application.Contracts.Interfaces
{
    public interface ISaleOrderAppService : IGenericApplicationService<SaleOrder>
    {
        ...
        Task<SaleOrder> GetFirstServiceLineAsync(Guid id);
        Task<SaleOrder> GetImportTemplatesAsync(Guid id);
        ...
        Task<SaleOrder> LoadSaleOrderFromPosAsync(Guid id, SaleOrderLoadSaleOrderFromPosRequestDto input);
        ...
        Task<SaleOrder> ViewGiftCardsAsync(Guid id);
