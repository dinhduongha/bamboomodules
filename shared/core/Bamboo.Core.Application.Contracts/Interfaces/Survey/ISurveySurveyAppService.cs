...
namespace Bamboo.Core.Application.Contracts.Interfaces
{
    public interface ISurveySurveyAppService : IGenericApplicationService<SurveySurvey>
    {
        ...
        Task<SurveySurvey> CopyDataAsync(Guid id, object @default);
        Task<SurveySurvey> EndSessionAsync(Guid id);
        Task<SurveySurvey> GetFormviewIdAsync(Guid id, object access_uid);
        ...
        Task<SurveySurvey> PrintSurveyAsync(Guid id, object answer);
        ...
        Task<SurveySurvey> StartSurveyAsync(Guid id, object answer);
