...
{
    public static class BaseModelBuilderExtension_ReportPaperFormat
    {
        public static ModelBuilder ConfigureReportPaperFormatEntity(this ModelBuilder modelBuilder)
        {
