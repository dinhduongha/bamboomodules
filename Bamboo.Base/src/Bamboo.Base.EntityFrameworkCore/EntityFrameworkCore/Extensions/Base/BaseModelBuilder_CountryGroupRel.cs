...
{
    public static class BaseModelBuilderExtension_CountryGroupRel
    {
        public static ModelBuilder ConfigureCountryGroupRelEntity(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CountryGroupRel>(entity =>
            {
