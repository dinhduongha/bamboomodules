...
python3 scripts/tools/refactor_fluent.py data/CoreDbContext/CoreDbContext-Odoo16-Uuid-Fluent.cs data/Models-Odoo16-Uuid-Annotation-Origin -oe data/Models-Odoo16-Uuid-Annotation-Origin-Converted/Models/v16 -of data/Models-Odoo16-Uuid-Annotation-Origin-Converted/Configurations/v16
...
python3 scripts/tools/refactor_fluent.py data/CoreDbContext/CoreDbContext-Odoo18-Uuid-Fluent.cs data/Models-Odoo18-Uuid-Annotation-Origin -oe data/Models-Odoo18-Uuid-Annotation-Origin-Converted/Models/v16 -of data/Models-Odoo18-Uuid-Annotation-Origin-Converted/Configurations/v16

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"

#"$SCRIPT_DIR/copy-config-v18.sh" data/Models-Bamboo1618-Uuid-Converted/Configurations/v16
"$SCRIPT_DIR/copy-config-v18.sh" data/Models-Odoo16-Uuid-Annotation-Origin-Converted/Configurations/v16
"$SCRIPT_DIR/copy-config-v18.sh" data/Models-Odoo18-Uuid-Annotation-Origin-Converted/Configurations/v16

"$SCRIPT_DIR/copy-entities.sh" data/Models-Odoo16-Uuid-Annotation-Origin-Converted/Models/v16
"$SCRIPT_DIR/copy-entities.sh" data/Models-Odoo18-Uuid-Annotation-Origin-Converted/Models/v16
