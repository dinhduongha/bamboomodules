...
# ./scripts/generator/copy-services.sh data/Generated-18/NameSpaceFlat/src/
# ./scripts/generator/copy-services.sh data/Generated-19/NameSpaceFlat/src/
...
mkdir -p $DST_SERVICES/Bamboo.Core.Application/Mixins/
mkdir -p $DST_SERVICES/Bamboo.Core.Application/Services/
mkdir -p $DST_SERVICES/Bamboo.Core.HttpApi/Controllers/

#cp -avr $BASE_PATH/Bamboo.Core.Domain.Shared/Enums $DST_SHARED/Bamboo.Core.Domain.Shared/
...
cp -avr $BASE_PATH/Bamboo.Core.Application.Contracts/Mixins $DST_SHARED/Bamboo.Core.Application.Contracts/
#cp -avr $BASE_PATH/Bamboo.Core.Application/Mixins/* $DST_SERVICES/Bamboo.Core.Application/Mixins
