...
# ls -p | grep -v ./
python3 scripts/tools/generate_abp_scaffold.py -s /home/dockers/odoo-src-18 /home/dockers/odoo18/addons --group-by-category --flat-structure none --flat-namespace model service controller --entity-property-order abc --include-private-methods --flat-by-cat -o data/Generated-18/NameSpaceFlat

python3 scripts/tools/generate_abp_scaffold.py -s /home/dockers/odoo-src-19 /home/dockers/odoo19/custom-addons/odooapps --group-by-category --flat-structure none --flat-namespace model service controller --entity-property-order abc --include-private-methods --flat-by-cat -o data/Generated-19/NameSpaceFlat
