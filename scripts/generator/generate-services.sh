...
# ls -p | grep -v ./
python3 scripts/tools/generate_abp_scaffold.py -s /home/ha/work/dockers/odoo /home/ha/work/dockers/odoo18/addons --group-by-category --flat-structure model --flat-namespace model service --entity-property-order abc --include-private-methods -o data/Generated/NameSpaceFlat
