...
using Bamboo.Core.Blazor.WebAssembly;
...
namespace Bamboo.Core.Blazor.Host.Client;
...
[DependsOn(
    ...
    typeof(CoreBlazorWebAssemblyModule)
)]
public class CoreBlazorHostClientModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddMapperlyObjectMapper<CoreBlazorHostClientModule>();
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(CoreBlazorHostClientModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new CoreHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
